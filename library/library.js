...
`;$.registerThemeFragment("spectrum","theme",Zr),$.registerThemeFragment("light","color",Kr);var Wr=d`
...
`;$.registerThemeFragment("lightest","color",Wr);var Yr=d`
...
`;$.registerThemeFragment("dark","color",Yr);var Qr=d`
...
`;$.registerThemeFragment("darkest","color",Qr);var Jr=d`
...
`;$.registerThemeFragment("medium","scale",Jr);var to=d`
...
`,qo=Object.defineProperty,Mo=Object.getOwnPropertyDescriptor,se=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Mo(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&qo(t,e,s),s};class ct extends function(t,e){var o;class a extends t{constructor(...c){super(c),this.slotHasContent=!1,new Ze(this,{config:{characterData:!0,subtree:!0},callback:l=>{for(const i of l)if(i.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[Jt])return;const c=[...this[Jt]].filter(l=>!!l.tagName||!!l.textContent&&l.textContent.trim());this.slotHasContent=c.length>0}update(c){if(!this.hasUpdated){const{childNodes:l}=this,i=[...l].filter(m=>m.tagName?e?m.getAttribute("slot")===e:!m.hasAttribute("slot"):!!m.textContent&&m.textContent.trim());this.slotHasContent=i.length>0}super.update(c)}firstUpdated(c){super.firstUpdated(c),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=Jt,We([n({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),We([Br(e,!0)],a.prototype,o,2),a}(Qt(U)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[jo]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[u`
...
`,Ro=Object.defineProperty,Fo=Object.getOwnPropertyDescriptor,or=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Fo(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ro(t,e,s),s};class w extends T{static get styles(){return[Oo]}render(){return u`
            <slot></slot>
        `}}or([n()],w.prototype,"label",2),or([n({reflect:!0})],w.prototype,"size",2);var No=Object.defineProperty,Vo=Object.getOwnPropertyDescriptor,ae=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Vo(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&No(t,e,s),s};class $t extends w{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const e=this.parseIcon(this.name);t.detail.name===e.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o),this.updateIconPromise=this.updateIcon()}render(){return this.name?u`
                <div id="container"></div>
            `:this.src?u`
                <img src="${this.src}" alt=${b(this.label)} />
            `:super.render()}async updateIcon(){if(this.updateIconPromise&&await this.updateIconPromise,!this.name)return Promise.resolve();const t=this.parseIcon(this.name),e=M.getInstance().getIconset(t.iconset);return e&&this.iconContainer?(this.iconContainer.innerHTML="",e.applyIconToElement(this.iconContainer,t.icon,this.size||"",this.label?this.label:"")):Promise.resolve()}parseIcon(t){const e=t.split(":");let o="default",a=t;return e.length>1&&(o=e[0],a=e[1]),{iconset:o,icon:a}}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.updateIconPromise,t}}let ce;ae([n()],$t.prototype,"src",2),ae([n()],$t.prototype,"name",2),ae([X("#container")],$t.prototype,"iconContainer",2);const Z=function(r,...t){return ce?ce(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},W=r=>{ce=r};customElements.define("sp-icon-cross75",class extends w{render(){return W(u),(({width:r=24,height:t=24,title:e="Cross75"}={})=>Z`<svg
  ...
  >
    ...
    />
  </svg>`)()}}),customElements.define("sp-icon-cross100",class extends w{render(){return W(u),(({width:r=24,height:t=24,title:e="Cross100"}={})=>Z`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),customElements.define("sp-icon-cross200",class extends w{render(){return W(u),(({width:r=24,height:t=24,title:e="Cross200"}={})=>Z`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),customElements.define("sp-icon-cross300",class extends w{render(){return W(u),(({width:r=24,height:t=24,title:e="Cross300"}={})=>Z`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
...
`,Go=Object.defineProperty,Ko=Object.getOwnPropertyDescriptor;const Zo={s:()=>u`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class ar extends at(rr){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Uo,sr]}get buttonContent(){return[Zo[this.size]()]}render(){return u`
            <div class="fill">${super.render()}</div>
        `}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ko(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&Go(t,e,s)})([n({reflect:!0})],ar.prototype,"variant",2);var Wo=d`
...
`,Yo=Object.defineProperty,Qo=Object.getOwnPropertyDescriptor;const Jo={s:()=>u`
        <sp-icon-cross75
            slot="icon"
            class="icon spectrum-UIIcon-Cross75"
        ></sp-icon-cross75>
    ...
    `,xl:()=>u`
        <sp-icon-cross300
            ...
            class="icon spectrum-UIIcon-Cross300"
        ></sp-icon-cross300>
    `};class cr extends at(rr){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Wo,sr]}get buttonContent(){return[Jo[this.size]()]}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?Qo(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&Yo(t,e,s)})([n({reflect:!0})],cr.prototype,"variant",2);var ts=d`
:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
--mod-sans-font-family-stack,var(--spectrum-sans-font-family-stack)
);justify-content:center;line-height:var(--mod-line-height-100,var(--spectrum-line-height-100));margin:0;overflow:visible;text-decoration:none;text-transform:none;transition:background var(
--mod-animation-duration-100,var(--spectrum-animation-duration-100)
...
`;customElements.define("sp-icon-corner-triangle300",class extends w{render(){return W(u),(({width:r=24,height:t=24,title:e="Corner Triangle300"}={})=>Z`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 7 7"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
        ...
        `}addId(){const r=this.helpTextElement?this.helpTextElement.id:this.id;this.conditionId=function(t,e,o){const a=Array.isArray(o)?o:[o],s=t.getAttribute(e),c=s?s.split(/\s+/):[];return a.every(l=>c.indexOf(l)>-1)?()=>{}:(c.push(...a),t.setAttribute(e,c.join(" ")),()=>function(l,i,m){const g=l.getAttribute(i);let p=g?g.split(/\s+/):[];p=p.filter(y=>!m.find(x=>y===x)),p.length?l.setAttribute(i,p.join(" ")):l.removeAttribute(i)}(t,e,a))}(this.host,"aria-describedby",r),this.host.hasAttribute("tabindex")&&(this.previousTabindex=parseFloat(this.host.getAttribute("tabindex"))),this.host.tabIndex=0}removeId(){this.conditionId&&(this.conditionId(),delete this.conditionId),!this.helpTextElement&&(this.previousTabindex?this.host.tabIndex=this.previousTabindex:this.host.removeAttribute("tabindex"))}handleHelpText(r){if(this.isInternal)return;this.helpTextElement&&this.helpTextElement.id===this.id&&this.helpTextElement.removeAttribute("id"),this.removeId();const t=r.assignedElements()[0];this.helpTextElement=t,t&&(t.id||(t.id=this.id),this.addId())}handleNegativeHelpText(r){r.name==="negative-help-text"&&r.assignedElements().forEach(t=>t.variant="negative")}};let nr=lr;nr.instanceCount=0;let ie;customElements.define("sp-icon-checkmark100",class extends w{render(){return W(u),(({width:r=24,height:t=24,title:e="Checkmark100"}={})=>Z`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}});const j=function(r,...t){return ie?ie(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},q=r=>{ie=r};customElements.define("sp-icon-alert",class extends w{render(){return q(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Alert"}={})=>j`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});var as=d`
...
`,cs=Object.defineProperty,is=Object.getOwnPropertyDescriptor,z=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?is(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&cs(t,e,s),s};const ls=["text","url","tel","email","password"];class C extends function(t,{mode:e}={mode:"internal"}){return class extends t{constructor(){super(...arguments),this.helpTextManager=new nr(this,{mode:e})}get helpTextId(){return this.helpTextManager.id}renderHelpText(o){return this.helpTextManager.render(o)}}}(U){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[as,ur]}get type(){var t;return(t=ls.find(e=>e===this._type))!=null?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?u`
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});var ns=d`
...
`,us=Object.defineProperty,ms=Object.getOwnPropertyDescriptor,yt=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?ms(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&us(t,e,s),s};const ps=r=>r.stopPropagation();class it extends mr{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,ns]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||e!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return u`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}yt([n()],it.prototype,"action",2),yt([n()],it.prototype,"label",2),yt([n()],it.prototype,"method",2),yt([n()],it.prototype,"placeholder",2),yt([X("#form")],it.prototype,"form",2),customElements.define("sp-search",it);var ds=d`
...
`,gs=Object.defineProperty,bs=Object.getOwnPropertyDescriptor;class le extends at(T,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}le.styles=[ds],((r,t,e,o)=>{for(var a,s=o>1?void 0:o?bs(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&gs(t,e,s)})([n({type:Boolean,reflect:!0})],le.prototype,"vertical",2),customElements.define("sp-divider",le),customElements.define("sp-close-button",cr),customElements.define("sp-icon-info",class extends w{render(){return q(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Info"}={})=>j`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),customElements.define("sp-icon-checkmark-circle",class extends w{render(){return q(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Checkmark Circle"}={})=>j`<svg
    xmlns="http://www.w3.org/2000/svg"
    width=${r}
    height=${t}
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});var hs=d`
...
`,As=Object.defineProperty,Ts=Object.getOwnPropertyDescriptor,xt=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ts(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&As(t,e,s),s};class ut extends at(T,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[Ls]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return u`
            <div class="track"></div>
            <div class="fills">
...
`],js=Object.defineProperty,qs=Object.getOwnPropertyDescriptor,hr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?qs(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&js(t,e,s),s};class Ht extends T{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[_s,Hs,$s]}render(){return u`
        ...
        `}}Ht.is="sp-illustrated-message",hr([n()],Ht.prototype,"heading",2),hr([n()],Ht.prototype,"description",2),customElements.define("sp-illustrated-message",Ht),customElements.define("sp-icon-search",class extends w{render(){return q(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Search"}={})=>j`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    <path
      d="M33.173 30.215 25.4 22.443a12.826 12.826 0 1 0-2.957 2.957l7.772 7.772a2.1 2.1 0 0 0 2.958-2.958ZM6 15a9 9 0 1 1 9 9 9 9 0 0 1-9-9Z"
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),customElements.define("sp-button",ft),customElements.define("sp-icon",$t),customElements.define("sp-icon-chevron100",class extends w{render(){return W(u),(({width:r=24,height:t=24,title:e="Chevron100"}={})=>Z`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
...
`;class Bs extends Event{constructor({root:t}){super("sp-overlay-close",{bubbles:!0,composed:!0}),this.root=t}}var Ds=d`
...
`,Fs=Object.defineProperty,Ns=Object.getOwnPropertyDescriptor,Y=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ns(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Fs(t,e,s),s};function yr(r,t){return!!t&&(r===t||r.contains(t))}class V extends T{constructor(){super(),this.isSubmenu=!1,this.label="",this.value="",this.valueSeparator=",",this.selected=[],this.selectedItems=[],this.childItemSet=new Set,this.focusedItemIndex=0,this.focusInItemIndex=0,this.selectedItemsMap=new Map,this._willUpdateItems=!1,this._notFirstUpdated=!1,this.cacheUpdated=Promise.resolve(),this.addEventListener("sp-menu-item-added-or-updated",this.onSelectableItemAddedOrUpdated),this.addEventListener("sp-menu-item-added-or-updated",this.onFocusableItemAddedOrUpdated,{capture:!0}),this.addEventListener("sp-menu-item-removed",this.removeChildItem),this.addEventListener("click",this.onClick),this.addEventListener("focusin",this.handleFocusin)}static get styles(){return[Rs]}get childItems(){return this.cachedChildItems||(this.cachedChildItems=this.updateCachedMenuItems()),this.cachedChildItems}updateCachedMenuItems(){this.cachedChildItems=[];const t=this.menuSlot?this.menuSlot.assignedElements({flatten:!0}):[];for(const e of t){const o=e instanceof _?[e]:[...e.querySelectorAll("*")];for(const a of o)this.childItemSet.has(a)&&this.cachedChildItems.push(a)}return this.cachedChildItems}get childRole(){if(this.resolvedRole==="listbox")return"option";switch(this.resolvedSelects){case"single":return"menuitemradio";case"multiple":return"menuitemcheckbox";default:return"menuitem"}}get ownRole(){return"menu"}onFocusableItemAddedOrUpdated(t){var e;t.item.menuData.focusRoot&&(this.tabIndex=-1),t.focusRoot=this,this.addChildItem(t.item),this.selects==="inherit"?(this.resolvedSelects="inherit",this.resolvedRole=((e=t.currentAncestorWithSelects)==null?void 0:e.getAttribute("role"))||this.getAttribute("role")||void 0):this.selects?(this.resolvedRole=this.getAttribute("role")||void 0,this.resolvedSelects=this.selects,t.currentAncestorWithSelects=this):(this.resolvedRole=this.getAttribute("role")||void 0,this.resolvedSelects=this.resolvedRole==="none"?"ignore":"none")}onSelectableItemAddedOrUpdated(t){(this.resolvedSelects==="single"||this.resolvedSelects==="multiple"||!this.selects&&this.resolvedSelects!=="ignore")&&!t.item.menuData.selectionRoot&&(t.item.setRole(this.childRole),t.selectionRoot=this)}addChildItem(t){this.childItemSet.add(t),this.handleItemsChanged()}async removeChildItem(t){this.childItemSet.delete(t.item),this.cachedChildItems=void 0,t.item.focused&&(this.handleItemsChanged(),await this.updateComplete,this.focus())}focus({preventScroll:t}={}){if(!this.childItems.length||this.childItems.every(o=>o.disabled))return;if(this.childItems.some(o=>o.menuData.focusRoot!==this))return void super.focus({preventScroll:t});this.focusMenuItemByOffset(0),super.focus({preventScroll:t});const e=this.querySelector("[selected]");e&&!t&&e.scrollIntoView({block:"nearest"})}onClick(t){if(t.defaultPrevented)return;const e=t.composedPath().find(o=>o instanceof Element&&o.getAttribute("role")===this.childRole);e!=null&&e.href&&e.href.length?this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})):(e==null?void 0:e.menuData.selectionRoot)===this&&this.childItems.length&&(t.preventDefault(),e.hasSubmenu||e.open||(this.selectOrToggleItem(e),this.prepareToCleanUp()))}handleFocusin(t){var e;const o=yr(this,t.relatedTarget);if(o||this.childItems.some(c=>c.menuData.focusRoot!==this))return;const a=this.getRootNode().activeElement,s=((e=this.childItems[this.focusedItemIndex])==null?void 0:e.menuData.selectionRoot)||this;if((a!==s||!o)&&(s.focus({preventScroll:!0}),a&&this.focusedItemIndex===0)){const c=this.childItems.findIndex(l=>l===a);c>0&&this.focusMenuItemByOffset(c)}this.startListeningToKeyboard()}startListeningToKeyboard(){this.addEventListener("keydown",this.handleKeydown),this.addEventListener("focusout",this.handleFocusout)}handleFocusout(t){if(yr(this,t.relatedTarget))t.composedPath()[0].focused=!1;else{if(this.stopListeningToKeyboard(),t.target===this&&this.childItems.some(e=>e.menuData.focusRoot===this)){const e=this.childItems[this.focusedItemIndex];e&&(e.focused=!1)}this.removeAttribute("aria-activedescendant")}}stopListeningToKeyboard(){this.removeEventListener("keydown",this.handleKeydown),this.removeEventListener("focusout",this.handleFocusout)}async selectOrToggleItem(t){const e=this.resolvedSelects,o=new Map(this.selectedItemsMap),a=this.selected.slice(),s=this.selectedItems.slice(),c=this.value;if(this.childItems[this.focusedItemIndex].focused=!1,this.focusedItemIndex=this.childItems.indexOf(t),this.forwardFocusVisibleToItem(t),e==="multiple"){this.selectedItemsMap.has(t)?this.selectedItemsMap.delete(t):this.selectedItemsMap.set(t,!0);const l=[],i=[];this.childItemSet.forEach(m=>{m.menuData.selectionRoot===this&&this.selectedItemsMap.has(m)&&(l.push(m.value),i.push(m))}),this.selected=l,this.selectedItems=i,this.value=this.selected.join(this.valueSeparator)}else this.selectedItemsMap.clear(),this.selectedItemsMap.set(t,!0),this.value=t.value,this.selected=[t.value],this.selectedItems=[t];if(await this.updateComplete,!this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0,composed:!0})))return this.selected=a,this.selectedItems=s,this.selectedItemsMap=o,void(this.value=c);if(e==="single"){for(const l of o.keys())l!==t&&(l.selected=!1);t.selected=!0}else e==="multiple"&&(t.selected=!t.selected)}navigateWithinMenu(t){const{code:e}=t,o=this.childItems[this.focusedItemIndex],a=e==="ArrowDown"?1:-1,s=this.focusMenuItemByOffset(a);s!==o&&(t.preventDefault(),s.scrollIntoView({block:"nearest"}))}navigateBetweenRelatedMenus(t){const e=this.isLTR&&t==="ArrowRight"||!this.isLTR&&t==="ArrowLeft",o=this.isLTR&&t==="ArrowLeft"||!this.isLTR&&t==="ArrowRight";if(e){const a=this.childItems[this.focusedItemIndex];a!=null&&a.hasSubmenu&&(this.blur(),a.openOverlay())}else o&&this.isSubmenu&&this.dispatchEvent(new Event("close",{bubbles:!0}))}handleKeydown(t){var e;const{code:o}=t;if(o!=="Tab"){if(o==="Space"){const a=this.childItems[this.focusedItemIndex];if(a!=null&&a.hasSubmenu)return this.blur(),void a.openOverlay()}o!=="Space"&&o!=="Enter"?o!=="ArrowDown"&&o!=="ArrowUp"?this.navigateBetweenRelatedMenus(o):this.navigateWithinMenu(t):(e=this.childItems[this.focusedItemIndex])==null||e.click()}else this.prepareToCleanUp()}focusMenuItemByOffset(t){const e=t||1;this.childItems[this.focusedItemIndex].focused=!1,this.focusedItemIndex=(this.childItems.length+this.focusedItemIndex+t)%this.childItems.length;let o=this.childItems[this.focusedItemIndex],a=this.childItems.length;for(;o.disabled&&a;)a-=1,this.focusedItemIndex=(this.childItems.length+this.focusedItemIndex+e)%this.childItems.length,o=this.childItems[this.focusedItemIndex];return o!=null&&o.disabled||this.forwardFocusVisibleToItem(o),o}prepareToCleanUp(){document.addEventListener("focusout",()=>{requestAnimationFrame(()=>{const t=this.childItems[this.focusedItemIndex];t&&(t.focused=!1,this.updateSelectedItemIndex())})},{once:!0})}updateSelectedItemIndex(){let t=0;const e=new Map,o=[],a=[];let s=this.childItems.length;for(;s;){s-=1;const c=this.childItems[s];c.menuData.selectionRoot===this&&(c.selected&&(t=s,e.set(c,!0),o.unshift(c.value),a.unshift(c)),s!==t&&(c.focused=!1))}a.map((c,l)=>{l>0&&(c.focused=!1)}),this.selectedItemsMap=e,this.selected=o,this.selectedItems=a,this.value=this.selected.join(this.valueSeparator),this.focusedItemIndex=t,this.focusInItemIndex=t}handleItemsChanged(){if(this.cachedChildItems=void 0,!this._willUpdateItems){let t=()=>{};this.cacheUpdated=new Promise(e=>t=e),this._willUpdateItems=!0,window.requestAnimationFrame(()=>{this.cachedChildItems===void 0&&(this.updateSelectedItemIndex(),this.updateItemFocus()),this._willUpdateItems=!1,t()})}}updateItemFocus(){if(this.childItems.length==0)return;const t=this.childItems[this.focusInItemIndex];this.getRootNode().activeElement===t.menuData.focusRoot&&this.forwardFocusVisibleToItem(t)}forwardFocusVisibleToItem(t){t.menuData.focusRoot===this&&(t.focused=this.hasVisibleFocusInTree(),this.setAttribute("aria-activedescendant",t.id),t.menuData.selectionRoot&&t.menuData.selectionRoot!==this&&t.menuData.selectionRoot.focus())}render(){return u`
  ...
  </svg>`)({hidden:!this.label,title:this.label})}}),customElements.define("sp-icon-preview",class extends w{render(){return q(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Preview"}={})=>j`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),customElements.define("sp-icon-view-detail",class extends w{render(){return q(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="View Detail"}={})=>j`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),customElements.define("sp-icon-chevron-right",class extends w{render(){return q(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Chevron Right"}={})=>j`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});const xr="LibraryLoaded",qt="PluginLoaded",Mt="PluginUnloaded",kr="SearchUpdated",me="LocaleSet",Bt="Toast";class wr extends vt{static get styles(){return[...super.styles,d`#item-link{display:flex;justify-content:space-between;min-height:42px}.actions{display:none}#item-link:hover .actions{display:flex}`]}get hasActions(){return this.copy||this.preview||this.info}connectedCallback(){super.connectedCallback(),this.info=this.getAttribute("data-info")}onClick(){this.handleClick(),this.selected=!1}onPreview(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("Preview"))}render(){return u` <a target="${b(this.target)}" download="${b(this.download)}" rel="${b(this.rel)}" data-level="${this.depth}" @click="${this.onClick}" id="item-link" aria-current="${b(this.selected&&this.href?"page":void 0)}"> <slot name="icon"></slot> ${this.label} <slot></slot> ${this.disclosureArrow?u`<sp-icon-chevron-right slot="icon"></sp-icon-chevron-right>`:""} ${this.hasActions?u` <div class="actions"> ${this.info?u` <overlay-trigger placement="left"> <sp-tooltip slot="hover-content" variant="info">${this.info}</sp-tooltip> <sp-action-button quiet tip slot="trigger"> <sp-icon-info slot="icon"></sp-icon-info> </sp-action-button> </overlay-trigger> `:""} ${this.preview?u` <sp-action-button quiet @click="${this.onPreview}"> <sp-icon-preview slot="icon"></sp-icon-preview> </sp-action-button> `:""} </div> `:""} </a> ${this.expanded?u` <slot name="descendant"></slot> `:u``} `}}S(wr,"properties",{disclosureArrow:!1,copy:!1,preview:!1,info:""}),customElements.define("sp-sidenav-item",wr),customElements.define("sp-icon-chevron-left",class extends w{render(){return q(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Chevron Left"}={})=>j`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
