...
`,Da=Object.defineProperty,$a=Object.getOwnPropertyDescriptor,Cr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?$a(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Da(t,e,s),s};const jr=class extends Le(vt){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[Uo]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let r=0,t=this.parentElement;for(;t instanceof jr;)r++,t=t.parentElement;return r}handleSideNavSelect(r){this.selected=r.target===this}handleClick(r){!this.href&&r&&r.preventDefault(),!this.disabled&&(!this.href||r!=null&&r.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(r){const t=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:r}});this.dispatchEvent(t)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(r){this.hasAttribute("slot")||(this.slot="descendant"),super.update(r)}render(){return u`
            <a
                href=${this.href||"#"}
                target=${H(this.target)}
                download=${H(this.download)}
            ...
            ${this.expanded?u`
                  ...
                  `:u``}
        `}updated(r){this.hasChildren&&this.expanded&&!this.selected&&(this.focusElement.tabIndex=-1),super.updated(r)}connectedCallback(){super.connectedCallback(),this.startTrackingSelection()}disconnectedCallback(){this.stopTrackingSelection(),super.disconnectedCallback()}async startTrackingSelection(){const r=this.parentSideNav;if(r&&(await r.updateComplete,r.startTrackingSelectionForItem(this),this.selected=this.value!=null&&this.value===r.value,this.selected===!0&&r.variant==="multilevel")){let t=this.parentElement;for(;t instanceof jr;)t.expanded=!0,t=t.parentElement}}stopTrackingSelection(){const r=this.parentSideNav;r&&r.stopTrackingSelectionForItem(this),this._parentSidenav=void 0}};let pe=jr;Cr([m()],pe.prototype,"value",2),Cr([m({type:Boolean,reflect:!0})],pe.prototype,"selected",2),Cr([m({type:Boolean,reflect:!0})],pe.prototype,"expanded",2);var qa=k`
...
`,Wa=Object.defineProperty,Ga=Object.getOwnPropertyDescriptor,Er=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ga(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Wa(t,e,s),s};class Xt extends function(t,e){var o;class a extends t{constructor(...i){super(i),this.slotHasContent=!1,new De(this,{config:{characterData:!0,subtree:!0},callback:c=>{for(const n of c)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[wr])return;const i=[...this[wr]].filter(c=>!!c.tagName||!!c.textContent&&c.textContent.trim());this.slotHasContent=i.length>0}update(i){if(!this.hasUpdated){const{childNodes:c}=this,n=[...c].filter(l=>l.tagName?e?l.getAttribute("slot")===e:!l.hasAttribute("slot"):!!l.textContent&&l.textContent.trim());this.slotHasContent=n.length>0}super.update(i)}firstUpdated(i){super.firstUpdated(i),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=wr,Ro([m({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),Ro([To(e,!0)],a.prototype,o,2),a}(Le(vt)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[Va]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[u`
...
`,ti=Object.defineProperty,ei=Object.getOwnPropertyDescriptor,Go=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?ei(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&ti(t,e,s),s};class L extends M{static get styles(){return[Ja]}render(){return u`
            <slot></slot>
        `}}Go([m()],L.prototype,"label",2),Go([m({reflect:!0})],L.prototype,"size",2);var ri=Object.defineProperty,oi=Object.getOwnPropertyDescriptor,Hr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?oi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&ri(t,e,s),s};class Be extends L{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const e=this.parseIcon(this.name);t.detail.name===e.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o),this.updateIconPromise=this.updateIcon()}render(){return this.name?u`
                <div id="container"></div>
            `:this.src?u`
                <img src="${this.src}" alt=${H(this.label)} />
            `:super.render()}async updateIcon(){if(this.updateIconPromise&&await this.updateIconPromise,!this.name)return Promise.resolve();const t=this.parseIcon(this.name),e=kt.getInstance().getIconset(t.iconset);return e&&this.iconContainer?(this.iconContainer.innerHTML="",e.applyIconToElement(this.iconContainer,t.icon,this.size||"",this.label?this.label:"")):Promise.resolve()}parseIcon(t){const e=t.split(":");let o="default",a=t;return e.length>1&&(o=e[0],a=e[1]),{iconset:o,icon:a}}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.updateIconPromise,t}}let Ir;Hr([m()],Be.prototype,"src",2),Hr([m()],Be.prototype,"name",2),Hr([tt("#container")],Be.prototype,"iconContainer",2);const et=function(r,...t){return Ir?Ir(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},rt=r=>{Ir=r};y("sp-icon-cross75",class extends L{render(){return rt(u),(({width:r=24,height:t=24,title:e="Cross75"}={})=>et`<svg
...
`,si=Object.defineProperty,ai=Object.getOwnPropertyDescriptor;const ii={s:()=>u`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class Zo extends nt(Wo){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Qa,Ko]}get buttonContent(){return[ii[this.size]()]}render(){return u`
            <div class="fill">${super.render()}</div>
        `}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?ai(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&si(t,e,s)})([m({reflect:!0})],Zo.prototype,"variant",2);var ci=k`
...
`,ni=Object.defineProperty,li=Object.getOwnPropertyDescriptor;const ui={s:()=>u`
        <sp-icon-cross75
            slot="icon"
            class="icon spectrum-UIIcon-Cross75"
        ></sp-icon-cross75>
    ...
    `,xl:()=>u`
        <sp-icon-cross300
            ...
            class="icon spectrum-UIIcon-Cross300"
        ></sp-icon-cross300>
    `};class Xo extends nt(Wo){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,ci,Ko]}get buttonContent(){return[ui[this.size]()]}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?li(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&ni(t,e,s)})([m({reflect:!0})],Xo.prototype,"variant",2);var mi=k`
:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
--mod-sans-font-family-stack,var(--spectrum-sans-font-family-stack)
);justify-content:center;line-height:var(--mod-line-height-100,var(--spectrum-line-height-100));margin:0;overflow:visible;-webkit-text-decoration:none;text-decoration:none;text-transform:none;transition:background var(
--mod-animation-duration-100,var(--spectrum-animation-duration-100)
...
`;y("sp-icon-corner-triangle300",class extends L{render(){return rt(u),(({width:r=24,height:t=24,title:e="Corner Triangle300"}={})=>et`<svg
  ...
  >
    ...
    />
  </svg>`)()}});var di=Object.defineProperty,gi=Object.getOwnPropertyDescriptor,Ht=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?gi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&di(t,e,s),s};const hi={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let Yo;class zt extends nt(Xt,{validSizes:["xs","s","m","l","xl"]}){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[...super.styles,mi,pi]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(t){t.button===0&&(this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),Yo=setTimeout(()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))},300))}onPointerup(){clearTimeout(Yo),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:e,altKey:o}=t;(e==="Space"||o&&e==="ArrowDown")&&(t.preventDefault(),e==="ArrowDown"&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:e,altKey:o}=t;(e==="Space"||o&&e==="ArrowDown")&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(u`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${hi[this.size]}"
                ></sp-icon-corner-triangle300>
  ...
  >
    ...
    />
  </svg>`)()}});const K=function(r,...t){return Sr?Sr(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},Z=r=>{Sr=r};y("sp-icon-alert",class extends L{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Alert"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,vi=Object.defineProperty,fi=Object.getOwnPropertyDescriptor,_=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?fi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&vi(t,e,s),s};const yi=["text","url","tel","email","password"];class R extends function(t,{mode:e}={mode:"internal"}){return class extends t{constructor(){super(...arguments),this.helpTextManager=new Jo(this,{mode:e})}get helpTextId(){return this.helpTextManager.id}renderHelpText(o){return this.helpTextManager.render(o)}}}(vt){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[bi,Tr]}get type(){var t;return(t=yi.find(e=>e===this._type))!=null?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?u`
        ...
        `}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then(()=>{this.checkValidity()}),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),this.minlength!==void 0&&(t=t&&this.value.toString().length>=this.minlength),this.valid=t,this.invalid=!t),t}}_([m({attribute:"allowed-keys"})],R.prototype,"allowedKeys",2),_([m({type:Boolean,reflect:!0})],R.prototype,"focused",2),_([tt(".input")],R.prototype,"inputElement",2),_([m({type:Boolean,reflect:!0})],R.prototype,"invalid",2),_([m()],R.prototype,"label",2),_([m()],R.prototype,"placeholder",2),_([m({attribute:"type",reflect:!0})],R.prototype,"_type",2),_([pr()],R.prototype,"type",1),_([m()],R.prototype,"pattern",2),_([m({type:Boolean,reflect:!0})],R.prototype,"grows",2),_([m({type:Number})],R.prototype,"maxlength",2),_([m({type:Number})],R.prototype,"minlength",2),_([m({type:Boolean,reflect:!0})],R.prototype,"multiline",2),_([m({type:Boolean,reflect:!0})],R.prototype,"readonly",2),_([m({type:Boolean,reflect:!0})],R.prototype,"valid",2),_([m({type:String})],R.prototype,"value",1),_([m({type:Boolean,reflect:!0})],R.prototype,"quiet",2),_([m({type:Boolean,reflect:!0})],R.prototype,"required",2),_([m({type:String,reflect:!0})],R.prototype,"autocomplete",2);class Lr extends R{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}_([m({type:String})],Lr.prototype,"value",1),y("sp-clear-button",Zo),y("sp-icon-magnify",class extends L{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Magnify"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});var ki=k`
...
`,wi=Object.defineProperty,xi=Object.getOwnPropertyDescriptor,ge=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?xi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&wi(t,e,s),s};const zi=r=>r.stopPropagation();class Yt extends Lr{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,ki]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||e!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return u`
            <form
                action=${this.action}
                id="form"
...
`,Ci=Object.defineProperty,ji=Object.getOwnPropertyDescriptor;class Dr extends nt(M,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Dr.styles=[ts],((r,t,e,o)=>{for(var a,s=o>1?void 0:o?ji(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&Ci(t,e,s)})([m({type:Boolean,reflect:!0})],Dr.prototype,"vertical",2),y("sp-divider",Dr),y("sp-close-button",Xo),y("sp-icon-info",class extends L{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Info"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,Ei=Object.defineProperty,Hi=Object.getOwnPropertyDescriptor,$r=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Hi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ei(t,e,s),s};const Ii=["negative","positive","info","error","warning"];class Pe extends M{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[Ai]}set timeout(t){const e=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;Ii.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(this.timeout!==null&&this.open?this.startCountdown():this.stopCountdown())}}$r([m({type:Boolean,reflect:!0})],Pe.prototype,"open",2),$r([m({type:Number})],Pe.prototype,"timeout",1),$r([m({type:String})],Pe.prototype,"variant",1),y("sp-toast",Pe);const Oe=async(r,t,e,o)=>{const{Overlay:a}=await Promise.resolve().then(function(){return qc});return a.open(r,t,e,o)};var Si=k`
...
`,Mi=Object.defineProperty,_i=Object.getOwnPropertyDescriptor,he=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?_i(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Mi(t,e,s),s};class te extends nt(M,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[Oi]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return u`
            <div class="track"></div>
            <div class="fills">
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(t){super.updated(t),!this.indeterminate&&t.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),this.label&&t.has("label")&&this.setAttribute("aria-label",this.label)}}he([m({type:Boolean,reflect:!0})],te.prototype,"indeterminate",2),he([m({type:String})],te.prototype,"label",2),he([m({type:Boolean,reflect:!0,attribute:"over-background"})],te.prototype,"overBackground",2),he([m({reflect:!0})],te.prototype,"static",2),he([m({type:Number})],te.prototype,"progress",2),y("sp-progress-circle",te);var Ri=k`
...
`],Ni=Object.defineProperty,Fi=Object.getOwnPropertyDescriptor,ss=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Fi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ni(t,e,s),s};class Me extends M{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[os,Ui,Ri]}render(){return u`
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-button",de);var Vi=k`
...
`,Wi=Object.defineProperty,Gi=Object.getOwnPropertyDescriptor;class as extends nt(M){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[Vi]}handleSlotchange({target:t}){t.assignedElements().forEach(e=>{e.size=this.size})}render(){return u`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?Gi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&Wi(t,e,s)})([m({type:Boolean,reflect:!0})],as.prototype,"vertical",2),y("sp-button-group",as);var Ki=k`
...
`,Zi=Object.defineProperty,Xi=Object.getOwnPropertyDescriptor,Tt=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Xi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Zi(t,e,s),s};const Pr=[];class Ct extends nt(M,{validSizes:["xs","s","m","l","xl"]}){constructor(){super(),this._buttons=[],this._buttonSelector="sp-action-button",this.rovingTabindexController=new Lo(this,{focusInIndex:t=>{let e=-1;const o=t.findIndex((a,s)=>(!t[e]&&!a.disabled&&(e=s),a.selected&&!a.disabled));return t[o]?o:e},elements:()=>this.buttons,isFocusableElement:t=>!t.disabled}),this.compact=!1,this.emphasized=!1,this.justified=!1,this.label="",this.quiet=!1,this.vertical=!1,this._selected=Pr,this.manageButtons=()=>{const t=this.shadowRoot.querySelector("slot");if(!t)return;const e=t.assignedElements({flatten:!0}).reduce((a,s)=>{if(s.matches(this._buttonSelector))a.push(s);else{const i=Array.from(s.querySelectorAll(`:scope > ${this._buttonSelector}`));a.push(...i)}return a},[]);this.buttons=e;const o=[];this.buttons.forEach(a=>{a.selected&&o.push(a.value)}),this.setSelected(this.selected.concat(o)),this.manageChildren(),this.manageSelects()},new De(this,{config:{childList:!0,subtree:!0},callback:()=>{this.manageButtons()}})}static get styles(){return[Ki]}set buttons(t){t!==this.buttons&&(this._buttons=t,this.rovingTabindexController.clearElementCache())}get buttons(){return this._buttons}set selected(t){this.requestUpdate("selected",this._selected),this._selected=t,this.updateComplete.then(()=>{this.applySelects(),this.manageChildren()})}get selected(){return this._selected}dispatchChange(t){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))||(this.setSelected(t),this.buttons.map(e=>{e.selected=this.selected.includes(e.value)}))}setSelected(t,e){if(t===this.selected)return;const o=this.selected;this.requestUpdate("selected",o),this._selected=t,e&&this.dispatchChange(o)}focus(t){this.rovingTabindexController.focus(t)}deselectSelectedButtons(){[...this.querySelectorAll("[selected]")].forEach(t=>{t.selected=!1,t.tabIndex=-1,t.setAttribute("aria-checked","false")})}handleClick(t){const e=t.target;if(e.value!==void 0)switch(this.selects){case"single":this.deselectSelectedButtons(),e.selected=!0,e.tabIndex=0,e.setAttribute("aria-checked","true"),this.setSelected([e.value],!0),e.focus();break;case"multiple":{const o=[...this.selected];e.selected=!e.selected,e.setAttribute("aria-checked",e.selected?"true":"false"),e.selected?o.push(e.value):o.splice(this.selected.indexOf(e.value),1),this.setSelected(o,!0),this.buttons.forEach(a=>{a.tabIndex=-1}),e.tabIndex=0;break}}}async applySelects(){await this.manageSelects(!0)}async manageSelects(t){if(!this.buttons.length)return;const e=this.buttons;switch(this.selects){case"single":{this.setAttribute("role","radiogroup");const o=[],a=e.map(async i=>{await i.updateComplete,i.setAttribute("role","radio"),i.setAttribute("aria-checked",i.selected?"true":"false"),i.selected&&o.push(i)});if(t)break;await Promise.all(a);const s=o.map(i=>i.value);this.setSelected(s||Pr);break}case"multiple":{this.setAttribute("role","group");const o=[],a=[],s=e.map(async c=>{await c.updateComplete,c.setAttribute("role","checkbox"),c.setAttribute("aria-checked",c.selected?"true":"false"),c.selected&&(o.push(c.value),a.push(c))});if(t)break;await Promise.all(s);const i=o.length?o:Pr;this.setSelected(i);break}default:if(!this.selected.length){this.buttons.forEach(o=>{o.setAttribute("role","button")}),this.removeAttribute("role");break}{const o=[],a=e.map(async s=>{await s.updateComplete,s.setAttribute("aria-checked",s.selected?"true":"false"),s.setAttribute("role","button"),s.selected&&o.push(s)});if(t)break;await Promise.all(a),this.setSelected(o.map(s=>s.value))}}}render(){return u`
...
`;class Yi extends Event{constructor({root:t}){super("sp-overlay-close",{bubbles:!0,composed:!0}),this.root=t}}var Qi=k`
...
`,Ji=Object.defineProperty,tc=Object.getOwnPropertyDescriptor,Lt=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?tc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ji(t,e,s),s};class ec extends Event{constructor(){super("sp-menu-item-removed",{bubbles:!0,composed:!0}),this.focused=!1}get item(){return this._item}reset(t){this._item=t}}class rc extends Event{constructor(){super("sp-menu-item-added-or-updated",{bubbles:!0,composed:!0})}set focusRoot(t){this.item.menuData.focusRoot=this.item.menuData.focusRoot||t}set selectionRoot(t){this.item.menuData.selectionRoot=this.item.menuData.selectionRoot||t}get item(){return this._item}set currentAncestorWithSelects(t){this._currentAncestorWithSelects=t}get currentAncestorWithSelects(){return this._currentAncestorWithSelects}reset(t){this._item=t,this._currentAncestorWithSelects=void 0,t.menuData={focusRoot:void 0,selectionRoot:void 0}}}const _e=new rc,cs=new ec,ns=class extends Le(vt){constructor(){super(),this.isInSubmenu=!1,this.active=!1,this.focused=!1,this.selected=!1,this._value="",this.hasSubmenu=!1,this.noWrap=!1,this.open=!1,this.handleSubmenuChange=()=>{var r;(r=this.menuData.selectionRoot)==null||r.selectOrToggleItem(this)},this.handleSubmenuPointerenter=()=>{this.leaveTimeout&&(clearTimeout(this.leaveTimeout),delete this.leaveTimeout)},this.menuData={focusRoot:void 0,selectionRoot:void 0},this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0}),new De(this,{config:{characterData:!0,childList:!0,subtree:!0},callback:()=>{this.breakItemChildrenCache()}})}static get styles(){return[Qi,Tr,is]}get value(){return this._value||this.itemText}set value(r){r!==this._value&&(this._value=r||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return this.itemChildren.content.reduce((r,t)=>r+(t.textContent||"").trim(),"")}get focusElement(){return this}get itemChildren(){var r,t;if(this._itemChildren)return this._itemChildren;const e=(r=this.shadowRoot)==null?void 0:r.querySelector('slot[name="icon"]'),o=e?e.assignedElements().map(i=>{const c=i.cloneNode(!0);return c.removeAttribute("slot"),c.classList.toggle("icon"),c}):[],a=(t=this.shadowRoot)==null?void 0:t.querySelector("slot:not([name])"),s=a?a.assignedNodes().map(i=>i.cloneNode(!0)):[];return this._itemChildren={icon:o,content:s},this._itemChildren}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(r){if(this.disabled)return r.preventDefault(),r.stopImmediatePropagation(),r.stopPropagation(),!1}proxyFocus(){this.focus()}shouldProxyClick(){let r=!1;return this.anchorElement&&(this.anchorElement.click(),r=!0),r}breakItemChildrenCache(){this._itemChildren=void 0,this.triggerUpdate()}render(){return u`
            <slot name="icon"></slot>
            <div id="label">
                <slot id="slot"></slot>
            </div>
...
`,cc=Object.defineProperty,nc=Object.getOwnPropertyDescriptor,us=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?nc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&cc(t,e,s),s};const Or=class extends jt{constructor(){super(),Or.instances+=1,this.headerId=`sp-menu-group-label-${Or.instances}`}static get styles(){return[...super.styles,ic]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const r=this.headerElements.length?this.headerElements[0]:void 0;if(r!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),r){const t=r.id||this.headerId;r.id||(r.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=r}render(){return u`
        ...
        `}};let Re=Or;Re.instances=0,us([To("header",!0)],Re.prototype,"headerElements",2),us([pr()],Re.prototype,"headerElement",2),y("sp-menu-group",Re);var lc=k`
...
`;class uc extends nt(M,{validSizes:["s","m","l"]}){static get styles(){return[ts,lc]}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}}y("sp-menu-divider",uc);var mc=k`
...
`,dc=Object.defineProperty,gc=Object.getOwnPropertyDescriptor;class ms extends M{constructor(){super(...arguments),this.open=!1}static get styles(){return[pc]}render(){return u``}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?gc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&dc(t,e,s)})([m({type:Boolean,reflect:!0})],ms.prototype,"open",2),y("sp-underlay",ms);class ps{constructor(t,e){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(e),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}}var hc=k`
...
`,vc=Object.defineProperty,fc=Object.getOwnPropertyDescriptor,ds=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?fc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&vc(t,e,s),s};class Mr extends M{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new ps(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[hc,bc]}focus(){const t=br(this);t?t.focus():this.children.length===1?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(t){t.has("open")&&t.get("open")!==void 0&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise(e=>{this.resolveTransitionPromise=()=>{this.animating=!1,e()}})),super.update(t)}render(){return u`
            <sp-underlay
                ?open=${this.open}
                @click=${this.close}
        ...
        `}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.transitionPromise,t}}ds([m({type:Boolean,reflect:!0})],Mr.prototype,"open",2),ds([tt(".tray")],Mr.prototype,"tray",2),y("sp-tray",Mr);var yc=k`
...
`,kc=Object.defineProperty,wc=Object.getOwnPropertyDescriptor,Ue=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?wc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&kc(t,e,s),s};class be extends M{constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[yc]}renderTip(){return u`
            <div id="tip">
                <svg
        ...
        `}}Ue([m({type:Boolean,reflect:!0})],be.prototype,"dialog",2),Ue([m({type:Boolean,reflect:!0})],be.prototype,"open",2),Ue([m({reflect:!0})],be.prototype,"placement",2),Ue([m({type:Boolean,reflect:!0})],be.prototype,"tip",2),y("sp-popover",be);var xc=k`
...
`;const ee=r=>{if(!r)return null;const t=r.closest("active-overlay");if(t)return t;const e=r.getRootNode();return e.host?ee(e.host):null},_r=(r,t)=>{const e=[];if(!r)return[];for(const o of t)o.root&&ee(o.root)===r&&(e.push(o),e.push(..._r(o,t)));return e};function re(r){return r.split("-")[1]}function Rr(r){return r==="y"?"height":"width"}function Dt(r){return r.split("-")[0]}function oe(r){return["top","bottom"].includes(Dt(r))?"x":"y"}function gs(r,t,e){let{reference:o,floating:a}=r;const s=o.x+o.width/2-a.width/2,i=o.y+o.height/2-a.height/2,c=oe(t),n=Rr(c),l=o[n]/2-a[n]/2,p=c==="x";let d;switch(Dt(t)){case"top":d={x:s,y:o.y-a.height};break;case"bottom":d={x:s,y:o.y+o.height};break;case"right":d={x:o.x+o.width,y:i};break;case"left":d={x:o.x-a.width,y:i};break;default:d={x:o.x,y:o.y}}switch(re(t)){case"start":d[c]-=l*(e&&p?-1:1);break;case"end":d[c]+=l*(e&&p?-1:1)}return d}function hs(r){return typeof r!="number"?function(t){return{top:0,right:0,bottom:0,left:0,...t}}(r):{top:r,right:r,bottom:r,left:r}}function Ne(r){return{...r,top:r.y,left:r.x,right:r.x+r.width,bottom:r.y+r.height}}async function Ur(r,t){var e;t===void 0&&(t={});const{x:o,y:a,platform:s,rects:i,elements:c,strategy:n}=r,{boundary:l="clippingAncestors",rootBoundary:p="viewport",elementContext:d="floating",altBoundary:g=!1,padding:h=0}=t,b=hs(h),v=c[g?d==="floating"?"reference":"floating":d],w=Ne(await s.getClippingRect({element:(e=await(s.isElement==null?void 0:s.isElement(v)))==null||e?v:v.contextElement||await(s.getDocumentElement==null?void 0:s.getDocumentElement(c.floating)),boundary:l,rootBoundary:p,strategy:n})),f=d==="floating"?{...i.floating,x:o,y:a}:i.reference,C=await(s.getOffsetParent==null?void 0:s.getOffsetParent(c.floating)),j=await(s.isElement==null?void 0:s.isElement(C))&&await(s.getScale==null?void 0:s.getScale(C))||{x:1,y:1},A=Ne(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({rect:f,offsetParent:C,strategy:n}):f);return{top:(w.top-A.top+b.top)/j.y,bottom:(A.bottom-w.bottom+b.bottom)/j.y,left:(w.left-A.left+b.left)/j.x,right:(A.right-w.right+b.right)/j.x}}const Nr=Math.min,Mt=Math.max;function Fr(r,t,e){return Mt(r,Nr(t,e))}const zc={left:"right",right:"left",bottom:"top",top:"bottom"};function Fe(r){return r.replace(/left|right|bottom|top/g,t=>zc[t])}const Cc={start:"end",end:"start"};function Vr(r){return r.replace(/start|end/g,t=>Cc[t])}const bs=function(r){return r===void 0&&(r={}),{name:"flip",options:r,async fn(t){var e;const{placement:o,middlewareData:a,rects:s,initialPlacement:i,platform:c,elements:n}=t,{mainAxis:l=!0,crossAxis:p=!0,fallbackPlacements:d,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:h="none",flipAlignment:b=!0,...v}=r,w=Dt(o),f=Dt(i)===i,C=await(c.isRTL==null?void 0:c.isRTL(n.floating)),j=d||(f||!b?[Fe(i)]:function(I){const B=Fe(I);return[Vr(I),B,Vr(B)]}(i));d||h==="none"||j.push(...function(I,B,T,P){const F=re(I);let O=function(J,W,at){const Bt=["left","right"],ie=["right","left"],ut=["top","bottom"],ze=["bottom","top"];switch(J){case"top":case"bottom":return at?W?ie:Bt:W?Bt:ie;case"left":case"right":return W?ut:ze;default:return[]}}(Dt(I),T==="start",P);return F&&(O=O.map(J=>J+"-"+F),B&&(O=O.concat(O.map(Vr)))),O}(i,b,h,C));const A=[i,...j],E=await Ur(t,v),z=[];let x=((e=a.flip)==null?void 0:e.overflows)||[];if(l&&z.push(E[w]),p){const{main:I,cross:B}=function(T,P,F){F===void 0&&(F=!1);const O=re(T),J=oe(T),W=Rr(J);let at=J==="x"?O===(F?"end":"start")?"right":"left":O==="start"?"bottom":"top";return P.reference[W]>P.floating[W]&&(at=Fe(at)),{main:at,cross:Fe(at)}}(o,s,C);z.push(E[I],E[B])}if(x=[...x,{placement:o,overflows:z}],!z.every(I=>I<=0)){var S,U;const I=(((S=a.flip)==null?void 0:S.index)||0)+1,B=A[I];if(B)return{data:{index:I,overflows:x},reset:{placement:B}};let T=(U=x.filter(P=>P.overflows[0]<=0).sort((P,F)=>P.overflows[1]-F.overflows[1])[0])==null?void 0:U.placement;if(!T)switch(g){case"bestFit":{var N;const P=(N=x.map(F=>[F.placement,F.overflows.filter(O=>O>0).reduce((O,J)=>O+J,0)]).sort((F,O)=>F[1]-O[1])[0])==null?void 0:N[0];P&&(T=P);break}case"initialPlacement":T=i}if(o!==T)return{reset:{placement:T}}}return{}}}},jc=function(r){return r===void 0&&(r=0),{name:"offset",options:r,async fn(t){const{x:e,y:o}=t,a=await async function(s,i){const{placement:c,platform:n,elements:l}=s,p=await(n.isRTL==null?void 0:n.isRTL(l.floating)),d=Dt(c),g=re(c),h=oe(c)==="x",b=["left","top"].includes(d)?-1:1,v=p&&h?-1:1,w=typeof i=="function"?i(s):i;let{mainAxis:f,crossAxis:C,alignmentAxis:j}=typeof w=="number"?{mainAxis:w,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...w};return g&&typeof j=="number"&&(C=g==="end"?-1*j:j),h?{x:C*v,y:f*b}:{x:f*b,y:C*v}}(t,r);return{x:e+a.x,y:o+a.y,data:a}}}},Ac=function(r){return r===void 0&&(r={}),{name:"size",options:r,async fn(t){const{placement:e,rects:o,platform:a,elements:s}=t,{apply:i=()=>{},...c}=r,n=await Ur(t,c),l=Dt(e),p=re(e),d=oe(e)==="x",{width:g,height:h}=o.floating;let b,v;l==="top"||l==="bottom"?(b=l,v=p===(await(a.isRTL==null?void 0:a.isRTL(s.floating))?"start":"end")?"left":"right"):(v=l,b=p==="end"?"top":"bottom");const w=h-n[b],f=g-n[v],C=!t.middlewareData.shift;let j=w,A=f;if(d){const z=g-n.left-n.right;A=p||C?Nr(f,z):z}else{const z=h-n.top-n.bottom;j=p||C?Nr(w,z):z}if(C&&!p){const z=Mt(n.left,0),x=Mt(n.right,0),S=Mt(n.top,0),U=Mt(n.bottom,0);d?A=g-2*(z!==0||x!==0?z+x:Mt(n.left,n.right)):j=h-2*(S!==0||U!==0?S+U:Mt(n.top,n.bottom))}await i({...t,availableWidth:A,availableHeight:j});const E=await a.getDimensions(s.floating);return g!==E.width||h!==E.height?{reset:{rects:!0}}:{}}}};function it(r){var t;return((t=r.ownerDocument)==null?void 0:t.defaultView)||window}function ft(r){return it(r).getComputedStyle(r)}function vs(r){return r instanceof it(r).Node}function $t(r){return vs(r)?(r.nodeName||"").toLowerCase():""}let Ve;function fs(){if(Ve)return Ve;const r=navigator.userAgentData;return r&&Array.isArray(r.brands)?(Ve=r.brands.map(t=>t.brand+"/"+t.version).join(" "),Ve):navigator.userAgent}function dt(r){return r instanceof it(r).HTMLElement}function gt(r){return r instanceof it(r).Element}function ys(r){return typeof ShadowRoot>"u"?!1:r instanceof it(r).ShadowRoot||r instanceof ShadowRoot}function We(r){const{overflow:t,overflowX:e,overflowY:o,display:a}=ft(r);return/auto|scroll|overlay|hidden|clip/.test(t+o+e)&&!["inline","contents"].includes(a)}function Ec(r){return["table","td","th"].includes($t(r))}function Wr(r){const t=/firefox/i.test(fs()),e=ft(r),o=e.backdropFilter||e.WebkitBackdropFilter;return e.transform!=="none"||e.perspective!=="none"||!!o&&o!=="none"||t&&e.willChange==="filter"||t&&!!e.filter&&e.filter!=="none"||["transform","perspective"].some(a=>e.willChange.includes(a))||["paint","layout","strict","content"].some(a=>{const s=e.contain;return s!=null&&s.includes(a)})}function Gr(){return/^((?!chrome|android).)*safari/i.test(fs())}function Kr(r){return["html","body","#document"].includes($t(r))}const ks=Math.min,ve=Math.max,Ge=Math.round;function ws(r){const t=ft(r);let e=parseFloat(t.width),o=parseFloat(t.height);const a=dt(r),s=a?r.offsetWidth:e,i=a?r.offsetHeight:o,c=Ge(e)!==s||Ge(o)!==i;return c&&(e=s,o=i),{width:e,height:o,fallback:c}}function xs(r){return gt(r)?r:r.contextElement}const zs={x:1,y:1};function se(r){const t=xs(r);if(!dt(t))return zs;const e=t.getBoundingClientRect(),{width:o,height:a,fallback:s}=ws(t);let i=(s?Ge(e.width):e.width)/o,c=(s?Ge(e.height):e.height)/a;return i&&Number.isFinite(i)||(i=1),c&&Number.isFinite(c)||(c=1),{x:i,y:c}}function _t(r,t,e,o){var a,s;t===void 0&&(t=!1),e===void 0&&(e=!1);const i=r.getBoundingClientRect(),c=xs(r);let n=zs;t&&(o?gt(o)&&(n=se(o)):n=se(r));const l=c?it(c):window,p=Gr()&&e;let d=(i.left+(p&&((a=l.visualViewport)==null?void 0:a.offsetLeft)||0))/n.x,g=(i.top+(p&&((s=l.visualViewport)==null?void 0:s.offsetTop)||0))/n.y,h=i.width/n.x,b=i.height/n.y;if(c){const v=it(c),w=o&&gt(o)?it(o):o;let f=v.frameElement;for(;f&&o&&w!==v;){const C=se(f),j=f.getBoundingClientRect(),A=getComputedStyle(f);j.x+=(f.clientLeft+parseFloat(A.paddingLeft))*C.x,j.y+=(f.clientTop+parseFloat(A.paddingTop))*C.y,d*=C.x,g*=C.y,h*=C.x,b*=C.y,d+=j.x,g+=j.y,f=it(f).frameElement}}return Ne({width:h,height:b,x:d,y:g})}function qt(r){return((vs(r)?r.ownerDocument:r.document)||window.document).documentElement}function Ke(r){return gt(r)?{scrollLeft:r.scrollLeft,scrollTop:r.scrollTop}:{scrollLeft:r.pageXOffset,scrollTop:r.pageYOffset}}function Cs(r){return _t(qt(r)).left+Ke(r).scrollLeft}function fe(r){if($t(r)==="html")return r;const t=r.assignedSlot||r.parentNode||ys(r)&&r.host||qt(r);return ys(t)?t.host:t}function js(r){const t=fe(r);return Kr(t)?t.ownerDocument.body:dt(t)&&We(t)?t:js(t)}function ye(r,t){var e;t===void 0&&(t=[]);const o=js(r),a=o===((e=r.ownerDocument)==null?void 0:e.body),s=it(o);return a?t.concat(s,s.visualViewport||[],We(o)?o:[]):t.concat(o,ye(o))}function As(r,t,e){let o;if(t==="viewport")o=function(i,c){const n=it(i),l=qt(i),p=n.visualViewport;let d=l.clientWidth,g=l.clientHeight,h=0,b=0;if(p){d=p.width,g=p.height;const v=Gr();(!v||v&&c==="fixed")&&(h=p.offsetLeft,b=p.offsetTop)}return{width:d,height:g,x:h,y:b}}(r,e);else if(t==="document")o=function(i){const c=qt(i),n=Ke(i),l=i.ownerDocument.body,p=ve(c.scrollWidth,c.clientWidth,l.scrollWidth,l.clientWidth),d=ve(c.scrollHeight,c.clientHeight,l.scrollHeight,l.clientHeight);let g=-n.scrollLeft+Cs(i);const h=-n.scrollTop;return ft(l).direction==="rtl"&&(g+=ve(c.clientWidth,l.clientWidth)-p),{width:p,height:d,x:g,y:h}}(qt(r));else if(gt(t))o=function(i,c){const n=_t(i,!0,c==="fixed"),l=n.top+i.clientTop,p=n.left+i.clientLeft,d=dt(i)?se(i):{x:1,y:1};return{width:i.clientWidth*d.x,height:i.clientHeight*d.y,x:p*d.x,y:l*d.y}}(t,e);else{const i={...t};if(Gr()){var a,s;const c=it(r);i.x-=((a=c.visualViewport)==null?void 0:a.offsetLeft)||0,i.y-=((s=c.visualViewport)==null?void 0:s.offsetTop)||0}o=i}return Ne(o)}function Es(r,t){return dt(r)&&ft(r).position!=="fixed"?t?t(r):r.offsetParent:null}function Hs(r,t){const e=it(r);if(!dt(r))return e;let o=Es(r,t);for(;o&&Ec(o)&&ft(o).position==="static";)o=Es(o,t);return o&&($t(o)==="html"||$t(o)==="body"&&ft(o).position==="static"&&!Wr(o))?e:o||function(a){let s=fe(a);for(;dt(s)&&!Kr(s);){if(Wr(s))return s;s=fe(s)}return null}(r)||e}function Hc(r,t,e){const o=dt(t),a=qt(t),s=_t(r,!0,e==="fixed",t);let i={scrollLeft:0,scrollTop:0};const c={x:0,y:0};if(o||!o&&e!=="fixed")if(($t(t)!=="body"||We(a))&&(i=Ke(t)),dt(t)){const n=_t(t,!0);c.x=n.x+t.clientLeft,c.y=n.y+t.clientTop}else a&&(c.x=Cs(a));return{x:s.left+i.scrollLeft-c.x,y:s.top+i.scrollTop-c.y,width:s.width,height:s.height}}const Ic={getClippingRect:function(r){let{element:t,boundary:e,rootBoundary:o,strategy:a}=r;const s=[...e==="clippingAncestors"?function(n,l){const p=l.get(n);if(p)return p;let d=ye(n).filter(v=>gt(v)&&$t(v)!=="body"),g=null;const h=ft(n).position==="fixed";let b=h?fe(n):n;for(;gt(b)&&!Kr(b);){const v=ft(b),w=Wr(b);v.position==="fixed"&&(g=null),(h?w||g:w||v.position!=="static"||!g||!["absolute","fixed"].includes(g.position))?g=v:d=d.filter(f=>f!==b),b=fe(b)}return l.set(n,d),d}(t,this._c):[].concat(e),o],i=s[0],c=s.reduce((n,l)=>{const p=As(t,l,a);return n.top=ve(p.top,n.top),n.right=ks(p.right,n.right),n.bottom=ks(p.bottom,n.bottom),n.left=ve(p.left,n.left),n},As(t,i,a));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}},convertOffsetParentRelativeRectToViewportRelativeRect:function(r){let{rect:t,offsetParent:e,strategy:o}=r;const a=dt(e),s=qt(e);if(e===s)return t;let i={scrollLeft:0,scrollTop:0},c={x:1,y:1};const n={x:0,y:0};if((a||!a&&o!=="fixed")&&(($t(e)!=="body"||We(s))&&(i=Ke(e)),dt(e))){const l=_t(e);c=se(e),n.x=l.x+e.clientLeft,n.y=l.y+e.clientTop}return{width:t.width*c.x,height:t.height*c.y,x:t.x*c.x-i.scrollLeft*c.x+n.x,y:t.y*c.y-i.scrollTop*c.y+n.y}},isElement:gt,getDimensions:function(r){return ws(r)},getOffsetParent:Hs,getDocumentElement:qt,getScale:se,async getElementRects(r){let{reference:t,floating:e,strategy:o}=r;const a=this.getOffsetParent||Hs,s=this.getDimensions;return{reference:Hc(t,await a(e),o),floating:{x:0,y:0,...await s(e)}}},getClientRects:r=>Array.from(r.getClientRects()),isRTL:r=>ft(r).direction==="rtl"},Sc=(r,t,e)=>{const o=new Map,a={platform:Ic,...e},s={...a.platform,_c:o};return(async(i,c,n)=>{const{placement:l="bottom",strategy:p="absolute",middleware:d=[],platform:g}=n,h=d.filter(Boolean),b=await(g.isRTL==null?void 0:g.isRTL(c));let v=await g.getElementRects({reference:i,floating:c,strategy:p}),{x:w,y:f}=gs(v,l,b),C=l,j={},A=0;for(let E=0;E<h.length;E++){const{name:z,fn:x}=h[E],{x:S,y:U,data:N,reset:I}=await x({x:w,y:f,initialPlacement:l,placement:C,strategy:p,middlewareData:j,rects:v,platform:g,elements:{reference:i,floating:c}});w=S!=null?S:w,f=U!=null?U:f,j={...j,[z]:{...j[z],...N}},I&&A<=50&&(A++,typeof I=="object"&&(I.placement&&(C=I.placement),I.rects&&(v=I.rects===!0?await g.getElementRects({reference:i,floating:c,strategy:p}):I.rects),{x:w,y:f}=gs(v,C,b)),E=-1)}return{x:w,y:f,placement:C,strategy:p,middlewareData:j}})(r,t,{...a,platform:s})};var Tc=Object.defineProperty,Lc=Object.getOwnPropertyDescriptor,ke=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Lc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Tc(t,e,s),s};const Is={initial:"idle",states:{idle:{on:{active:"active"}},active:{on:{hiding:"hiding",idle:"idle"}},hiding:{on:{dispose:"dispose"}},dispose:{on:{disposed:"disposed"}},disposed:{on:{}}}},Ss=(r,t)=>r?t&&Is.states[r].on[t]||r:Is.initial,Dc=r=>{var t;return(t={left:["right","bottom","top"],"left-start":["right-start","bottom","top"],"left-end":["right-end","bottom","top"],right:["left","bottom","top"],"right-start":["left-start","bottom","top"],"right-end":["left-end","bottom","top"],top:["bottom","left","right"],"top-start":["bottom-start","left","right"],"top-end":["bottom-end","left","right"],bottom:["top","left","right"],"bottom-start":["top-start","left","right"],"bottom-end":["top-end","left","right"]}[r])!=null?t:[r]},Ts=class extends M{constructor(){super(),this.contentAnimationPromise=Promise.resolve(!0),this.resolveContentAnimationPromise=()=>{},this._state=Ss(),this.animating=!1,this.theme={},this.tabbingAway=!1,this.offset=6,this.skidding=0,this.interaction="hover",this.positionAnimationFrame=0,this.willNotifyClosed=!1,this.isConstrained=!1,this.updateOverlayPosition=()=>{this.interaction!=="modal"&&this.cleanup?this.dispatchEvent(new Event("close")):this.setOverlayPosition()},this.resetOverlayPosition=()=>{this.style.removeProperty("max-height"),this.style.removeProperty("height"),this.initialHeight=void 0,this.isConstrained=!1,this.offsetHeight,this.setOverlayPosition()},this.setOverlayPosition=async()=>{if(!this.placement||this.placement==="none")return;function r(n){const l=window.devicePixelRatio||1;return Math.round(n*l)/l||-1e4}await(document.fonts?document.fonts.ready:Promise.resolve());const t=this.virtualTrigger?bs({padding:8,fallbackPlacements:Dc(this.placement)}):bs({padding:8}),e=[jc({mainAxis:this.offset,crossAxis:this.skidding}),(o={padding:8},o===void 0&&(o={}),{name:"shift",options:o,async fn(n){const{x:l,y:p,placement:d}=n,{mainAxis:g=!0,crossAxis:h=!1,limiter:b={fn:x=>{let{x:S,y:U}=x;return{x:S,y:U}}},...v}=o,w={x:l,y:p},f=await Ur(n,v),C=oe(Dt(d)),j=C==="x"?"y":"x";let A=w[C],E=w[j];if(g){const x=C==="y"?"bottom":"right";A=Fr(A+f[C==="y"?"top":"left"],A,A-f[x])}if(h){const x=j==="y"?"bottom":"right";E=Fr(E+f[j==="y"?"top":"left"],E,E-f[x])}const z=b.fn({...n,[C]:A,[j]:E});return{...z,data:{x:z.x-l,y:z.y-p}}}}),t,Ac({padding:8,apply:({availableWidth:n,availableHeight:l,rects:{floating:p}})=>{const d=Math.max(100,Math.floor(l)),g=p.height;this.initialHeight=(this.isConstrained||this.virtualTrigger)&&this.initialHeight||g,this.isConstrained=g<this.initialHeight||d<=g;const h=this.isConstrained?`${d}px`:"";Object.assign(this.style,{maxWidth:`${Math.floor(n)}px`,maxHeight:h,height:h})}})];var o;this.overlayContentTip&&e.push((n=>({name:"arrow",options:n,async fn(l){const{element:p,padding:d=0}=n||{},{x:g,y:h,placement:b,rects:v,platform:w,elements:f}=l;if(p==null)return{};const C=hs(d),j={x:g,y:h},A=oe(b),E=Rr(A),z=await w.getDimensions(p),x=A==="y",S=x?"top":"left",U=x?"bottom":"right",N=x?"clientHeight":"clientWidth",I=v.reference[E]+v.reference[A]-j[A]-v.floating[E],B=j[A]-v.reference[A],T=await(w.getOffsetParent==null?void 0:w.getOffsetParent(p));let P=T?T[N]:0;P&&await(w.isElement==null?void 0:w.isElement(T))||(P=f.floating[N]||v.floating[E]);const F=I/2-B/2,O=C[S],J=P-z[E]-C[U],W=P/2-z[E]/2+F,at=Fr(O,W,J),Bt=re(b)!=null&&W!=at&&v.reference[E]/2-(W<O?C[S]:C[U])-z[E]/2<0;return{[A]:j[A]-(Bt?W<O?O-W:J-W:0),data:{[A]:at,centerOffset:W-at}}}}))({element:this.overlayContentTip}));const{x:a,y:s,placement:i,middlewareData:c}=await Sc(this.virtualTrigger||this.trigger,this,{placement:this.placement,middleware:e,strategy:"fixed"});if(Object.assign(this.style,{top:"0px",left:"0px",transform:`translate(${r(a)}px, ${r(s)}px)`}),i!==this.getAttribute("actual-placement")&&(this.setAttribute("actual-placement",i),this.overlayContent.setAttribute("placement",i)),this.overlayContentTip&&c.arrow){const{x:n,y:l}=c.arrow;Object.assign(this.overlayContentTip.style,{left:n!=null?`${r(n)}px`:"",top:l!=null?`${r(l)}px`:"",right:"",bottom:""})}},this.handleInlineTriggerKeydown=r=>{const{code:t,shiftKey:e}=r;if(t==="Tab"){if(e)return this.tabbingAway=!0,void this.dispatchEvent(new Event("close"));r.stopPropagation(),r.preventDefault(),this.focus()}},this.stealOverlayContentPromise=Promise.resolve(),this.stealOverlayContentPromise=new Promise(r=>this.stealOverlayContentResolver=r)}get state(){return this._state}set state(r){const t=Ss(this.state,r);t!==this.state&&(this._state=t,this.state==="active"||this.state==="hiding"?this.setAttribute("state",this.state):this.removeAttribute("state"))}async focus(){const r=br(this);if(r){r.updateComplete&&await r.updateComplete;const t=this.getRootNode().activeElement;(t===this||!this.contains(t))&&r.focus()}else super.focus();this.removeAttribute("tabindex")}get hasTheme(){return!!this.theme.color||!!this.theme.scale||!!this.theme.lang}static get styles(){return[xc]}get hasModalRoot(){return!!this._modalRoot}feature(){this.contains(document.activeElement)||(this.tabIndex=-1);const r=ee(this.trigger);r&&r.slot==="open"&&(this._modalRoot=r._modalRoot||r),(this.interaction==="modal"||this._modalRoot)&&(this.slot="open",this.interaction==="modal"&&this.setAttribute("aria-modal","true"),this._modalRoot&&(r==null||r.feature()))}obscure(r){if(this.slot&&r==="modal"){if(this.removeAttribute("slot"),this.removeAttribute("aria-modal"),this.interaction!=="modal"){const t=ee(this.trigger);return this._modalRoot=t==null?void 0:t.obscure(r),this._modalRoot}return this}}async willUpdate(){this.hasUpdated||!this.overlayContent||!this.trigger||(this.stealOverlayContent(this.overlayContent),this.state="active",this.feature(),this.placement&&this.placement!=="none"&&(await this.updateOverlayPosition(),document.addEventListener("sp-update-overlays",this.resetOverlayPosition)),this.placement&&this.placement!=="none"&&(this.contentAnimationPromise=this.applyContentAnimation("sp-overlay-fade-in")))}async openCallback(r){await this.updateComplete,this.receivesFocus&&await this.focus(),await r(),this.trigger.dispatchEvent(new CustomEvent("sp-opened",{bubbles:!0,composed:!0,cancelable:!0,detail:{interaction:this.interaction}}))}open(r){this.extractDetail(r)}extractDetail(r){this.overlayContent=r.content,this.overlayContentTip=r.contentTip,this.trigger=r.trigger,this.virtualTrigger=r.virtualTrigger,this.placement=r.placement,this.offset=r.offset,this.skidding=r.skidding||0,this.interaction=r.interaction,this.theme=r.theme,this.receivesFocus=r.receivesFocus,this.root=r.root}dispose(){this.state==="dispose"&&(this.timeout&&(clearTimeout(this.timeout),delete this.timeout),this.trigger.removeEventListener("keydown",this.handleInlineTriggerKeydown),this.returnOverlayContent(),this.state="disposed",this.willNotifyClosed&&(this.overlayContent.dispatchEvent(new Event("sp-overlay-closed")),this.willNotifyClosed=!1),this.cleanup&&this.cleanup())}stealOverlayContent(r){this.originalPlacement=r.getAttribute("placement"),this.restoreContent=zr([r],this,{position:"beforeend",prepareCallback:t=>{const e=t.slot,o=t.placement;return t.removeAttribute("slot"),a=>{a.slot=e,a.placement=o}}}),this.stealOverlayContentResolver()}returnOverlayContent(){if(!this.restoreContent)return;const[r]=this.restoreContent();this.restoreContent=void 0,this.willNotifyClosed=!0,this.originalPlacement&&(r.setAttribute("placement",this.originalPlacement),delete this.originalPlacement)}async placeOverlay(){!this.placement||this.placement==="none"||(this.cleanup=function(r,t,e,o){o===void 0&&(o={});const{ancestorScroll:a=!0,ancestorResize:s=!0,elementResize:i=!0,animationFrame:c=!1}=o,n=a&&!c,l=n||s?[...gt(r)?ye(r):r.contextElement?ye(r.contextElement):[],...ye(t)]:[];l.forEach(h=>{n&&h.addEventListener("scroll",e,{passive:!0}),s&&h.addEventListener("resize",e)});let p,d=null;i&&(d=new ResizeObserver(()=>{e()}),gt(r)&&!c&&d.observe(r),gt(r)||!r.contextElement||c||d.observe(r.contextElement),d.observe(t));let g=c?_t(r):null;return c&&function h(){const b=_t(r);!g||b.x===g.x&&b.y===g.y&&b.width===g.width&&b.height===g.height||e(),g=b,p=requestAnimationFrame(h)}(),e(),()=>{var h;l.forEach(b=>{n&&b.removeEventListener("scroll",e),s&&b.removeEventListener("resize",e)}),(h=d)==null||h.disconnect(),d=null,c&&cancelAnimationFrame(p)}}(this.virtualTrigger||this.trigger,this,this.updateOverlayPosition,{elementResize:!1}))}async hide(r=!0){this.state==="active"&&(this.state="hiding",r&&await this.applyContentAnimation("sp-overlay-fade-out"),this.state="dispose")}schedulePositionUpdate(){cancelAnimationFrame(this.positionAnimationFrame),this.positionAnimationFrame=requestAnimationFrame(()=>{this.cleanup?this.updateOverlayPosition():this.placeOverlay()})}onSlotChange(){this.schedulePositionUpdate()}applyContentAnimation(r){return this.placement==="none"?Promise.resolve(!0):(this.resolveContentAnimationPromise(),new Promise(t=>{this.resolveContentAnimationPromise=()=>{t(!1)};const e=this.shadowRoot.querySelector("#contents"),o=a=>{r===a.animationName&&(e.removeEventListener("animationend",o),e.removeEventListener("animationcancel",o),this.animating=!1,t(a.type==="animationcancel"))};e.addEventListener("animationend",o),e.addEventListener("animationcancel",o),e.style.animationName=r,this.animating=!0}))}renderTheme(r){const{color:t,scale:e,lang:o,theme:a}=this.theme;return u`
            <sp-theme
                theme=${H(a)}
                color=${H(t)}
                scale=${H(e)}
...
`,Rc=Object.defineProperty,Uc=Object.getOwnPropertyDescriptor,Q=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Uc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Rc(t,e,s),s};const Yr=3840;class X extends M{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Yr,this.secondaryMin=0,this.secondaryMax=Yr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Yr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[_c]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return u`
            <slot
      ...
      `]}});class Nc{constructor(){V(this,"listeners",[])}addEventListener(t,e){const o={type:t,callback:e};return this.listeners.push(o),o}removeEventListener(t){for(let e=0;e<this.listeners.length;e++)if(t===this.listeners[e])return void this.listeners.splice(e,1)}removeEventListeners(t){t.forEach(e=>{this.removeEventListener(e)})}dispatchEvent(t){this.listeners.slice().forEach(e=>{t.type===e.type&&e.callback.apply(this,[t])})}}class q extends Nc{constructor(){return super(),q._instance||(q._instance=this),q._instance}static get instance(){return q._instance||(q._instance=new q),q._instance}}V(q,"_instance",void 0);const Fc={initialized:!1,activePlugin:void 0,searchQuery:"",context:{},localeDict:{}};class D{static init(){D.appStore=function(t={},e="store"){function o(a,s,i){const c=new CustomEvent(s,{bubbles:!0,cancelable:!0,detail:i});return q.instance.dispatchEvent(c)}return new Proxy(t,function a(s,i){return{get:(c,n)=>n==="_isProxy"||(typeof c[n]=="object"&&c[n]!==null&&!c[n]._isProxy&&(c[n]=new Proxy(c[n],a(s,i))),c[n]),set:(c,n,l)=>(c[n]===l||(c[n]=l,o(0,n,i)),!0),deleteProperty:(c,n)=>(delete c[n],o(0,n,i),!0)}}(e,t))}(Fc,"app"),D.appStore.webRoot=window.libraryDev?"./src":D.libraryHost}}async function qs(r){const t=await fetch(r);if(t.status===401)(async function(e){const o=await fetch(e,{credentials:"include"});if(o.status===401)window.open(new URL(origin).origin,"_self");else if(!o.ok)throw new Error("unable to load library JSON");o.json()})(r);else if(!t.ok)throw new Error("unable to load library JSON");return t.json()}function Nt(){return window.libraryDev}async function Vc(){const{context:r}=D.appStore;r.baseLibraryOrigin=Nt()?new URL(r.base).origin:window.location.origin;try{const t=await async function(o){const{base:a}=o,s=await qs(Xe(a)?`${o.baseLibraryOrigin}${a}`:a),i=s.data?s:s.blocks;return i&&i.data.forEach(c=>{c.path&&(c.path.includes("://")&&(c.path=new URL(c.path).pathname),c.url=`${o.baseLibraryOrigin}${c.path}`,c.path=`${c.path}`,c.extended=!1)}),s}(r),e=await async function(o){if(o.extends){const{extends:a}=o,{origin:s}=new URL(a),i=await qs(a),c=i.data?i:i.blocks;return c&&c.data.forEach(n=>{const{path:l}=n;if(l){const p=Xe(l);n.url=p?`${s}${l}`:l,n.path=p?`${l}`:new URL(l).pathname,n.extended=!0}}),o.extendedLibraryOrigin=s,i}return Promise.resolve()}(r);r.libraries=await async function(o,a){const s={};if(o[":type"]==="multi-sheet")for(const i of o[":names"])s[i]=o[i].data;else s.blocks=o.data;if(a)if(a[":type"]==="multi-sheet")for(const i of a[":names"])s[i]?s[i].push(...a[i].data):s[i]=a[i].data;else s.blocks=[...s.blocks||[],...a.data];return s}(t,e),q.instance.dispatchEvent(new CustomEvent(st.LIBRARY_LOADED))}catch(t){q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:{variant:"negative",message:D.appStore.localeDict.errorLoadingLibraryJSON}})),console.error("Unable to load library",t)}}async function Bs(r,t){const{appStore:e}=r,{context:o}=e,a={blocks:Nt()?"../../src/plugins/blocks/blocks.js":`${D.libraryHost}/plugins/blocks/blocks.js`,tags:Nt()?"../../src/plugins/tags/tags.js":`${D.libraryHost}/plugins/tags/tags.js`,"api-test":Nt()?"../../src/plugins/api-test/api-test.js":`${D.libraryHost}/plugins/api-test/api-test.js`};let s="plugins"in o?function(i,c){const n=c.plugins[i];if(n&&"src"in n){const{src:l}=n;return Xe(l)?`${c.baseLibraryOrigin}${l}`:l}}(t,o):function(i,c){const n=c[i];if(n)return Xe(n)?`${c.baseLibraryOrigin}${n}`:n}(t,o);if(s||(s=a[t]),s)try{const i=await import(s);o.activePlugin={config:i.default,data:e.context.libraries[t],path:s,decorate:i.decorate},q.instance.dispatchEvent(new CustomEvent(st.PLUGIN_LOADED))}catch(i){q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:{variant:"negative",message:r.appStore.localeDict.errorLoadingPlugin}})),Ps(r),console.error(`Error loading plugin ${t}: ${i.message}`)}else q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:{variant:"negative",message:r.appStore.localeDict.unknownPlugin}}))}async function Ps(r){const{appStore:t}=r;t.context.activePlugin=void 0,q.instance.dispatchEvent(new CustomEvent(st.PLUGIN_UNLOADED))}V(D,"libraryHost","https://main--franklin-library-host--dylandepass.hlx.live/tools/sidekick/library"),V(D,"appStore",void 0);class Qr extends ct{connectedCallback(){super.connectedCallback(),q.instance.addEventListener(st.LIBRARY_LOADED,()=>{const{context:t}=D.appStore,{libraries:e}=t,o=Object.keys(e);this.libraries=e;let a=o.includes("blocks")?"blocks":o[0];const s=new URLSearchParams(window.location.search);s.has("plugin")&&(a=s.get("plugin")),Bs(D,a)}),q.instance.addEventListener(st.PLUGIN_LOADED,()=>{const{context:t}=D.appStore;if(t.activePlugin){const{activePlugin:e}=t,{searchEnabled:o}=e.config;o&&(this.searchEnabled=!0),this.pluginActive=!0,this.defaultPluginName=e.config.title.toLowerCase().replace(" ","-"),function(a,s=[]){const i=new URL(window.location.href);a.forEach(([n,l])=>{i.searchParams.set(n,l)}),s.forEach(n=>{i.searchParams.delete(n)});const{href:c}=i;window.history.pushState({path:c},"",decodeURIComponent(c))}([["plugin",this.defaultPluginName]])}}),q.instance.addEventListener(st.PLUGIN_UNLOADED,()=>{this.pluginActive=!1,this.searchEnabled=!1,this.searchActivated=!1;const t=this.renderRoot.querySelector(".middle-bar");t==null||t.classList.remove("search-active"),this.renderRoot.querySelector("sp-search").value=""})}activateSearch(){const t=this.renderRoot.querySelector(".middle-bar");this.searchActivated=!this.searchActivated,this.searchActivated?t==null||t.classList.add("search-active"):t==null||t.classList.remove("search-active");const e=this.renderRoot.querySelector("sp-search");e==null||e.focus()}async onPluginChange(t){const{value:e}=t.target;(function(){const o=new URL(window.location.href),a=`${o.origin}${o.pathname}`;window.history.pushState({path:a},"",a)})(),Ps(D),await Bs(D,e)}onSearch(t){D.appStore.searchQuery=t.target.value,q.instance.dispatchEvent(new CustomEvent(st.SEARCH_UPDATED))}renderLibraries(){if(this.libraries){const t=Object.keys(this.libraries);return u`
        <sp-picker
          quiet 
  ...
  `),customElements.define("library-header",Qr);class Jr extends ct{connectedCallback(){super.connectedCallback()}render(){return u`
  ...
  `),customElements.define("plugin-renderer",_s);class eo extends ct{constructor(){super(),this.type="hierarchical"}onPreview(t,e){this.dispatchEvent(new CustomEvent("PreviewBlock",{detail:{path:e}})),window.open(e,"_blank")}renderNoResults(){return`
      <div class="message-container">
    ...
    `}filterBlocks(t){const e=this.renderRoot.querySelector(".message-container"),o=this.renderRoot.querySelectorAll("sp-sidenav-item"),a=this.renderRoot.querySelectorAll("sp-sidenav-item > sp-sidenav-item"),s=this.renderRoot.querySelectorAll("sp-sidenav > sp-sidenav-item");let i=!0;if(t==="")return o.forEach(c=>{c.removeAttribute("aria-hidden"),c.removeAttribute("expanded")}),void(e&&e.remove());a.forEach(c=>{var n;const l=c.getAttribute("label").toLowerCase(),p=(n=c.dataset.searchTags)!=null?n:"";l.includes(t.toLowerCase())||p.split(",").some(d=>d.toLowerCase().includes(t.toLowerCase()))?c.removeAttribute("aria-hidden"):c.setAttribute("aria-hidden",!0)}),s.forEach(c=>{let n=!1;c.querySelectorAll("sp-sidenav-item").forEach(l=>{l.hasAttribute("aria-hidden")||(n=!0,i=!1,e&&e.remove())}),n?(c.setAttribute("expanded",!0),c.removeAttribute("aria-hidden")):c.setAttribute("aria-hidden",!0)}),i&&!e&&this.renderRoot.append(ht("div",{},this.renderNoResults()))}async loadBlocks(t,e){var o;const a=new URLSearchParams(window.location.search),s=a.has("path")?a.get("path"):void 0,i=a.has("index")?a.get("index"):void 0,c=ht("div",{class:"list-container"});if(this.type==="hierarchical"){const n=ht("sp-sidenav",{variant:"multilevel","data-testid":"blocks"});c.append(n);const l=[];let p;const d=t.map(async g=>{var h,b,v,w,f;const{url:C,path:j}=g,A=async function(E){if(window.blocks||(window.blocks={}),!window.blocks[E]){const z=await fetch(`${E}.plain.html`);if(!z.ok)return;const x=await z.text(),S=new DOMParser().parseFromString(x,"text/html");window.blocks[E]=S}return window.blocks[E]}(C);try{const E=await A;if(!E)throw new Error(`An error occurred fetching ${g.name}`);const{body:z}=E.cloneNode(!0),x=(h=function(N){const I=N.querySelector(":scope > div > .library-metadata:only-child");if(I){const B=I.parentElement,T=Us(I.parentElement);return B.remove(),T}return{}}(z))!=null?h:{},S=(b=x.type)!=null?b:void 0,U=function(N){const I=N.querySelector(".page-metadata");if(I){const B=Rs(I,[],!1);return I.remove(),B}}(z);if(S&&S.toLowerCase()==="template"){p||(p=Ye("Templates","sp-icon-file-code",!0,!1),l.push(p));const N=(v=x.name)!=null?v:g.name,I=(f=(w=x.searchtags)!=null?w:x["search-tags"])!=null?f:"",B=Ye(N,"sp-icon-file-code",!1,!0,"sp-icon-copy");I&&B.setAttribute("data-search-tags",I);const T={detail:{blockWrapper:z,blockData:g,blockURL:C,defaultLibraryMetadata:x,pageMetadata:U}};B.addEventListener("OnAction",P=>{P.preventDefault(),P.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",T))}),p.append(B),B.addEventListener("click",async()=>{this.dispatchEvent(new CustomEvent("LoadTemplate",T))}),s===j&&(p.setAttribute("expanded",!0),this.selectedItem=B,this.dispatchEvent(new CustomEvent("LoadTemplate",T)))}else{const N=Ye(g.name,"sp-icon-file-template",!0,!0,"sp-icon-preview");l.push(N),N.addEventListener("OnAction",T=>this.onPreview(T,C));const I=z.querySelectorAll(":scope > div");let B=0;I.forEach((T,P)=>{var F,O,J,W,at,Bt,ie;if(B>0)return void(B-=1);const ut=(F=Us(T))!=null?F:{},ze=T.querySelector("div[class]");let Ce=(O=ut.name)!=null?O:Ns(ze);const Ws=Ns(ze,!0),no=(Bt=(at=(W=(J=ut.searchtags)!=null?J:ut["search-tags"])!=null?W:x.searchtags)!=null?at:x["search-tags"])!=null?Bt:"";(!Ce||Ce==="section-metadata")&&(Ce="Unnamed Item");const wt=Ye(Ce,"sp-icon-file-code",!1,!0,"sp-icon-copy");no&&wt.setAttribute("data-search-tags",no),ut.compoundBlock=!1;const lo=(ie=T.querySelectorAll("div[class]:not(.section-metadata)").length)!=null?ie:0;if(ut.includeNextSections){const xt=Number(ut.includeNextSections);if(!Number.isNaN(xt)){const er=document.createElement("body");let uo=0;for(;uo<xt;){const Gs=T.nextElementSibling;er.append(Gs),uo+=1}er.prepend(T),T=er,B=xt,ut.multiSectionBlock=!0}}else if(lo>0&&(T.querySelectorAll("body > :scope > p").length>0||lo>1)){const xt=document.createElement("body");xt.append(T),T=xt,ut.compoundBlock=!0}const tr={detail:{blockWrapper:T,blockNameWithVariant:Ws,blockData:g,blockURL:C,sectionLibraryMetadata:ut,defaultLibraryMetadata:x,pageMetadata:U,index:P}};wt.classList.add("descendant"),wt.setAttribute("data-index",P),wt.addEventListener("OnAction",xt=>{xt.preventDefault(),xt.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",tr))}),N.append(wt),wt.addEventListener("click",async()=>{this.selectedItem&&this.selectedItem.removeAttribute("selected"),wt.setAttribute("selected",!0),this.selectedItem=wt,this.dispatchEvent(new CustomEvent("LoadBlock",tr))}),s===j&&i===P.toString()&&(N.setAttribute("expanded",!0),this.selectedItem=wt,this.dispatchEvent(new CustomEvent("LoadBlock",tr)))})}return A}catch(E){console.error(E.message),e.dispatchEvent(new CustomEvent("Toast",{detail:{message:E.message,variant:"negative"}}))}});await Promise.all(d),n.append(...l.sort((g,h)=>{const b=g.getAttribute("label").toLowerCase(),v=h.getAttribute("label").toLowerCase();return b<v?-1:b>v?1:0})),setTimeout(()=>{this.selectedItem&&this.selectedItem.setAttribute("selected",!0)},1),n.querySelectorAll("sp-sidenav-item").length===0&&e.append(this.renderNoResults())}(o=this.renderRoot)==null||o.append(c)}}V(eo,"properties",{mutationObserver:{state:!1},selectedItem:{state:!1},type:{state:!0}}),V(eo,"styles",k`
    .list-container {
      width: 100%;
    }
  ...
  `),customElements.define("block-renderer",ro);var Gc=k`
...
`,Kc=Object.defineProperty,Zc=Object.getOwnPropertyDescriptor,Fs=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Zc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Kc(t,e,s),s};class oo extends M{constructor(){super(...arguments),this.label=""}static get styles(){return[Gc]}render(){return this.variant==="file"?(t=>u`
    <svg
        class="file"
        role="img"
        viewBox="0 0 128 128"
...
`)(this.label):u`
            <slot></slot>
        `}}Fs([m({type:String,reflect:!0})],oo.prototype,"variant",2),Fs([m()],oo.prototype,"label",2),y("sp-asset",oo);var Xc=Object.defineProperty,Yc=Object.getOwnPropertyDescriptor,so=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Yc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Xc(t,e,s),s};class Qe extends vt{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return u`
            <input
                id="input"
                ...
                @change=${this.handleChange}
            />
        `}}so([m({type:Boolean,reflect:!0})],Qe.prototype,"checked",2),so([m({type:Boolean,reflect:!0})],Qe.prototype,"readonly",2),so([tt("#input")],Qe.prototype,"inputElement",2),y("sp-icon-checkmark75",class extends L{render(){return rt(u),(({width:r=24,height:t=24,title:e="Checkmark75"}={})=>et`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
...
`,tn=Object.defineProperty,en=Object.getOwnPropertyDescriptor,ao=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?en(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&tn(t,e,s),s};const rn={s:u`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:u`
        ...
        ></sp-icon-dash300>
    `};class Je extends nt(Qe){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[Qc,Tr,Jc]}render(){return u`
            ${super.render()}
            <span id="box">
                ${rn[this.size]}
                ${on[this.size]}
        ...
        `}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),t.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}ao([m({type:Boolean,reflect:!0})],Je.prototype,"indeterminate",2),ao([m({type:Boolean,reflect:!0})],Je.prototype,"invalid",2),ao([m({type:Boolean,reflect:!0})],Je.prototype,"emphasized",2),y("sp-checkbox",Je);var sn=k`
:host{--spectrum-overlay-animation-distance:var(
--spectrum-picker-m-texticon-popover-offset-y,var(--spectrum-global-dimension-size-75)
...
`,an=Object.defineProperty,cn=Object.getOwnPropertyDescriptor,Vs=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?cn(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&an(t,e,s),s};class io extends M{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[sn]}render(){return u`
            <slot></slot>
        `}}Vs([m({type:Boolean,reflect:!0})],io.prototype,"opened",2),Vs([m({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],io.prototype,"textOnly",2),y("sp-quick-actions",io);var nn=k`
...
`],un=Object.defineProperty,mn=Object.getOwnPropertyDescriptor,yt=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?mn(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&un(t,e,s),s};class bt extends Le(nt(function(t,e){var o;const a=Array.isArray(e)?e:[e];return o=Zt,class extends t{constructor(...s){super(s),this[o]=new Map,this.managePresenceObservedSlot=()=>{let i=!1;a.forEach(c=>{const n=!!this.querySelector(c),l=this[Zt].get(c)||!1;i=i||l!==n,this[Zt].set(c,!!this.querySelector(c))}),i&&this.updateComplete.then(()=>{this.requestUpdate()})},new De(this,{config:{childList:!0,subtree:!0},callback:()=>{this.managePresenceObservedSlot()}}),this.managePresenceObservedSlot()}get slotContentIsPresent(){if(a.length===1)return this[Zt].get(a[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(s){if(this[Zt].has(s))return this[Zt].get(s)||!1;throw new Error(`The provided selector \`${s}\` is not being observed.`)}}}(Do(M),['[slot="cover-photo"]','[slot="preview"]']),{validSizes:["s","m"]})){constructor(){super(...arguments),this.variant="standard",this._selected=!1,this.heading="",this.horizontal=!1,this.focused=!1,this.toggles=!1,this.value="",this.subheading="",this.handleFocusin=t=>{this.focused=!0,t.composedPath()[0]===this?this.addEventListener("keydown",this.handleKeydown):this.removeEventListener("keydown",this.handleKeydown)}}static get styles(){return[os,ln,nn]}get selected(){return this._selected}set selected(t){t!==this.selected&&(this._selected=t,this.requestUpdate("selected",!this._selected))}get hasCoverPhoto(){return this.getSlotContentPresence('[slot="cover-photo"]')}get hasPreview(){return this.getSlotContentPresence('[slot="preview"]')}click(){var t;(t=this.likeAnchor)==null||t.click()}handleFocusout(t){this.focused=!1,t.composedPath()[0]===this&&this.removeEventListener("keydown",this.handleKeydown)}handleKeydown(t){const{code:e}=t;switch(e){case"Space":if(this.toggleSelected(),this.toggles){t.preventDefault();break}case"Enter":case"NumpadEnter":this.click()}}handleSelectedChange(t){t.stopPropagation(),this.selected=t.target.checked,this.announceChange()}toggleSelected(){this.toggles?(this.selected=!this.selected,this.announceChange()):this.dispatchEvent(new Event("click",{bubbles:!0,composed:!0}))}announceChange(){this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0,composed:!0}))||(this.selected=!this.selected)}stopPropagationOnHref(t){this.href&&t.stopPropagation()}handlePointerdown(t){if(t.composedPath().some(a=>a.localName==="a"))return;const e=+new Date,o=()=>{+new Date-e<200&&this.click(),this.removeEventListener("pointerup",o),this.removeEventListener("pointercancel",o)};this.addEventListener("pointerup",o),this.addEventListener("pointercancel",o)}get renderHeading(){return u`
    ...
    `}}V(co,"properties",{theme:void 0}),V(co,"styles",k`
    * {
  ...
  `),customElements.define("sidekick-library",co);
