...
`,qa=Object.defineProperty,$a=Object.getOwnPropertyDescriptor,fr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?$a(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&qa(t,r,s),s};class Ft extends function(t,r){var o;class a extends t{constructor(...i){super(i),this.slotHasContent=!1,new He(this,{config:{characterData:!0,subtree:!0},callback:c=>{for(const n of c)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[pr])return;const i=[...this[pr]].filter(c=>!!c.tagName||!!c.textContent&&c.textContent.trim());this.slotHasContent=i.length>0}update(i){if(!this.hasUpdated){const{childNodes:c}=this,n=[...c].filter(l=>l.tagName?r?l.getAttribute("slot")===r:!l.hasAttribute("slot"):!!l.textContent&&l.textContent.trim());this.slotHasContent=n.length>0}super.update(i)}firstUpdated(i){super.firstUpdated(i),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=pr,Lo([u({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),Lo([zo(r,!0)],a.prototype,o,2),a}(Ee(ht)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[La]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[m`
...
`,hi=Object.defineProperty,bi=Object.getOwnPropertyDescriptor,jr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?bi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&hi(t,r,s),s};const vi=["negative","positive","info","error","warning"];class De extends ${constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[gi]}set timeout(t){const r=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;r&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=r,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const r=this.variant;vi.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",r)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return m`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
...
`],Ti=Object.defineProperty,Di=Object.getOwnPropertyDescriptor,Xo=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Di(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ti(t,r,s),s};class qe extends ${constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[Zo,Si,Ii]}render(){return m`
        ...
        `}}qe.is="sp-illustrated-message",Xo([u()],qe.prototype,"heading",2),Xo([u()],qe.prototype,"description",2),f("sp-illustrated-message",qe),f("sp-icon-search",class extends H{render(){return F(m),(({width:e=24,height:t=24,hidden:r=!1,title:o="Search"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
...
`,Mi=Object.defineProperty,Ri=Object.getOwnPropertyDescriptor,Sr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ri(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Mi(t,r,s),s};const Ui={s:m`
    ...
    `,xl:m`
        ...
        ></sp-icon-dash300>
    `};class Be extends st($e){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[Oi,xr,_i]}render(){return m`
            ${super.render()}
            <span id="box">
                ${Ui[this.size]}
                ${Ni[this.size]}
        ...
        `}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),t.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}Sr([u({type:Boolean,reflect:!0})],Be.prototype,"indeterminate",2),Sr([u({type:Boolean,reflect:!0})],Be.prototype,"invalid",2),Sr([u({type:Boolean,reflect:!0})],Be.prototype,"emphasized",2),f("sp-checkbox",Be);var Fi=k`
...
`,dc=Object.defineProperty,gc=Object.getOwnPropertyDescriptor,ss=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?gc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&dc(t,r,s),s};const Lr=class extends wt{constructor(){super(),Lr.instances+=1,this.headerId=`sp-menu-group-label-${Lr.instances}`}static get styles(){return[...super.styles,pc]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return m`
        ...
        `}};let Oe=Lr;Oe.instances=0,ss([zo("header",!0)],Oe.prototype,"headerElements",2),ss([or()],Oe.prototype,"headerElement",2),f("sp-menu-group",Oe);var hc=k`
...
`,Ac=Object.defineProperty,Ec=Object.getOwnPropertyDescriptor,_e=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ec(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ac(t,r,s),s};class le extends ${constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[jc]}renderTip(){return m`
            <div id="tip">
                <svg
        ...
        `}}_e([u({type:Boolean,reflect:!0})],le.prototype,"dialog",2),_e([u({type:Boolean,reflect:!0})],le.prototype,"open",2),_e([u({reflect:!0})],le.prototype,"placement",2),_e([u({type:Boolean,reflect:!0})],le.prototype,"tip",2),f("sp-popover",le);var Hc=k`
