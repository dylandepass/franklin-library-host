...
`,Va=Object.defineProperty,Wa=Object.getOwnPropertyDescriptor,Er=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Wa(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Va(t,e,s),s};class Yt extends function(t,e){var o;class a extends t{constructor(...i){super(i),this.slotHasContent=!1,new De(this,{config:{characterData:!0,subtree:!0},callback:c=>{for(const n of c)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[kr])return;const i=[...this[kr]].filter(c=>!!c.tagName||!!c.textContent&&c.textContent.trim());this.slotHasContent=i.length>0}update(i){if(!this.hasUpdated){const{childNodes:c}=this,n=[...c].filter(l=>l.tagName?e?l.getAttribute("slot")===e:!l.hasAttribute("slot"):!!l.textContent&&l.textContent.trim());this.slotHasContent=n.length>0}super.update(i)}firstUpdated(i){super.firstUpdated(i),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=kr,Uo([m({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),Uo([Lo(e,!0)],a.prototype,o,2),a}(Le(bt)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[Fa]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[u`
...
`,Ja=Object.defineProperty,ti=Object.getOwnPropertyDescriptor,Ko=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?ti(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ja(t,e,s),s};class S extends R{static get styles(){return[Qa]}render(){return u`
            <slot></slot>
        `}}Ko([m()],S.prototype,"label",2),Ko([m({reflect:!0})],S.prototype,"size",2);var ei=Object.defineProperty,ri=Object.getOwnPropertyDescriptor,Ar=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?ri(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&ei(t,e,s),s};class Be extends S{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const e=this.parseIcon(this.name);t.detail.name===e.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o),this.updateIconPromise=this.updateIcon()}render(){return this.name?u`
                <div id="container"></div>
            `:this.src?u`
                <img src="${this.src}" alt=${H(this.label)} />
            `:super.render()}async updateIcon(){if(this.updateIconPromise&&await this.updateIconPromise,!this.name)return Promise.resolve();const t=this.parseIcon(this.name),e=yt.getInstance().getIconset(t.iconset);return e&&this.iconContainer?(this.iconContainer.innerHTML="",e.applyIconToElement(this.iconContainer,t.icon,this.size||"",this.label?this.label:"")):Promise.resolve()}parseIcon(t){const e=t.split(":");let o="default",a=t;return e.length>1&&(o=e[0],a=e[1]),{iconset:o,icon:a}}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.updateIconPromise,t}}let Hr;Ar([m()],Be.prototype,"src",2),Ar([m()],Be.prototype,"name",2),Ar([tt("#container")],Be.prototype,"iconContainer",2);const et=function(r,...t){return Hr?Hr(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},rt=r=>{Hr=r};y("sp-icon-cross75",class extends S{render(){return rt(u),(({width:r=24,height:t=24,title:e="Cross75"}={})=>et`<svg
...
`,oi=Object.defineProperty,si=Object.getOwnPropertyDescriptor;const ai={s:()=>u`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class Xo extends nt(Go){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Ya,Zo]}get buttonContent(){return[ai[this.size]()]}render(){return u`
...
`,ci=Object.defineProperty,ni=Object.getOwnPropertyDescriptor;const li={s:()=>u`
        <sp-icon-cross75
            slot="icon"
            class="icon spectrum-UIIcon-Cross75"
        ></sp-icon-cross75>
...
`;y("sp-icon-corner-triangle300",class extends S{render(){return rt(u),(({width:r=24,height:t=24,title:e="Corner Triangle300"}={})=>et`<svg
  ...
  >
    ...
    />
  </svg>`)()}});const K=function(r,...t){return Ir?Ir(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},Z=r=>{Ir=r};y("sp-icon-alert",class extends S{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Alert"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,zi=Object.defineProperty,Ci=Object.getOwnPropertyDescriptor;class Lr extends nt(R,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Lr.styles=[es],((r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ci(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&zi(t,e,s)})([m({type:Boolean,reflect:!0})],Lr.prototype,"vertical",2),y("sp-divider",Lr),y("sp-close-button",Yo),y("sp-icon-info",class extends S{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Info"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,Ei=Object.defineProperty,Ai=Object.getOwnPropertyDescriptor,Dr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ai(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ei(t,e,s),s};const Hi=["negative","positive","info","error","warning"];class Pe extends R{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[ji]}set timeout(t){const e=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;Hi.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
...
`,Oi=Object.defineProperty,Mi=Object.getOwnPropertyDescriptor,he=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Mi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Oi(t,e,s),s};class ee extends nt(R,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[Pi]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return u`
            <div class="track"></div>
            <div class="fills">
...
`],Ui=Object.defineProperty,Ni=Object.getOwnPropertyDescriptor,as=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ni(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ui(t,e,s),s};class Me extends R{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[ss,Ri,_i]}render(){return u`
        ...
        `}}Me.is="sp-illustrated-message",as([m()],Me.prototype,"heading",2),as([m()],Me.prototype,"description",2),y("sp-illustrated-message",Me),y("sp-icon-search",class extends S{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Search"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,Vi=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor;class is extends nt(R){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[Fi]}handleSlotchange({target:t}){t.assignedElements().forEach(e=>{e.size=this.size})}render(){return u`
...
`;class lc extends nt(R,{validSizes:["s","m","l"]}){static get styles(){return[es,nc]}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}}y("sp-menu-divider",lc);var uc=k`
...
`,yc=Object.defineProperty,kc=Object.getOwnPropertyDescriptor,Ue=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?kc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&yc(t,e,s),s};class be extends R{constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[fc]}renderTip(){return u`
            <div id="tip">
                <svg
...
`,_c=Object.defineProperty,Rc=Object.getOwnPropertyDescriptor,Q=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Rc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&_c(t,e,s),s};const Xr=3840;class X extends R{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Xr,this.secondaryMin=0,this.secondaryMax=Xr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Xr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Mc]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return u`
      ...
      </div>`}}M(Qr,"properties",{searchActivated:{type:Boolean},pluginActive:{type:Boolean},libraries:{type:Array},searchEnabled:{type:Boolean},defaultPluginName:{type:String}}),M(Qr,"styles",k`
    .search {
      padding: 10px 5px;
      display: grid;
  ...
  `),customElements.define("library-header",Qr);class Jr extends it{connectedCallback(){super.connectedCallback()}render(){return u`
      ...
      </div>`}}M(Jr,"properties",{heading:{type:String},description:{type:String}}),M(Jr,"styles",k`
    .message-container {
      width: 100%;
      height: 100%;
      display: flex;
  ...
  `),customElements.define("plugin-renderer",Ms);class ro extends it{constructor(){super(),this.type="hierarchical"}onPreview(t,e){this.dispatchEvent(new CustomEvent("PreviewBlock",{detail:{path:e}})),window.open(e,"_blank")}renderNoResults(){return`
    ...
    `}filterBlocks(t){const e=this.renderRoot.querySelector(".message-container"),o=this.renderRoot.querySelectorAll("sp-sidenav-item"),a=this.renderRoot.querySelectorAll("sp-sidenav-item > sp-sidenav-item"),s=this.renderRoot.querySelectorAll("sp-sidenav > sp-sidenav-item");let i=!0;if(t==="")return o.forEach(c=>{c.removeAttribute("aria-hidden"),c.removeAttribute("expanded")}),void(e&&e.remove());a.forEach(c=>{var n;const l=c.getAttribute("label").toLowerCase(),d=(n=c.dataset.searchTags)!=null?n:"";l.includes(t.toLowerCase())||d.split(",").some(p=>p.toLowerCase().includes(t.toLowerCase()))?c.removeAttribute("aria-hidden"):c.setAttribute("aria-hidden",!0)}),s.forEach(c=>{let n=!1;c.querySelectorAll("sp-sidenav-item").forEach(l=>{l.hasAttribute("aria-hidden")||(n=!0,i=!1,e&&e.remove())}),n?(c.setAttribute("expanded",!0),c.removeAttribute("aria-hidden")):c.setAttribute("aria-hidden",!0)}),i&&!e&&this.renderRoot.append(gt("div",{},this.renderNoResults()))}async loadBlocks(t,e){var o;const a=new URLSearchParams(window.location.search),s=a.has("path")?a.get("path"):void 0,i=a.has("index")?a.get("index"):void 0,c=gt("div",{class:"list-container"});if(this.type==="hierarchical"){const n=gt("sp-sidenav",{variant:"multilevel","data-testid":"blocks"});c.append(n);const l=[],d=t.map(async p=>{var h,g,b,f,w;const{url:v,path:j}=p,C=async function(z){if(window.blocks||(window.blocks={}),!window.blocks[z]){const A=await fetch(`${z}.plain.html`);if(!A.ok)return;const x=await A.text(),E=new DOMParser().parseFromString(x,"text/html");window.blocks[z]=E}return window.blocks[z]}(v);try{const z=await C;if(!z)throw new Error(`An error occurred fetching ${p.name}`);const{body:A}=z.cloneNode(!0),x=(h=function(F){const I=F.querySelector(":scope > div > .library-metadata:only-child");if(I){const B=I.parentElement,L=Rs(I.parentElement);return B.remove(),L}return{}}(A))!=null?h:{},E=(g=x.type)!=null?g:void 0,T=function(F){const I=F.querySelector(".page-metadata");if(I){const B=_s(I,[],!1);return I.remove(),B}}(A);let _;if(E&&E.toLowerCase()==="template"){_||(_=Xe("Templates","sp-icon-file-code",!0,!1),l.push(_));const F=(b=x.name)!=null?b:p.name,I=(w=(f=x.searchtags)!=null?f:x["search-tags"])!=null?w:"",B=Xe(F,"sp-icon-file-code",!1,!0,"sp-icon-copy");I&&B.setAttribute("data-search-tags",I);const L={detail:{blockWrapper:A,blockData:p,blockURL:v,defaultLibraryMetadata:x,pageMetadata:T}};B.addEventListener("OnAction",P=>{P.preventDefault(),P.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",L))}),_.append(B),B.addEventListener("click",async()=>{this.dispatchEvent(new CustomEvent("LoadTemplate",L))}),s===j&&(_.setAttribute("expanded",!0),this.selectedItem=B,this.dispatchEvent(new CustomEvent("LoadTemplate",L)))}else{const F=Xe(p.name,"sp-icon-file-template",!0,!0,"sp-icon-preview");l.push(F),F.addEventListener("OnAction",L=>this.onPreview(L,v));const I=A.querySelectorAll(":scope > div");let B=0;I.forEach((L,P)=>{var V,O,J,W,at,Bt;if(B>0)return void(B-=1);const kt=(V=Rs(L))!=null?V:{},Ce=L.querySelector("div[class]");let Ft=(O=kt.name)!=null?O:Us(Ce);const Vs=Us(Ce,!0),uo=(Bt=(at=(W=(J=kt.searchtags)!=null?J:kt["search-tags"])!=null?W:x.searchtags)!=null?at:x["search-tags"])!=null?Bt:"";(!Ft||Ft==="section-metadata")&&(Ft="Unnamed Item");const wt=Xe(Ft,"sp-icon-file-code",!1,!0,"sp-icon-copy");if(uo&&wt.setAttribute("data-search-tags",uo),kt.includeNextSections){const xt=Number(kt.includeNextSections);if(!Number.isNaN(xt)){const tr=document.createElement("body");let mo=0;for(;mo<xt;){const Ws=L.nextElementSibling;tr.append(Ws),mo+=1}tr.prepend(L),L=tr,B=xt,x.multiSectionBlock=!0}}else if(L.querySelectorAll("div[class]:not(.section-metadata)").length>1){const xt=document.createElement("body");xt.append(L),L=xt,x.compoundBlock=!0}const Je={detail:{blockWrapper:L,blockNameWithVariant:Vs,blockData:p,blockURL:v,sectionLibraryMetadata:kt,defaultLibraryMetadata:x,pageMetadata:T,index:P}};wt.classList.add("descendant"),wt.setAttribute("data-index",P),wt.addEventListener("OnAction",xt=>{xt.preventDefault(),xt.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",Je))}),F.append(wt),wt.addEventListener("click",async()=>{this.selectedItem&&this.selectedItem.removeAttribute("selected"),wt.setAttribute("selected",!0),this.selectedItem=wt,this.dispatchEvent(new CustomEvent("LoadBlock",Je))}),s===j&&i===P.toString()&&(F.setAttribute("expanded",!0),this.selectedItem=wt,this.dispatchEvent(new CustomEvent("LoadBlock",Je)))})}return C}catch(z){console.error(z.message),e.dispatchEvent(new CustomEvent("Toast",{detail:{message:z.message,variant:"negative"}}))}});await Promise.all(d),n.append(...l.sort((p,h)=>{const g=p.getAttribute("label").toLowerCase(),b=h.getAttribute("label").toLowerCase();return g<b?-1:g>b?1:0})),setTimeout(()=>{this.selectedItem&&this.selectedItem.setAttribute("selected",!0)},1),n.querySelectorAll("sp-sidenav-item").length===0&&e.append(this.renderNoResults())}(o=this.renderRoot)==null||o.append(c)}}M(ro,"properties",{mutationObserver:{state:!1},selectedItem:{state:!1},type:{state:!0}}),M(ro,"styles",k`
    .list-container {
      width: 100%;
    }
...
`,Gc=Object.defineProperty,Kc=Object.getOwnPropertyDescriptor,Ns=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Kc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Gc(t,e,s),s};class so extends R{constructor(){super(...arguments),this.label=""}static get styles(){return[Wc]}render(){return this.variant==="file"?(t=>u`
    <svg
        class="file"
        role="img"
        viewBox="0 0 128 128"
...
`)(this.label):u`
        ...
        `}}Ns([m({type:String,reflect:!0})],so.prototype,"variant",2),Ns([m()],so.prototype,"label",2),y("sp-asset",so);var Zc=Object.defineProperty,Xc=Object.getOwnPropertyDescriptor,ao=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Xc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Zc(t,e,s),s};class Ye extends bt{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return u`
            <input
                ...
                @change=${this.handleChange}
            />
        `}}ao([m({type:Boolean,reflect:!0})],Ye.prototype,"checked",2),ao([m({type:Boolean,reflect:!0})],Ye.prototype,"readonly",2),ao([tt("#input")],Ye.prototype,"inputElement",2),y("sp-icon-checkmark75",class extends S{render(){return rt(u),(({width:r=24,height:t=24,title:e="Checkmark75"}={})=>et`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
...
`,Jc=Object.defineProperty,tn=Object.getOwnPropertyDescriptor,io=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?tn(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Jc(t,e,s),s};const en={s:u`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:u`
        ...
        ></sp-icon-dash300>
    `};class Qe extends nt(Ye){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[Yc,Sr,Qc]}render(){return u`
            ${super.render()}
            <span id="box">
                ${en[this.size]}
                ${rn[this.size]}
...
`,sn=Object.defineProperty,an=Object.getOwnPropertyDescriptor,Fs=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?an(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&sn(t,e,s),s};class co extends R{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[on]}render(){return u`
            <slot></slot>
...
`],ln=Object.defineProperty,un=Object.getOwnPropertyDescriptor,ft=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?un(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&ln(t,e,s),s};class ht extends Le(nt(function(t,e){var o;const a=Array.isArray(e)?e:[e];return o=Xt,class extends t{constructor(...s){super(s),this[o]=new Map,this.managePresenceObservedSlot=()=>{let i=!1;a.forEach(c=>{const n=!!this.querySelector(c),l=this[Xt].get(c)||!1;i=i||l!==n,this[Xt].set(c,!!this.querySelector(c))}),i&&this.updateComplete.then(()=>{this.requestUpdate()})},new De(this,{config:{childList:!0,subtree:!0},callback:()=>{this.managePresenceObservedSlot()}}),this.managePresenceObservedSlot()}get slotContentIsPresent(){if(a.length===1)return this[Xt].get(a[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(s){if(this[Xt].has(s))return this[Xt].get(s)||!1;throw new Error(`The provided selector \`${s}\` is not being observed.`)}}}($o(R),['[slot="cover-photo"]','[slot="preview"]']),{validSizes:["s","m"]})){constructor(){super(...arguments),this.variant="standard",this._selected=!1,this.heading="",this.horizontal=!1,this.focused=!1,this.toggles=!1,this.value="",this.subheading="",this.handleFocusin=t=>{this.focused=!0,t.composedPath()[0]===this?this.addEventListener("keydown",this.handleKeydown):this.removeEventListener("keydown",this.handleKeydown)}}static get styles(){return[ss,nn,cn]}get selected(){return this._selected}set selected(t){t!==this.selected&&(this._selected=t,this.requestUpdate("selected",!this._selected))}get hasCoverPhoto(){return this.getSlotContentPresence('[slot="cover-photo"]')}get hasPreview(){return this.getSlotContentPresence('[slot="preview"]')}click(){var t;(t=this.likeAnchor)==null||t.click()}handleFocusout(t){this.focused=!1,t.composedPath()[0]===this&&this.removeEventListener("keydown",this.handleKeydown)}handleKeydown(t){const{code:e}=t;switch(e){case"Space":if(this.toggleSelected(),this.toggles){t.preventDefault();break}case"Enter":case"NumpadEnter":this.click()}}handleSelectedChange(t){t.stopPropagation(),this.selected=t.target.checked,this.announceChange()}toggleSelected(){this.toggles?(this.selected=!this.selected,this.announceChange()):this.dispatchEvent(new Event("click",{bubbles:!0,composed:!0}))}announceChange(){this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0,composed:!0}))||(this.selected=!this.selected)}stopPropagationOnHref(t){this.href&&t.stopPropagation()}handlePointerdown(t){if(t.composedPath().some(a=>a.localName==="a"))return;const e=+new Date,o=()=>{+new Date-e<200&&this.click(),this.removeEventListener("pointerup",o),this.removeEventListener("pointercancel",o)};this.addEventListener("pointerup",o),this.addEventListener("pointercancel",o)}get renderHeading(){return u`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.addEventListener("pointerdown",this.handlePointerdown),this.addEventListener("focusin",this.handleFocusin),this.shadowRoot.addEventListener("focusin",this.handleFocusin),this.addEventListener("focusout",this.handleFocusout)}}ft([m()],ht.prototype,"asset",2),ft([m({reflect:!0})],ht.prototype,"variant",2),ft([m({type:Boolean,reflect:!0})],ht.prototype,"selected",1),ft([m()],ht.prototype,"heading",2),ft([m({type:Boolean,reflect:!0})],ht.prototype,"horizontal",2),ft([tt("#like-anchor")],ht.prototype,"likeAnchor",2),ft([m({type:Boolean,reflect:!0})],ht.prototype,"focused",2),ft([m({type:Boolean,reflect:!0})],ht.prototype,"toggles",2),ft([m()],ht.prototype,"value",2),ft([m()],ht.prototype,"subheading",2),customElements.define("sp-card",class extends ht{render(){return u`
            ...
            ${this.toggles?u`
                  ...
                  `:u``}
        `}});class no extends it{constructor(){super(),M(this,"promptInput",we()),M(this,"popover",we()),M(this,"generateButton",we()),this.state="ready"}connectedCallback(){super.connectedCallback()}onOpen(){this.promptInput.value.focus()}async onGenerate(){this.generateButton.value.toggleAttribute("disabled"),this.promptInput.value.toggleAttribute("disabled"),this.generating=!0,this.popover.value.open=!1;try{const t=await async function(e){const o={model:"gpt-4",temperature:.7,n:1,frequency_penalty:0,presence_penalty:0,messages:[{role:"user",content:e}]},a=await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${localStorage.getItem("open-ai-key")}`},body:JSON.stringify(o)}),s=await a.json();if(a.ok)return s.choices[0].message.content;throw new Error(`${s.error.message}: ${s.error.code}`)}(`${this.promptInput.value.value}`);this.dispatchEvent(new CustomEvent("generated",{detail:{generated:t}}))}catch(t){this.dispatchEvent(new CustomEvent("error",{detail:{message:t}})),this.remove(),q.instance.dispatchEvent(new CustomEvent("Toast",{detail:{message:t,variant:"negative"}}))}}handleFocus(t){console.log("focus",this.promptInput)}generate(t){this.dispatchEvent(new CustomEvent("generate",{detail:{generate:this.promptInput.value.value}}))}render(){return u`
        <div>
        ...
        </div>`}}M(no,"properties",{generating:{state:!0}}),M(no,"styles",k`
    :host([dialog]) {
      padding: 10px;
    }
  ...
  `),customElements.define("generative-text-popover",no);class lo extends it{async loadLocaleDict(t){const e={},o=`${D.appStore.webRoot}/locales/${t}/messages.json`;try{const a=await(await fetch(o)).json();Object.keys(a).forEach(s=>{e[s]=a[s].message})}catch(a){console.error(`failed to fetch dictionary from ${o}`)}D.appStore.localeDict=e,q.instance.dispatchEvent(new CustomEvent(st.LOCALE_SET))}isValidConfig(t){if(t!=null&&t.base)return!0;const{searchParams:e}=new URL(window.location.href),o={};for(const[a,s]of e.entries())o[a]=s;return o.base?(this.config=o,!0):(console.error("Missing base configuration"),!1)}async connectedCallback(){super.connectedCallback(),this.getTheme(),D.init(),window.matchMedia("(prefers-color-scheme: dark)").addListener(t=>{this.theme=t.matches?"dark":"light"}),q.instance.addEventListener(st.TOAST,t=>{var e,o;const a=this.renderRoot.querySelector(".toast-container"),s=gt("sp-toast",{open:!0,variant:(e=t.detail.variant)!=null?e:"positive",timeout:200});s.textContent=(o=t.detail.message)!=null?o:"Done",a.append(s),s.addEventListener("close",()=>{a==null||a.removeChild(s)}),D.appStore.context.libraries&&D.appStore.context.libraries.length===0&&this.renderIllustratedMessage()}),q.instance.addEventListener(st.LOCALE_SET,()=>{this.requestUpdate(),this.configured||this.renderIllustratedMessage()}),this.configured=this.isValidConfig(this.config),this.loadLocaleDict("en"),this.configured&&(D.appStore.context=this.config,await Fc(),Y("library:opened"))}renderIllustratedMessage(){var t;const{invalidConfiguration:e,invalidConfigurationDescription:o}=D.appStore.localeDict,a=gt("illustrated-message",{heading:e,description:o});(t=this.renderRoot.querySelector(".container"))==null||t.append(a)}getTheme(){this.theme=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}render(){return u`
    ...
    `}}M(lo,"properties",{theme:void 0}),M(lo,"styles",k`
    * {
      box-sizing: border-box;
    }
