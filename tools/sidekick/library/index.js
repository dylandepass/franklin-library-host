...
`;zt.registerThemeFragment("spectrum","theme",ra),zt.registerThemeFragment("dark","color",ea);var oa=k`
...
`;zt.registerThemeFragment("light","color",oa);var sa=k`
...
`,xa=Object.defineProperty,za=Object.getOwnPropertyDescriptor,br=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?za(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&xa(t,r,s),s};const vr=class extends Ae(ht){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[$o]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let e=0,t=this.parentElement;for(;t instanceof vr;)e++,t=t.parentElement;return e}handleSideNavSelect(e){this.selected=e.target===this}handleClick(e){!this.href&&e&&e.preventDefault(),!this.disabled&&(!this.href||e!=null&&e.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(e){const t=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:e}});this.dispatchEvent(t)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return m`
            ...
            ${this.expanded?m`
                  ...
                  `:m``}
        `}updated(e){this.hasChildren&&this.expanded&&!this.selected&&(this.focusElement.tabIndex=-1),super.updated(e)}connectedCallback(){super.connectedCallback(),this.startTrackingSelection()}disconnectedCallback(){this.stopTrackingSelection(),super.disconnectedCallback()}async startTrackingSelection(){const e=this.parentSideNav;if(e&&(await e.updateComplete,e.startTrackingSelectionForItem(this),this.selected=this.value!=null&&this.value===e.value,this.selected===!0&&e.variant==="multilevel")){let t=this.parentElement;for(;t instanceof vr;)t.expanded=!0,t=t.parentElement}}stopTrackingSelection(){const e=this.parentSideNav;e&&e.stopTrackingSelectionForItem(this),this._parentSidenav=void 0}};let ae=vr;br([u()],ae.prototype,"value",2),br([u({type:Boolean,reflect:!0})],ae.prototype,"selected",2),br([u({type:Boolean,reflect:!0})],ae.prototype,"expanded",2);var Ca=k`
...
`,$a=Object.defineProperty,Ba=Object.getOwnPropertyDescriptor,yr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ba(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&$a(t,r,s),s};class Ft extends function(t,r){var o;class a extends t{constructor(...i){super(i),this.slotHasContent=!1,new He(this,{config:{characterData:!0,subtree:!0},callback:c=>{for(const n of c)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[dr])return;const i=[...this[dr]].filter(c=>!!c.tagName||!!c.textContent&&c.textContent.trim());this.slotHasContent=i.length>0}update(i){if(!this.hasUpdated){const{childNodes:c}=this,n=[...c].filter(l=>l.tagName?r?l.getAttribute("slot")===r:!l.hasAttribute("slot"):!!l.textContent&&l.textContent.trim());this.slotHasContent=n.length>0}super.update(i)}firstUpdated(i){super.firstUpdated(i),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=dr,qo([u({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),qo([Co(r,!0)],a.prototype,o,2),a}(Ae(ht)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[qa]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[m`
...
`,Oa=Object.defineProperty,_a=Object.getOwnPropertyDescriptor,Se=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?_a(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Oa(t,r,s),s};const Ma=["accent","primary","secondary","negative","white","black"];class ie extends st(Ft){constructor(){super(...arguments),this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,Pa]}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":return this.removeAttribute("variant"),this.static="white",void(this.treatment="outline");case"white":case"black":return this.static=t,void this.removeAttribute("variant");case null:return;default:Ma.includes(t)?this._variant=t:this._variant="accent"}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}}Se([u()],ie.prototype,"variant",1),Se([u({type:String,reflect:!0})],ie.prototype,"static",2),Se([u({reflect:!0})],ie.prototype,"treatment",2),Se([u({type:Boolean})],ie.prototype,"quiet",1);class _o extends Ft{}var Ra=k`
...
`,Na=Object.defineProperty,Fa=Object.getOwnPropertyDescriptor,Mo=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Fa(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Na(t,r,s),s};class H extends ${static get styles(){return[Ua]}render(){return m`
            <slot></slot>
        `}}Mo([u()],H.prototype,"label",2),Mo([u({reflect:!0})],H.prototype,"size",2);var Va=Object.defineProperty,Ga=Object.getOwnPropertyDescriptor,kr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ga(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Va(t,r,s),s};class Te extends H{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const r=this.parseIcon(this.name);t.detail.name===r.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,r,o){super.attributeChangedCallback(t,r,o),this.updateIconPromise=this.updateIcon()}render(){return this.name?m`
...
`,Ka=Object.defineProperty,Wa=Object.getOwnPropertyDescriptor;const Za={s:()=>m`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>m`
        ...
        ></sp-icon-cross300>
    `};class Uo extends st(_o){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Ra,Ro]}get buttonContent(){return[Za[this.size]()]}render(){return m`
            <div class="fill">${super.render()}</div>
        `}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?Wa(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&Ka(t,r,s)})([u({reflect:!0})],Uo.prototype,"variant",2);var Xa=k`
...
`,Ya=Object.defineProperty,Qa=Object.getOwnPropertyDescriptor;const Ja={s:()=>m`
    ...
    `,xl:()=>m`
        <sp-icon-cross300
            ...
            class="icon spectrum-UIIcon-Cross300"
        ></sp-icon-cross300>
    `};class No extends st(_o){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Xa,Ro]}get buttonContent(){return[Ja[this.size]()]}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?Qa(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&Ya(t,r,s)})([u({reflect:!0})],No.prototype,"variant",2);var ti=k`
:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
--mod-sans-font-family-stack,var(--spectrum-sans-font-family-stack)
);justify-content:center;line-height:var(--mod-line-height-100,var(--spectrum-line-height-100));margin:0;overflow:visible;-webkit-text-decoration:none;text-decoration:none;text-transform:none;transition:background var(
--mod-animation-duration-100,var(--spectrum-animation-duration-100)
...
`;f("sp-icon-corner-triangle300",class extends H{render(){return J(m),(({width:e=24,height:t=24,title:r="Corner Triangle300"}={})=>Q`<svg
  ...
  >
    ...
    />
  </svg>`)()}});var ri=Object.defineProperty,oi=Object.getOwnPropertyDescriptor,Ct=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?oi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&ri(t,r,s),s};const si={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let Fo;class yt extends st(Ft,{validSizes:["xs","s","m","l","xl"]}){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[...super.styles,ti,ei]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(t){t.button===0&&(this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),Fo=setTimeout(()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))},300))}onPointerup(){clearTimeout(Fo),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:r,altKey:o}=t;(r==="Space"||o&&r==="ArrowDown")&&(t.preventDefault(),r==="ArrowDown"&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:r,altKey:o}=t;(r==="Space"||o&&r==="ArrowDown")&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(m`
...
`,ui=Object.defineProperty,mi=Object.getOwnPropertyDescriptor,ce=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?mi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&ui(t,r,s),s};const pi=e=>e.stopPropagation();class Vt extends Cr{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,li]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:r}=t;!this.value||r!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return m`
            <form
                action=${this.action}
                id="form"
...
`,di=Object.defineProperty,gi=Object.getOwnPropertyDescriptor;class jr extends st($,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return m``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}jr.styles=[Ko],((e,t,r,o)=>{for(var a,s=o>1?void 0:o?gi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&di(t,r,s)})([u({type:Boolean,reflect:!0})],jr.prototype,"vertical",2),f("sp-divider",jr),f("sp-close-button",No),f("sp-icon-info",class extends H{render(){return F(m),(({width:e=24,height:t=24,hidden:r=!1,title:o="Info"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
...
`,bi=Object.defineProperty,vi=Object.getOwnPropertyDescriptor,Er=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?vi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&bi(t,r,s),s};const fi=["negative","positive","info","error","warning"];class De extends ${constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[hi]}set timeout(t){const r=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;r&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=r,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const r=this.variant;fi.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",r)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return m`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
...
`,Ci=Object.defineProperty,ji=Object.getOwnPropertyDescriptor,Kt=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?ji(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ci(t,r,s),s};const Ei={touch:"Double tap and long press for additional options",keyboard:"Press Space or Alt+Down Arrow for additional options",mouse:"Click and hold for additional options"},Zo=class extends ${constructor(){super(...arguments),this.placement="bottom",this.offset=6,this.disabled=!1,this.hasLongpressContent=!1,this._longpressId="longpress-describedby-descriptor",this.abortOverlay=()=>{},this.openStatePromise=Promise.resolve()}static get styles(){return[zi]}handleClose(e){e&&e.detail.interaction!==this.open&&e.detail.interaction!==this.type||this.removeAttribute("open")}render(){return m`
            <slot
                id="trigger"
...
`,Hi=Object.defineProperty,Ii=Object.getOwnPropertyDescriptor,ne=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ii(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Hi(t,r,s),s};class Wt extends st($,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[Ai]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return m`
            <div class="track"></div>
            <div class="fills">
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(t){super.updated(t),!this.indeterminate&&t.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),this.label&&t.has("label")&&this.setAttribute("aria-label",this.label)}}ne([u({type:Boolean,reflect:!0})],Wt.prototype,"indeterminate",2),ne([u({type:String})],Wt.prototype,"label",2),ne([u({type:Boolean,reflect:!0,attribute:"over-background"})],Wt.prototype,"overBackground",2),ne([u({reflect:!0})],Wt.prototype,"static",2),ne([u({type:Number})],Wt.prototype,"progress",2),f("sp-progress-circle",Wt);var Si=k`
...
`],Di=Object.defineProperty,Li=Object.getOwnPropertyDescriptor,Yo=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Li(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Di(t,r,s),s};class qe extends ${constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[Xo,Ti,Si]}render(){return m`
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),f("sp-button",ie);var qi=k`
...
`,$i=Object.defineProperty,Bi=Object.getOwnPropertyDescriptor,Qo=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Bi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&$i(t,r,s),s};class Ir extends ${constructor(){super(...arguments),this.label=""}static get styles(){return[qi]}render(){return this.variant==="file"?(t=>m`
    <svg
        class="file"
        role="img"
        viewBox="0 0 128 128"
...
`)(this.label):m`
            <slot></slot>
        `}}Qo([u({type:String,reflect:!0})],Ir.prototype,"variant",2),Qo([u()],Ir.prototype,"label",2),f("sp-asset",Ir);var Pi=Object.defineProperty,Oi=Object.getOwnPropertyDescriptor,Sr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Oi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Pi(t,r,s),s};class $e extends ht{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return m`
            <input
                id="input"
...
`,Ri=Object.defineProperty,Ui=Object.getOwnPropertyDescriptor,Tr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ui(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ri(t,r,s),s};const Ni={s:m`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:m`
        ...
        ></sp-icon-dash300>
    `};class Be extends st($e){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[_i,zr,Mi]}render(){return m`
            ${super.render()}
            <span id="box">
                ${Ni[this.size]}
                ${Fi[this.size]}
        ...
        `}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),t.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}Tr([u({type:Boolean,reflect:!0})],Be.prototype,"indeterminate",2),Tr([u({type:Boolean,reflect:!0})],Be.prototype,"invalid",2),Tr([u({type:Boolean,reflect:!0})],Be.prototype,"emphasized",2),f("sp-checkbox",Be);var Vi=k`
...
`,Gi=Object.defineProperty,Ki=Object.getOwnPropertyDescriptor,Jo=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ki(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Gi(t,r,s),s};class Dr extends ${constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[Vi]}render(){return m`
            <slot></slot>
        `}}Jo([u({type:Boolean,reflect:!0})],Dr.prototype,"opened",2),Jo([u({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Dr.prototype,"textOnly",2),f("sp-quick-actions",Dr);var Wi=k`
...
`,Ji=Object.defineProperty,tc=Object.getOwnPropertyDescriptor;class ts extends st($){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[Qi]}handleSlotchange({target:t}){t.assignedElements().forEach(r=>{r.size=this.size})}render(){return m`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?tc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&Ji(t,r,s)})([u({type:Boolean,reflect:!0})],ts.prototype,"vertical",2),f("sp-button-group",ts);var ec=k`
...
`;class sc extends Event{constructor({root:t}){super("sp-overlay-close",{bubbles:!0,composed:!0}),this.root=t}}var ac=k`
...
`,ic=Object.defineProperty,cc=Object.getOwnPropertyDescriptor,Ht=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?cc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&ic(t,r,s),s};class nc extends Event{constructor(){super("sp-menu-item-removed",{bubbles:!0,composed:!0}),this.focused=!1}get item(){return this._item}reset(t){this._item=t}}class lc extends Event{constructor(){super("sp-menu-item-added-or-updated",{bubbles:!0,composed:!0})}set focusRoot(t){this.item.menuData.focusRoot=this.item.menuData.focusRoot||t}set selectionRoot(t){this.item.menuData.selectionRoot=this.item.menuData.selectionRoot||t}get item(){return this._item}set currentAncestorWithSelects(t){this._currentAncestorWithSelects=t}get currentAncestorWithSelects(){return this._currentAncestorWithSelects}reset(t){this._item=t,this._currentAncestorWithSelects=void 0,t.menuData={focusRoot:void 0,selectionRoot:void 0}}}const Pe=new lc,rs=new nc,os=class extends Ae(ht){constructor(){super(),this.isInSubmenu=!1,this.active=!1,this.focused=!1,this.selected=!1,this._value="",this.hasSubmenu=!1,this.noWrap=!1,this.open=!1,this.handleSubmenuChange=()=>{var e;(e=this.menuData.selectionRoot)==null||e.selectOrToggleItem(this)},this.handleSubmenuPointerenter=()=>{this.leaveTimeout&&(clearTimeout(this.leaveTimeout),delete this.leaveTimeout)},this.menuData={focusRoot:void 0,selectionRoot:void 0},this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0}),new He(this,{config:{characterData:!0,childList:!0,subtree:!0},callback:()=>{this.breakItemChildrenCache()}})}static get styles(){return[ac,zr,es]}get value(){return this._value||this.itemText}set value(e){e!==this._value&&(this._value=e||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return this.itemChildren.content.reduce((e,t)=>e+(t.textContent||"").trim(),"")}get focusElement(){return this}get itemChildren(){var e,t;if(this._itemChildren)return this._itemChildren;const r=(e=this.shadowRoot)==null?void 0:e.querySelector('slot[name="icon"]'),o=r?r.assignedElements().map(i=>{const c=i.cloneNode(!0);return c.removeAttribute("slot"),c.classList.toggle("icon"),c}):[],a=(t=this.shadowRoot)==null?void 0:t.querySelector("slot:not([name])"),s=a?a.assignedNodes().map(i=>i.cloneNode(!0)):[];return this._itemChildren={icon:o,content:s},this._itemChildren}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(e){if(this.disabled)return e.preventDefault(),e.stopImmediatePropagation(),e.stopPropagation(),!1}proxyFocus(){this.focus()}shouldProxyClick(){let e=!1;return this.anchorElement&&(this.anchorElement.click(),e=!0),e}breakItemChildrenCache(){this._itemChildren=void 0,this.triggerUpdate()}render(){return m`
            <slot name="icon"></slot>
            <div id="label">
                <slot id="slot"></slot>
            </div>
...
`,gc=Object.defineProperty,hc=Object.getOwnPropertyDescriptor,as=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?hc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&gc(t,r,s),s};const qr=class extends wt{constructor(){super(),qr.instances+=1,this.headerId=`sp-menu-group-label-${qr.instances}`}static get styles(){return[...super.styles,dc]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return m`
        ...
        `}};let Oe=qr;Oe.instances=0,as([Co("header",!0)],Oe.prototype,"headerElements",2),as([sr()],Oe.prototype,"headerElement",2),f("sp-menu-group",Oe);var bc=k`
...
`;class vc extends st($,{validSizes:["s","m","l"]}){static get styles(){return[Ko,bc]}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}}f("sp-menu-divider",vc);var fc=k`
...
`,kc=Object.defineProperty,wc=Object.getOwnPropertyDescriptor;class is extends ${constructor(){super(...arguments),this.open=!1}static get styles(){return[yc]}render(){return m``}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?wc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&kc(t,r,s)})([u({type:Boolean,reflect:!0})],is.prototype,"open",2),f("sp-underlay",is);class cs{constructor(t,r){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(r),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}}var xc=k`
...
`,Cc=Object.defineProperty,jc=Object.getOwnPropertyDescriptor,ns=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?jc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Cc(t,r,s),s};class $r extends ${constructor(){super(...arguments),this.open=!1,this.prefersMotion=new cs(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[xc,zc]}focus(){const t=nr(this);t?t.focus():this.children.length===1?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(t){t.has("open")&&t.get("open")!==void 0&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise(r=>{this.resolveTransitionPromise=()=>{this.animating=!1,r()}})),super.update(t)}render(){return m`
            <sp-underlay
                ?open=${this.open}
                @click=${this.close}
        ...
        `}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.transitionPromise,t}}ns([u({type:Boolean,reflect:!0})],$r.prototype,"open",2),ns([Y(".tray")],$r.prototype,"tray",2),f("sp-tray",$r);var Ec=k`
:host{--spectrum-overlay-animation-distance:var(
--spectrum-picker-m-texticon-popover-offset-y,var(--spectrum-global-dimension-size-75)
...
`,Ac=Object.defineProperty,Hc=Object.getOwnPropertyDescriptor,_e=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Hc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ac(t,r,s),s};class le extends ${constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[Ec]}renderTip(){return m`
            <div id="tip">
                <svg
        ...
        `}}_e([u({type:Boolean,reflect:!0})],le.prototype,"dialog",2),_e([u({type:Boolean,reflect:!0})],le.prototype,"open",2),_e([u({reflect:!0})],le.prototype,"placement",2),_e([u({type:Boolean,reflect:!0})],le.prototype,"tip",2),f("sp-popover",le);var Ic=k`
...
`,Wc=Object.defineProperty,Zc=Object.getOwnPropertyDescriptor,K=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Zc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Wc(t,r,s),s};const Kr=3840;class V extends ${constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Kr,this.secondaryMin=0,this.secondaryMax=Kr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Kr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Kc]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return m`
            <slot
            ...
            ${this.enoughChildren?m`
                      <div
                          ...
                          ${Gc({start:["pointerdown",this.onPointerdown],streamInside:["pointermove",this.onPointermove],end:[["pointerup","pointercancel","pointerleave"],this.onPointerup]})}
                      >
                          ${this.resizable?m`
                                    <div id="gripper"></div>
                                `:m``}
      ...
      `]}});class Xc{constructor(){q(this,"listeners",[])}addEventListener(t,r){const o={type:t,callback:r};return this.listeners.push(o),o}removeEventListener(t){for(let r=0;r<this.listeners.length;r++)if(t===this.listeners[r])return void this.listeners.splice(r,1)}removeEventListeners(t){t.forEach(r=>{this.removeEventListener(r)})}dispatchEvent(t){this.listeners.slice().forEach(r=>{t.type===r.type&&r.callback.apply(this,[t])})}}class L extends Xc{constructor(){return super(),L._instance||(L._instance=this),L._instance}static get instance(){return L._instance||(L._instance=new L),L._instance}}async function Ts(e){console.log("fetchLibrary",e);const t=await fetch(e);if(t.status===401)(async function(r){const o=new URL(r),a=await fetch(r,{credentials:"include"});if(a.status===401)window.open(o.origin,"_self");else if(!a.ok)throw new Error("unable to load library JSON");a.json()})(e);else if(!t.ok)throw new Error("unable to load library JSON");return t.json()}function ge(){return window.libraryDev}function Ke(e){return ge()?new URL(e.appStore.config.base).origin:window.location.origin}async function Yc(e,t){const{appStore:r}=e;let{libraries:o}=e;r.config=t;try{const a=await Ts(t.base),s=await async function(i){return i?Ts(i):Promise.resolve()}(t.extends);o=await async function(i,c){const n={};if(i[":type"]==="multi-sheet")for(const l of i[":names"])n[l]=i[l].data;else n.blocks=i.data;if(c)if(c[":type"]==="multi-sheet")for(const l of c[":names"])n[l]?n[l].push(...c[l].data):n[l]=c[l].data;else n.blocks=[...n.blocks||[],...c.data];return n}(a,s),r.libraries=o,L.instance.dispatchEvent(new CustomEvent(et.LIBRARY_LOADED))}catch(a){L.instance.dispatchEvent(new CustomEvent(Dt.TOAST,{detail:{variant:"negative",message:e.appStore.localeDict.errorLoadingLibraryJSON}})),console.error("Unable to load library",a)}}q(L,"_instance",void 0);const Qc={initialized:!1,activePlugin:void 0,activePluginPath:void 0,searchQuery:"",libraries:[],config:{},localeDict:{}};class A{static init(){A.appStore=function(t={},r="store"){function o(a,s,i){const c=new CustomEvent(s,{bubbles:!0,cancelable:!0,detail:i});return L.instance.dispatchEvent(c)}return new Proxy(t,function a(s,i){return{get:(c,n)=>n==="_isProxy"||(typeof c[n]=="object"&&c[n]!==null&&!c[n]._isProxy&&(c[n]=new Proxy(c[n],a(s,i))),c[n]),set:(c,n,l)=>(c[n]===l||(c[n]=l,o(0,n,i)),!0),deleteProperty:(c,n)=>(delete c[n],o(0,n,i),!0)}}(r,t))}(Qc,"app"),A.appStore.webRoot=ge()?"./src/":A.host}}q(A,"host","https://main--franklin-library-host--dylandepass.hlx.live/tools/sidekick/library"),q(A,"appStore",void 0),q(A,"libraries",void 0);const Jc={blocks:ge()?"../../src/plugins/blocks/blocks.js":`${A.host}/plugins/blocks/blocks.js`,tags:ge()?"../../src/plugins/tags/tags.js":`${A.host}/plugins/tags/tags.js`,"api-test":ge()?"../../src/plugins/api-test/api-test.js":`${A.host}/plugins/api-test/api-test.js`};async function Ds(e,t){const{appStore:r}=e,{config:o}=r,a=Ke(e);let s=Jc[t];const i=o[t];if(i&&(s=function(c){try{const n=new URL(c);return n.protocol===""&&n.hostname===""}catch(n){return!0}}(i)?`${a}${i}`:i),s)try{const c=await import(s);r.pluginData=r.libraries[t],r.activePluginPath=s,r.activePlugin=c.default,r.activePluginDecorate=c.decorate,L.instance.dispatchEvent(new CustomEvent(et.PLUGIN_LOADED))}catch(c){L.instance.dispatchEvent(new CustomEvent(Dt.TOAST,{detail:{variant:"negative",message:e.appStore.localeDict.errorLoadingPlugin}})),Wr(e),console.error(`Error loading plugin ${t}: ${c.message}`)}else L.instance.dispatchEvent(new CustomEvent(Dt.TOAST,{detail:{variant:"negative",message:e.appStore.localeDict.unknownPlugin}}))}async function Wr(e){const{appStore:t}=e;t.activePlugin=void 0,t.pluginData=void 0,t.activePluginPath=void 0,t.activePluginDecorate=void 0,L.instance.dispatchEvent(new CustomEvent(et.PLUGIN_UNLOADED))}class Zr extends rt{connectedCallback(){super.connectedCallback(),L.instance.addEventListener(et.LIBRARY_LOADED,()=>{this.libraries=A.appStore.libraries;const t=Object.keys(this.libraries),r=t.includes("blocks")?"blocks":t[0];Ds(A,r)}),L.instance.addEventListener(et.PLUGIN_LOADED,()=>{if(A.appStore.activePlugin){const{searchEnabled:t}=A.appStore.activePlugin;t&&(this.searchEnabled=!0),this.pluginActive=!0,this.defaultPluginName=A.appStore.activePlugin.title.toLowerCase()}}),L.instance.addEventListener(et.PLUGIN_UNLOADED,()=>{this.pluginActive=!1,this.searchEnabled=!1,this.searchActivated=!1;const t=this.renderRoot.querySelector(".middle-bar");t==null||t.classList.remove("search-active"),this.renderRoot.querySelector("sp-search").value=""})}onBack(){Wr(A)}activateSearch(){const t=this.renderRoot.querySelector(".middle-bar");this.searchActivated=!this.searchActivated,this.searchActivated?t==null||t.classList.add("search-active"):t==null||t.classList.remove("search-active");const r=this.renderRoot.querySelector("sp-search");r==null||r.focus()}async onPluginChange(t){const{value:r}=t.target;Wr(A),await Ds(A,r)}onSearch(t){A.appStore.searchQuery=t.target.value,L.instance.dispatchEvent(new CustomEvent(et.SEARCH_UPDATED))}renderLibraries(){if(this.libraries){const t=Object.keys(this.libraries);return m`
        <sp-picker
          quiet 
