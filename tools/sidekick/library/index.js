...
`,Wa=Object.defineProperty,Za=Object.getOwnPropertyDescriptor;const Xa={s:()=>m`
        <sp-icon-cross75
            slot="icon"
    ...
    `};class No extends st(Mo){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Ua,Uo]}get buttonContent(){return[Xa[this.size]()]}render(){return m`
        ...
        `}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?Za(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&Wa(t,r,s)})([u({reflect:!0})],No.prototype,"variant",2);var Ya=k`
...
`,mi=Object.defineProperty,pi=Object.getOwnPropertyDescriptor,ce=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?pi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&mi(t,r,s),s};const di=e=>e.stopPropagation();class Vt extends jr{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,ui]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:r}=t;!this.value||r!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return m`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}ce([u()],Vt.prototype,"action",2),ce([u()],Vt.prototype,"label",2),ce([u()],Vt.prototype,"method",2),ce([u()],Vt.prototype,"placeholder",2),ce([Y("#form")],Vt.prototype,"form",2),y("sp-search",Vt);var Wo=k`
...
`,gi=Object.defineProperty,hi=Object.getOwnPropertyDescriptor;class Er extends st(P,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return m``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Er.styles=[Wo],((e,t,r,o)=>{for(var a,s=o>1?void 0:o?hi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&gi(t,r,s)})([u({type:Boolean,reflect:!0})],Er.prototype,"vertical",2),y("sp-divider",Er),y("sp-close-button",Fo),y("sp-icon-info",class extends H{render(){return V(m),(({width:e=24,height:t=24,hidden:r=!1,title:o="Info"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
...
`,Ii=Object.defineProperty,Si=Object.getOwnPropertyDescriptor,ne=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Si(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ii(t,r,s),s};class Wt extends st(P,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[Hi]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return m`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(t){super.updated(t),!this.indeterminate&&t.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),this.label&&t.has("label")&&this.setAttribute("aria-label",this.label)}}ne([u({type:Boolean,reflect:!0})],Wt.prototype,"indeterminate",2),ne([u({type:String})],Wt.prototype,"label",2),ne([u({type:Boolean,reflect:!0,attribute:"over-background"})],Wt.prototype,"overBackground",2),ne([u({reflect:!0})],Wt.prototype,"static",2),ne([u({type:Number})],Wt.prototype,"progress",2),y("sp-progress-circle",Wt);var Ti=k`
...
`,Ki=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor,ts=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Wi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ki(t,r,s),s};class Lr extends P{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[Gi]}render(){return m`
            <slot></slot>
...
`;class fc extends st(P,{validSizes:["s","m","l"]}){static get styles(){return[Wo,vc]}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}}y("sp-menu-divider",fc);var yc=k`
...
`,Zc=Object.defineProperty,Xc=Object.getOwnPropertyDescriptor,W=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Xc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Zc(t,r,s),s};const Wr=3840;class G extends P{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Wr,this.secondaryMin=0,this.secondaryMax=Wr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Wr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Wc]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return m`
            <slot
