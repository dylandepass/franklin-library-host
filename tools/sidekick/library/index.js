...
`,Fa=Object.defineProperty,Va=Object.getOwnPropertyDescriptor,jr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Va(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Fa(t,e,s),s};class Xt extends function(t,e){var o;class a extends t{constructor(...i){super(i),this.slotHasContent=!1,new Le(this,{config:{characterData:!0,subtree:!0},callback:c=>{for(const n of c)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[yr])return;const i=[...this[yr]].filter(c=>!!c.tagName||!!c.textContent&&c.textContent.trim());this.slotHasContent=i.length>0}update(i){if(!this.hasUpdated){const{childNodes:c}=this,n=[...c].filter(l=>l.tagName?e?l.getAttribute("slot")===e:!l.hasAttribute("slot"):!!l.textContent&&l.textContent.trim());this.slotHasContent=n.length>0}super.update(i)}firstUpdated(i){super.firstUpdated(i),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=yr,Mo([m({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),Mo([Io(e,!0)],a.prototype,o,2),a}(Te(vt)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[Na]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[u`
...
`,yi=Object.defineProperty,ki=Object.getOwnPropertyDescriptor,ge=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?ki(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&yi(t,e,s),s};const wi=r=>r.stopPropagation();class Yt extends Sr{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,fi]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||e!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return u`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}ge([m()],Yt.prototype,"action",2),ge([m()],Yt.prototype,"label",2),ge([m()],Yt.prototype,"method",2),ge([m()],Yt.prototype,"placeholder",2),ge([tt("#form")],Yt.prototype,"form",2),y("sp-search",Yt);var Qo=k`
...
`,Pi=Object.defineProperty,Oi=Object.getOwnPropertyDescriptor,he=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Oi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Pi(t,e,s),s};class te extends nt(_,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[Bi]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return u`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(t){super.updated(t),!this.indeterminate&&t.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),this.label&&t.has("label")&&this.setAttribute("aria-label",this.label)}}he([m({type:Boolean,reflect:!0})],te.prototype,"indeterminate",2),he([m({type:String})],te.prototype,"label",2),he([m({type:Boolean,reflect:!0,attribute:"over-background"})],te.prototype,"overBackground",2),he([m({reflect:!0})],te.prototype,"static",2),he([m({type:Number})],te.prototype,"progress",2),y("sp-progress-circle",te);var Mi=k`
...
`,Mc=Object.defineProperty,_c=Object.getOwnPropertyDescriptor,Q=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?_c(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Mc(t,e,s),s};const Zr=3840;class X extends _{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Zr,this.secondaryMin=0,this.secondaryMax=Zr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Zr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Oc]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return u`
      ...
      `]}});class Rc{constructor(){V(this,"listeners",[])}addEventListener(t,e){const o={type:t,callback:e};return this.listeners.push(o),o}removeEventListener(t){for(let e=0;e<this.listeners.length;e++)if(t===this.listeners[e])return void this.listeners.splice(e,1)}removeEventListeners(t){t.forEach(e=>{this.removeEventListener(e)})}dispatchEvent(t){this.listeners.slice().forEach(e=>{t.type===e.type&&e.callback.apply(this,[t])})}}class q extends Rc{constructor(){return super(),q._instance||(q._instance=this),q._instance}static get instance(){return q._instance||(q._instance=new q),q._instance}}V(q,"_instance",void 0);const Uc={initialized:!1,activePlugin:void 0,searchQuery:"",context:{},localeDict:{}};class L{static init(){L.appStore=function(t={},e="store"){function o(a,s,i){const c=new CustomEvent(s,{bubbles:!0,cancelable:!0,detail:i});return q.instance.dispatchEvent(c)}return new Proxy(t,function a(s,i){return{get:(c,n)=>n==="_isProxy"||(typeof c[n]=="object"&&c[n]!==null&&!c[n]._isProxy&&(c[n]=new Proxy(c[n],a(s,i))),c[n]),set:(c,n,l)=>(c[n]===l||(c[n]=l,o(0,n,i)),!0),deleteProperty:(c,n)=>(delete c[n],o(0,n,i),!0)}}(e,t))}(Uc,"app"),L.appStore.webRoot=window.libraryDev?"./src":L.libraryHost}}async function Ds(r){const t=await fetch(r);if(t.status===401)(async function(e){const o=await fetch(e,{credentials:"include"});if(o.status===401)window.open(new URL(origin).origin,"_self");else if(!o.ok)throw new Error("unable to load library JSON");o.json()})(r);else if(!t.ok)throw new Error("unable to load library JSON");return t.json()}function ie(){return window.libraryDev}async function Nc(){const{context:r}=L.appStore;r.baseLibraryOrigin=ie()?new URL(r.base).origin:window.location.origin;try{const t=await async function(o){const{base:a}=o,s=await Ds(Xr(a)?`${o.baseLibraryOrigin}${a}`:a),i=s.data?s:s.blocks;return i&&i.data.forEach(c=>{c.path&&(c.path.includes("://")&&(c.path=new URL(c.path).pathname),c.url=`${o.baseLibraryOrigin}${c.path}`,c.path=`${c.path}`,c.extended=!1)}),s}(r),e=await async function(o){if(o.extends){const{extends:a}=o,{origin:s}=new URL(a),i=await Ds(a),c=i.data?i:i.blocks;return c&&c.data.forEach(n=>{const{path:l}=n;if(l){const d=Xr(l);n.url=d?`${s}${l}`:l,n.path=d?`${l}`:new URL(l).pathname,n.extended=!0}}),o.extendedLibraryOrigin=s,i}return Promise.resolve()}(r);r.libraries=await async function(o,a){const s={};if(o[":type"]==="multi-sheet")for(const i of o[":names"])s[i]=o[i].data;else s.blocks=o.data;if(a)if(a[":type"]==="multi-sheet")for(const i of a[":names"])s[i]?s[i].push(...a[i].data):s[i]=a[i].data;else s.blocks=[...s.blocks||[],...a.data];return s}(t,e),q.instance.dispatchEvent(new CustomEvent(st.LIBRARY_LOADED))}catch(t){q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:{variant:"negative",message:L.appStore.localeDict.errorLoadingLibraryJSON}})),console.error("Unable to load library",t)}}async function $s(r,t){const{appStore:e}=r,{context:o}=e;let a={blocks:ie()?"../../src/plugins/blocks/blocks.js":`${L.libraryHost}/plugins/blocks/blocks.js`,tags:ie()?"../../src/plugins/tags/tags.js":`${L.libraryHost}/plugins/tags/tags.js`,"api-test":ie()?"../../src/plugins/api-test/api-test.js":`${L.libraryHost}/plugins/api-test/api-test.js`}[t];const s=o[t];if(s&&(a=Xr(s)?`${o.baseLibraryOrigin}${s}`:s),a)try{const i=await import(a);o.activePlugin={config:i.default,data:e.context.libraries[t],path:a,decorate:i.decorate},q.instance.dispatchEvent(new CustomEvent(st.PLUGIN_LOADED))}catch(i){q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:{variant:"negative",message:r.appStore.localeDict.errorLoadingPlugin}})),qs(r),console.error(`Error loading plugin ${t}: ${i.message}`)}else q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:{variant:"negative",message:r.appStore.localeDict.unknownPlugin}}))}async function qs(r){const{appStore:t}=r;t.context.activePlugin=void 0,q.instance.dispatchEvent(new CustomEvent(st.PLUGIN_UNLOADED))}V(L,"libraryHost","https://main--franklin-library-host--dylandepass.hlx.live/tools/sidekick/library"),V(L,"appStore",void 0);class Yr extends ct{connectedCallback(){super.connectedCallback(),q.instance.addEventListener(st.LIBRARY_LOADED,()=>{const{context:t}=L.appStore,{libraries:e}=t,o=Object.keys(e);this.libraries=e;let a=o.includes("blocks")?"blocks":o[0];const s=new URLSearchParams(window.location.search);s.has("plugin")&&(a=s.get("plugin")),$s(L,a)}),q.instance.addEventListener(st.PLUGIN_LOADED,()=>{const{context:t}=L.appStore;if(t.activePlugin){const{activePlugin:e}=t,{searchEnabled:o}=e.config;o&&(this.searchEnabled=!0),this.pluginActive=!0,this.defaultPluginName=e.config.title.toLowerCase().replace(" ","-"),function(a,s=[]){const i=new URL(window.location.href);a.forEach(([n,l])=>{i.searchParams.set(n,l)}),s.forEach(n=>{i.searchParams.delete(n)});const{href:c}=i;window.history.pushState({path:c},"",decodeURIComponent(c))}([["plugin",this.defaultPluginName]])}}),q.instance.addEventListener(st.PLUGIN_UNLOADED,()=>{this.pluginActive=!1,this.searchEnabled=!1,this.searchActivated=!1;const t=this.renderRoot.querySelector(".middle-bar");t==null||t.classList.remove("search-active"),this.renderRoot.querySelector("sp-search").value=""})}activateSearch(){const t=this.renderRoot.querySelector(".middle-bar");this.searchActivated=!this.searchActivated,this.searchActivated?t==null||t.classList.add("search-active"):t==null||t.classList.remove("search-active");const e=this.renderRoot.querySelector("sp-search");e==null||e.focus()}async onPluginChange(t){const{value:e}=t.target;(function(){const o=new URL(window.location.href),a=`${o.origin}${o.pathname}`;window.history.pushState({path:a},"",a)})(),qs(L),await $s(L,e)}onSearch(t){L.appStore.searchQuery=t.target.value,q.instance.dispatchEvent(new CustomEvent(st.SEARCH_UPDATED))}renderLibraries(){if(this.libraries){const t=Object.keys(this.libraries);return u`
        <sp-picker
          quiet 
      ...
      <div class="search">
        <div>
          <div class="logo-container">
            ...
            <span>${L.appStore.localeDict.appTitle}</span>
          </div>
        </div>
        <div class="middle-bar">
          ${this.renderLibraries()}
          <sp-search
            placeholder=${L.appStore.localeDict.search}
            @input=${this.onSearch}
  ...
  `),customElements.define("plugin-renderer",Os);class to extends ct{constructor(){super(),this.type="hierarchical"}onPreview(t,e){this.dispatchEvent(new CustomEvent("PreviewBlock",{detail:{path:e}})),window.open(e,"_blank")}renderNoResults(){return`
    ...
    `}filterBlocks(t){const e=this.renderRoot.querySelector(".message-container"),o=this.renderRoot.querySelectorAll("sp-sidenav-item"),a=this.renderRoot.querySelectorAll("sp-sidenav-item > sp-sidenav-item"),s=this.renderRoot.querySelectorAll("sp-sidenav > sp-sidenav-item");let i=!0;if(t==="")return o.forEach(c=>{c.removeAttribute("aria-hidden"),c.removeAttribute("expanded")}),void(e&&e.remove());a.forEach(c=>{var n;const l=c.getAttribute("label").toLowerCase(),d=(n=c.dataset.searchTags)!=null?n:"";l.includes(t.toLowerCase())||d.split(",").some(p=>p.toLowerCase().includes(t.toLowerCase()))?c.removeAttribute("aria-hidden"):c.setAttribute("aria-hidden",!0)}),s.forEach(c=>{let n=!1;c.querySelectorAll("sp-sidenav-item").forEach(l=>{l.hasAttribute("aria-hidden")||(n=!0,i=!1,e&&e.remove())}),n?(c.setAttribute("expanded",!0),c.removeAttribute("aria-hidden")):c.setAttribute("aria-hidden",!0)}),i&&!e&&this.renderRoot.append(gt("div",{},this.renderNoResults()))}async loadBlocks(t,e){var o;const a=new URLSearchParams(window.location.search),s=a.has("path")?a.get("path"):void 0,i=a.has("index")?a.get("index"):void 0,c=gt("div",{class:"list-container"});if(this.type==="hierarchical"){const n=gt("sp-sidenav",{variant:"multilevel","data-testid":"blocks"});c.append(n);const l=[],d=t.map(async p=>{var h,g,b,f,w;const{url:v,path:j}=p,C=async function(z){if(window.blocks||(window.blocks={}),!window.blocks[z]){const E=await fetch(`${z}.plain.html`);if(!E.ok)return;const x=await E.text(),A=new DOMParser().parseFromString(x,"text/html");window.blocks[z]=A}return window.blocks[z]}(v);try{const z=await C;if(!z)throw new Error(`An error occurred fetching ${p.name}`);const{body:E}=z.cloneNode(!0),x=(h=function(N){const I=N.querySelector(":scope > div > .library-metadata:only-child");if(I){const B=I.parentElement,D=_s(I.parentElement);return B.remove(),D}return{}}(E))!=null?h:{},A=(g=x.type)!=null?g:void 0,T=function(N){const I=N.querySelector(".page-metadata");if(I){const B=Ms(I,[],!1);return I.remove(),B}}(E);let M;if(A&&A.toLowerCase()==="template"){M||(M=Ze("Templates","sp-icon-file-code",!0,!1),l.push(M));const N=(b=x.name)!=null?b:p.name,I=(w=(f=x.searchtags)!=null?f:x["search-tags"])!=null?w:"",B=Ze(N,"sp-icon-file-code",!1,!0,"sp-icon-copy");I&&B.setAttribute("data-search-tags",I);const D={detail:{blockWrapper:E,blockData:p,blockURL:v,defaultLibraryMetadata:x,pageMetadata:T}};B.addEventListener("OnAction",P=>{P.preventDefault(),P.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",D))}),M.append(B),B.addEventListener("click",async()=>{this.dispatchEvent(new CustomEvent("LoadTemplate",D))}),s===j&&(M.setAttribute("expanded",!0),this.selectedItem=B,this.dispatchEvent(new CustomEvent("LoadTemplate",D)))}else{const N=Ze(p.name,"sp-icon-file-template",!0,!0,"sp-icon-preview");l.push(N),N.addEventListener("OnAction",D=>this.onPreview(D,v));const I=E.querySelectorAll(":scope > div");let B=0;I.forEach((D,P)=>{var F,O,J,W,at,Bt;if(B>0)return void(B-=1);const bt=(F=_s(D))!=null?F:{},ze=D.querySelector("div[class]");let Nt=(O=bt.name)!=null?O:Rs(ze);const Fs=Rs(ze,!0),co=(Bt=(at=(W=(J=bt.searchtags)!=null?J:bt["search-tags"])!=null?W:x.searchtags)!=null?at:x["search-tags"])!=null?Bt:"";(!Nt||Nt==="section-metadata")&&(Nt="Unnamed Item");const wt=Ze(Nt,"sp-icon-file-code",!1,!0,"sp-icon-copy");if(co&&wt.setAttribute("data-search-tags",co),bt.includeNext){const xt=Number(bt.includeNext);if(!Number.isNaN(xt)){const Je=document.createElement("body");let no=0;for(;no<xt;){const Vs=D.nextElementSibling;Je.append(Vs),no+=1}Je.prepend(D),D=Je,B=xt,x.multiSectionBlock=!0}}else if(bt.type==="section"){const xt=document.createElement("body");xt.append(D),D=xt,x.compoundBlock=!0}const Qe={detail:{blockWrapper:D,blockNameWithVariant:Fs,blockData:p,blockURL:v,sectionLibraryMetadata:bt,defaultLibraryMetadata:x,pageMetadata:T,index:P}};wt.classList.add("descendant"),wt.setAttribute("data-index",P),wt.addEventListener("OnAction",xt=>{xt.preventDefault(),xt.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",Qe))}),N.append(wt),wt.addEventListener("click",async()=>{this.selectedItem&&this.selectedItem.removeAttribute("selected"),wt.setAttribute("selected",!0),this.selectedItem=wt,this.dispatchEvent(new CustomEvent("LoadBlock",Qe))}),s===j&&i===P.toString()&&(N.setAttribute("expanded",!0),this.selectedItem=wt,this.dispatchEvent(new CustomEvent("LoadBlock",Qe)))})}return C}catch(z){console.error(z.message),e.dispatchEvent(new CustomEvent("Toast",{detail:{message:z.message,variant:"negative"}}))}});await Promise.all(d),n.append(...l.sort((p,h)=>{const g=p.getAttribute("label").toLowerCase(),b=h.getAttribute("label").toLowerCase();return g<b?-1:g>b?1:0})),setTimeout(()=>{this.selectedItem&&this.selectedItem.setAttribute("selected",!0)},1),n.querySelectorAll("sp-sidenav-item").length===0&&e.append(this.renderNoResults())}(o=this.renderRoot)==null||o.append(c)}}V(to,"properties",{mutationObserver:{state:!1},selectedItem:{state:!1},type:{state:!0}}),V(to,"styles",k`
    .list-container {
      width: 100%;
    }
