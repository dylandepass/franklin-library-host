...
`,qa=Object.defineProperty,Ba=Object.getOwnPropertyDescriptor,vr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ba(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&qa(t,e,s),s};class Vt extends function(t,e){var o;class a extends t{constructor(...i){super(i),this.slotHasContent=!1,new Ae(this,{config:{characterData:!0,subtree:!0},callback:c=>{for(const n of c)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[mr])return;const i=[...this[mr]].filter(c=>!!c.tagName||!!c.textContent&&c.textContent.trim());this.slotHasContent=i.length>0}update(i){if(!this.hasUpdated){const{childNodes:c}=this,n=[...c].filter(u=>u.tagName?e?u.getAttribute("slot")===e:!u.hasAttribute("slot"):!!u.textContent&&u.textContent.trim());this.slotHasContent=n.length>0}super.update(i)}firstUpdated(i){super.firstUpdated(i),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=mr,So([m({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),So([ko(e,!0)],a.prototype,o,2),a}(je(bt)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[$a]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[l`
...
`,Na=Object.defineProperty,Fa=Object.getOwnPropertyDescriptor,Bo=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Fa(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Na(t,e,s),s};class I extends B{static get styles(){return[Ua]}render(){return l`
            <slot></slot>
        `}}Bo([m()],I.prototype,"label",2),Bo([m({reflect:!0})],I.prototype,"size",2);var Va=Object.defineProperty,Wa=Object.getOwnPropertyDescriptor,fr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Wa(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Va(t,e,s),s};class Ie extends I{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const e=this.parseIcon(this.name);t.detail.name===e.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o),this.updateIconPromise=this.updateIcon()}render(){return this.name?l`
                <div id="container"></div>
            `:this.src?l`
                <img src="${this.src}" alt=${E(this.label)} />
            `:super.render()}async updateIcon(){if(this.updateIconPromise&&await this.updateIconPromise,!this.name)return Promise.resolve();const t=this.parseIcon(this.name),e=yt.getInstance().getIconset(t.iconset);return e&&this.iconContainer?(this.iconContainer.innerHTML="",e.applyIconToElement(this.iconContainer,t.icon,this.size||"",this.label?this.label:"")):Promise.resolve()}parseIcon(t){const e=t.split(":");let o="default",a=t;return e.length>1&&(o=e[0],a=e[1]),{iconset:o,icon:a}}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.updateIconPromise,t}}let yr;fr([m()],Ie.prototype,"src",2),fr([m()],Ie.prototype,"name",2),fr([J("#container")],Ie.prototype,"iconContainer",2);const tt=function(r,...t){return yr?yr(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},et=r=>{yr=r};y("sp-icon-cross75",class extends I{render(){return et(l),(({width:r=24,height:t=24,title:e="Cross75"}={})=>tt`<svg
...
`,bi=Object.defineProperty,vi=Object.getOwnPropertyDescriptor,Cr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?vi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&bi(t,e,s),s};const fi=["negative","positive","info","error","warning"];class Se extends B{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[hi]}set timeout(t){const e=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;fi.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return l`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(this.timeout!==null&&this.open?this.startCountdown():this.stopCountdown())}}Cr([m({type:Boolean,reflect:!0})],Se.prototype,"open",2),Cr([m({type:Number})],Se.prototype,"timeout",1),Cr([m({type:String})],Se.prototype,"variant",1),y("sp-toast",Se);const Te=async(r,t,e,o)=>{const{Overlay:a}=await Promise.resolve().then(function(){return Cc});return a.open(r,t,e,o)};var yi=k`
...
`],Li=Object.defineProperty,Di=Object.getOwnPropertyDescriptor,Go=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Di(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Li(t,e,s),s};class Le extends B{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[Wo,Ti,Si]}render(){return l`
        ...
        `}}Le.is="sp-illustrated-message",Go([m()],Le.prototype,"heading",2),Go([m()],Le.prototype,"description",2),y("sp-illustrated-message",Le),y("sp-icon-search",class extends I{render(){return Z(l),(({width:r=24,height:t=24,hidden:e=!1,title:o="Search"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,Sc=Object.defineProperty,Tc=Object.getOwnPropertyDescriptor,Q=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Tc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Sc(t,e,s),s};const Rr=3840;class X extends B{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Rr,this.secondaryMin=0,this.secondaryMax=Rr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Rr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Ic]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return l`
  ...
  `),customElements.define("plugin-renderer",Ss);class Wr extends it{constructor(){super(),this.type="hierarchical"}onPreview(t,e){this.dispatchEvent(new CustomEvent("PreviewBlock",{detail:{path:e}})),window.open(e,"_blank")}renderNoResults(){return`
    ...
    `}filterBlocks(t){const e=this.renderRoot.querySelector(".message-container"),o=this.renderRoot.querySelectorAll("sp-sidenav-item"),a=this.renderRoot.querySelectorAll("sp-sidenav-item > sp-sidenav-item"),s=this.renderRoot.querySelectorAll("sp-sidenav > sp-sidenav-item");let i=!0;if(t==="")return o.forEach(c=>{c.removeAttribute("aria-hidden"),c.removeAttribute("expanded")}),void(e&&e.remove());a.forEach(c=>{var n;const u=c.getAttribute("label").toLowerCase(),d=(n=c.dataset.searchTags)!=null?n:"";u.includes(t.toLowerCase())||d.split(",").some(p=>p.toLowerCase().includes(t.toLowerCase()))?c.removeAttribute("aria-hidden"):c.setAttribute("aria-hidden",!0)}),s.forEach(c=>{let n=!1;c.querySelectorAll("sp-sidenav-item").forEach(u=>{u.hasAttribute("aria-hidden")||(n=!0,i=!1,e&&e.remove())}),n?(c.setAttribute("expanded",!0),c.removeAttribute("aria-hidden")):c.setAttribute("aria-hidden",!0)}),i&&!e&&this.renderRoot.append(dt("div",{},this.renderNoResults()))}async loadBlocks(t,e){var o;const a=new URLSearchParams(window.location.search),s=a.has("path")?a.get("path"):void 0,i=a.has("index")?a.get("index"):void 0,c=dt("div",{class:"list-container"});if(this.type==="hierarchical"){const n=dt("sp-sidenav",{variant:"multilevel","data-testid":"blocks"});c.append(n);const u=[],d=t.map(async p=>{var g;const{url:h,path:b}=p,f=async function(w){if(window.blocks||(window.blocks={}),!window.blocks[w]){const v=await fetch(`${w}.plain.html`);if(!v.ok)return;const A=await v.text(),C=new DOMParser().parseFromString(A,"text/html");window.blocks[w]=C}return window.blocks[w]}(h);try{const w=await f;if(!w)throw new Error(`An error occurred fetching ${p.name}`);const v=Cs(p.name,"sp-icon-file-template",!0,!0,"sp-icon-preview");u.push(v),v.addEventListener("OnAction",z=>this.onPreview(z,h));const{body:A}=w.cloneNode(!0),C=(g=function(z){const j=z.querySelector(":scope > div > .library-metadata:only-child");if(j){const x=j.parentElement,H=Ts(j.parentElement);return x.remove(),H}return{}}(A))!=null?g:{};return A.querySelectorAll(":scope > div").forEach((z,j)=>{var x,H,P,_,ht,D;const G=(x=Ts(z))!=null?x:{},N=z.querySelector("div[class]");let q=(H=G.name)!=null?H:Ls(N);const F=Ls(N,!0),$=(D=(ht=(_=(P=G.searchtags)!=null?P:G["search-tags"])!=null?_:C.searchtags)!=null?ht:C["search-tags"])!=null?D:"";(!q||q==="section-metadata")&&(q="Unnamed Item");const R=Cs(q,"sp-icon-file-code",!1,!0,"sp-icon-copy");$&&R.setAttribute("data-search-tags",$),R.classList.add("descendant"),R.setAttribute("data-index",j),R.addEventListener("OnAction",st=>{st.preventDefault(),st.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",{detail:{blockWrapper:z,blockNameWithVariant:F,blockURL:h}}))}),v.append(R);const V={detail:{blockWrapper:z,blockData:p,sectionLibraryMetadata:G,defaultLibraryMetadata:C,index:j}};R.addEventListener("click",async()=>{this.dispatchEvent(new CustomEvent("LoadBlock",V))}),s===b&&i===j.toString()&&(v.setAttribute("expanded",!0),this.dispatchEvent(new CustomEvent("LoadBlock",V)))}),f}catch(w){console.error(w.message),e.dispatchEvent(new CustomEvent("Toast",{detail:{message:w.message,variant:"negative"}}))}});await Promise.all(d),n.append(...u.sort((p,g)=>{const h=p.getAttribute("label").toLowerCase(),b=g.getAttribute("label").toLowerCase();return h<b?-1:h>b?1:0})),n.querySelectorAll("sp-sidenav-item").length===0&&e.append(this.renderNoResults())}(o=this.renderRoot)==null||o.append(c)}}U(Wr,"properties",{mutationObserver:{state:!1},type:{state:!0}}),U(Wr,"styles",k`
    .list-container {
      width: 100%;
    }
