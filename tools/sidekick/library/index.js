...
`;y("sp-icon-corner-triangle300",class extends I{render(){return tt(m),(({width:e=24,height:t=24,title:r="Corner Triangle300"}={})=>J`<svg
  ...
  >
    ...
    />
  </svg>`)()}});const N=function(e,...t){return kr?kr(e,...t):t.reduce((r,o,a)=>r+o+e[a+1],e[0])},F=e=>{kr=e};y("sp-icon-alert",class extends I{render(){return F(m),(({width:e=24,height:t=24,hidden:r=!1,title:o="Alert"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
...
`],Lc=Object.defineProperty,Dc=Object.getOwnPropertyDescriptor,Zo=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Dc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Lc(t,r,s),s};class Le extends q{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[Go,Tc,Sc]}render(){return m`
        ...
        `}}Le.is="sp-illustrated-message",Zo([u()],Le.prototype,"heading",2),Zo([u()],Le.prototype,"description",2),y("sp-illustrated-message",Le),y("sp-icon-search",class extends I{render(){return F(m),(({width:e=24,height:t=24,hidden:r=!1,title:o="Search"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
...
`)(this.label):m`
        ...
        `}}Xo([u({type:String,reflect:!0})],Er.prototype,"variant",2),Xo([u()],Er.prototype,"label",2),y("sp-asset",Er);var Pc=Object.defineProperty,Oc=Object.getOwnPropertyDescriptor,Hr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Oc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Pc(t,r,s),s};class De extends bt{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return m`
            <input
                ...
                @change=${this.handleChange}
            />
        `}}Hr([u({type:Boolean,reflect:!0})],De.prototype,"checked",2),Hr([u({type:Boolean,reflect:!0})],De.prototype,"readonly",2),Hr([Q("#input")],De.prototype,"inputElement",2),y("sp-icon-checkmark75",class extends I{render(){return tt(m),(({width:e=24,height:t=24,title:r="Checkmark75"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
...
`,Gi=Object.defineProperty,Zi=Object.getOwnPropertyDescriptor,G=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Zi(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Gi(t,r,s),s};const Vr=3840;class V extends q{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Vr,this.secondaryMin=0,this.secondaryMax=Vr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Vr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Ki]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return m`
  ...
  `),customElements.define("illustrated-message",Zr);const Ts=()=>new tn;class tn{}const Xr=new WeakMap,Ls=ze(class extends To{render(e){return L}update(e,[t]){var r;const o=t!==this.G;return o&&this.G!==void 0&&this.ot(void 0),(o||this.rt!==this.lt)&&(this.G=t,this.ct=(r=e.options)===null||r===void 0?void 0:r.host,this.ot(this.lt=e.element)),L}ot(e){var t;if(typeof this.G=="function"){const r=(t=this.ct)!==null&&t!==void 0?t:globalThis;let o=Xr.get(r);o===void 0&&(o=new WeakMap,Xr.set(r,o)),o.get(this.G)!==void 0&&this.G.call(this.ct,void 0),o.set(this.G,e),e!==void 0&&this.G.call(this.ct,e)}else this.G.value=e}get rt(){var e,t,r;return typeof this.G=="function"?(t=Xr.get((e=this.ct)!==null&&e!==void 0?e:globalThis))===null||t===void 0?void 0:t.get(this.G):(r=this.G)===null||r===void 0?void 0:r.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});class Ds extends st{constructor(...t){super(...t),_(this,"progressContainer",Ts())}connectedCallback(){super.connectedCallback(),D.instance.addEventListener(rt.PLUGIN_LOADED,()=>{const t=dt("div",{class:"plugin-root","data-testid":"plugin-root"});this.renderRoot.prepend(t),this.loadPluginStylesheet(),t.addEventListener(Ot.SHOW_LOADER,this.displayLoader.bind(this)),t.addEventListener(Ot.TOAST,this.sendToast),t.addEventListener(Ot.HIDE_LOADER,this.hideLoader.bind(this));const{context:r}=H.appStore,{activePlugin:o}=r;o.decorate(t,o.data,H.appStore.searchQuery)}),D.instance.addEventListener(rt.PLUGIN_UNLOADED,()=>{const t=this.renderRoot.querySelector(".plugin-root");t&&(this.hideLoader(),t.remove())}),D.instance.addEventListener(rt.SEARCH_UPDATED,()=>{const t=this.renderRoot.querySelector(".plugin-root");if(t){t.innerHTML="";const{context:r}=H.appStore,{activePlugin:o}=r;o.decorate(t,o.data,H.appStore.searchQuery)}})}loadPluginStylesheet(){const t=document.createElement("link");t.setAttribute("rel","stylesheet");const r=H.appStore.context.activePlugin.path.replace(".js",".css");t.setAttribute("href",r),t.setAttribute("type","text/css"),this.renderRoot.append(t)}displayLoader(){var t;(t=this.progressContainer.value)==null||t.classList.add("visible")}hideLoader(){var t;(t=this.progressContainer.value)==null||t.classList.remove("visible")}sendToast(t){D.instance.dispatchEvent(new CustomEvent(Ot.TOAST,{detail:t.detail}))}render(){return m`
    ...
    `}}function qs(e){const t=e.querySelector(".library-metadata"),r={};if(t){const o=function(a){const s={};return a.querySelectorAll(":scope > div").forEach(c=>{if(c.children){const i=[...c.children];if(i[1]){const n=i[1],l=Es(i[0].textContent);let d="";if(n.querySelector("a")){const p=[...n.querySelectorAll("a")];d=p.length===1?p[0].href:p.map(g=>g.href)}else if(n.querySelector("img")){const p=[...n.querySelectorAll("img")];d=p.length===1?p[0].src:p.map(g=>g.src)}else if(n.querySelector("p")){const p=[...n.querySelectorAll("p")];d=p.length===1?p[0].textContent:p.map(g=>g.textContent)}else d=c.children[1].textContent;s[l]=d}}}),s}(t);return Object.keys(o).forEach(a=>{a!=="style"&&(r[function(s){return Es(s).replace(/-([a-z])/g,c=>c[1].toUpperCase())}(a)]=o[a])}),t.remove(),r}}function Yr(e,t=!0){if(!e)return;const r=e.className.split(" "),o=r.shift();if(!t)return o;const a=r.filter(s=>s!=="sidekick-library"&&s!=="");return a.length>0?`${o} (${a.join(", ")})`:o}_(Ds,"styles",k`
    sp-sidenav {
      width: 100%;
    }
