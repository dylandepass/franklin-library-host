...
`,Mc=Object.defineProperty,_c=Object.getOwnPropertyDescriptor,Q=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?_c(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Mc(t,e,s),s};const Zr=3840;class X extends _{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Zr,this.secondaryMin=0,this.secondaryMax=Zr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Zr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Oc]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return u`
  ...
  `),customElements.define("illustrated-message",Qr);const Bs=()=>new Fc;class Fc{}const Jr=new WeakMap,Ps=Ie(class extends Oo{render(r){return $}update(r,[t]){var e;const o=t!==this.G;return o&&this.G!==void 0&&this.ot(void 0),(o||this.rt!==this.lt)&&(this.G=t,this.ct=(e=r.options)===null||e===void 0?void 0:e.host,this.ot(this.lt=r.element)),$}ot(r){var t;if(typeof this.G=="function"){const e=(t=this.ct)!==null&&t!==void 0?t:globalThis;let o=Jr.get(e);o===void 0&&(o=new WeakMap,Jr.set(e,o)),o.get(this.G)!==void 0&&this.G.call(this.ct,void 0),o.set(this.G,r),r!==void 0&&this.G.call(this.ct,r)}else this.G.value=r}get rt(){var r,t,e;return typeof this.G=="function"?(t=Jr.get((r=this.ct)!==null&&r!==void 0?r:globalThis))===null||t===void 0?void 0:t.get(this.G):(e=this.G)===null||e===void 0?void 0:e.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});class Os extends ct{constructor(...t){super(...t),V(this,"progressContainer",Bs())}connectedCallback(){super.connectedCallback(),q.instance.addEventListener(st.PLUGIN_LOADED,async()=>{this.renderRoot.innerHTML="";const t=gt("div",{class:"plugin-root","data-testid":"plugin-root"});this.renderRoot.prepend(t),await this.loadPluginStylesheet(),t.addEventListener(Ut.SHOW_LOADER,this.displayLoader.bind(this)),t.addEventListener(Ut.TOAST,this.sendToast),t.addEventListener(Ut.HIDE_LOADER,this.hideLoader.bind(this));const{context:e}=L.appStore,{activePlugin:o}=e;o.decorate(t,o.data,L.appStore.searchQuery),t.setAttribute("id",`${o.config.title.toLowerCase()}-plugin`)}),q.instance.addEventListener(st.PLUGIN_UNLOADED,()=>{const t=this.renderRoot.querySelector(".plugin-root");t&&(this.hideLoader(),t.remove())}),q.instance.addEventListener(st.SEARCH_UPDATED,()=>{const t=this.renderRoot.querySelector(".plugin-root");if(t){t.innerHTML="";const{context:e}=L.appStore,{activePlugin:o}=e;o.decorate(t,o.data,L.appStore.searchQuery)}})}loadPluginStylesheet(){return new Promise(t=>{const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.onload=()=>t(),e.onerror=()=>t();const o=L.appStore.context.activePlugin.path.replace(".js",".css");e.setAttribute("href",o),e.setAttribute("type","text/css"),this.renderRoot.append(e)})}displayLoader(){var t;(t=this.progressContainer.value)==null||t.classList.add("visible")}hideLoader(){var t;(t=this.progressContainer.value)==null||t.classList.remove("visible")}sendToast(t){q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:t.detail}))}render(){return u`
    ...
    `}}function Y(r,t={}){Y.defer=Y.defer||[];const e=o=>{Y[o]=Y[o]||((...a)=>Y.defer.push({fnname:o,args:a}))};Y.drain=Y.drain||((o,a)=>{Y[o]=a,Y.defer.filter(({fnname:s})=>o===s).forEach(({fnname:s,args:i})=>Y[s](...i))}),Y.on=(o,a)=>{Y.cases[o]=a},e("observe"),e("cwv");try{if(window.hlx=window.hlx||{},!window.hlx.rum){const s=new URLSearchParams(window.location.search).get("rum")==="on"?1:100,i=`${window.location.href.split("").reduce((l,d)=>(l<<5)-l+d.charCodeAt(0)|0,0)}-${new Date().getTime()}-${Math.random().toString(16).substr(2,14)}`,c=Math.random(),n=c*s<1;window.hlx.rum={weight:s,id:i,random:c,isSelected:n,sampleRUM:Y}}const{weight:o,id:a}=window.hlx.rum;window.hlx&&window.hlx.rum&&window.hlx.rum.isSelected&&(((s=t)=>{const i=JSON.stringify({weight:o,id:a,referer:window.location.href,checkpoint:r,...t}),c=`https://rum.hlx.page/.rum/${o}`;navigator.sendBeacon(c,i),console.debug(`ping:${r}`,s)})(t),Y.cases[r]&&Y.cases[r]())}catch(o){}}function Ms(r,t=[]){if(r){const e={},o=function(a){const s={};return a.querySelectorAll(":scope > div").forEach(i=>{if(i.children){const c=[...i.children];if(c[1]){const n=c[1],l=Ls(c[0].textContent);let d="";if(n.querySelector("a")){const p=[...n.querySelectorAll("a")];d=p.length===1?p[0].href:p.map(g=>g.href)}else if(n.querySelector("img")){const p=[...n.querySelectorAll("img")];d=p.length===1?p[0].src:p.map(g=>g.src)}else if(n.querySelector("p")){const p=[...n.querySelectorAll("p")];d=p.length===1?p[0].textContent:p.map(g=>g.textContent)}else d=i.children[1].textContent;s[l]=d}}}),s}(r);return Object.keys(o).forEach(a=>{t.includes(a)||(e[function(s){return Ls(s).replace(/-([a-z])/g,i=>i[1].toUpperCase())}(a)]=o[a])}),e}}function _s(r){const t=r.querySelector(".library-metadata");if(t){const e=Ms(t,["style"]);return t.remove(),e}}function Rs(r,t=!0){if(!r)return;const e=r.className.split(" "),o=e.shift();if(!t)return o;const a=e.filter(s=>s!=="sidekick-library"&&s!=="");return a.length>0?`${o} (${a.join(", ")})`:o}V(Os,"styles",k`
    sp-sidenav {
      width: 100%;
    }
  ...
  `),customElements.define("plugin-renderer",Os);class to extends ct{constructor(){super(),this.type="hierarchical"}onPreview(t,e){this.dispatchEvent(new CustomEvent("PreviewBlock",{detail:{path:e}})),window.open(e,"_blank")}renderNoResults(){return`
    ...
    `}filterBlocks(t){const e=this.renderRoot.querySelector(".message-container"),o=this.renderRoot.querySelectorAll("sp-sidenav-item"),a=this.renderRoot.querySelectorAll("sp-sidenav-item > sp-sidenav-item"),s=this.renderRoot.querySelectorAll("sp-sidenav > sp-sidenav-item");let i=!0;if(t==="")return o.forEach(c=>{c.removeAttribute("aria-hidden"),c.removeAttribute("expanded")}),void(e&&e.remove());a.forEach(c=>{var n;const l=c.getAttribute("label").toLowerCase(),d=(n=c.dataset.searchTags)!=null?n:"";l.includes(t.toLowerCase())||d.split(",").some(p=>p.toLowerCase().includes(t.toLowerCase()))?c.removeAttribute("aria-hidden"):c.setAttribute("aria-hidden",!0)}),s.forEach(c=>{let n=!1;c.querySelectorAll("sp-sidenav-item").forEach(l=>{l.hasAttribute("aria-hidden")||(n=!0,i=!1,e&&e.remove())}),n?(c.setAttribute("expanded",!0),c.removeAttribute("aria-hidden")):c.setAttribute("aria-hidden",!0)}),i&&!e&&this.renderRoot.append(gt("div",{},this.renderNoResults()))}async loadBlocks(t,e){var o;const a=new URLSearchParams(window.location.search),s=a.has("path")?a.get("path"):void 0,i=a.has("index")?a.get("index"):void 0,c=gt("div",{class:"list-container"});if(this.type==="hierarchical"){const n=gt("sp-sidenav",{variant:"multilevel","data-testid":"blocks"});c.append(n);const l=[],d=t.map(async p=>{var g,h,v,f,w;const{url:b,path:j}=p,C=async function(z){if(window.blocks||(window.blocks={}),!window.blocks[z]){const E=await fetch(`${z}.plain.html`);if(!E.ok)return;const x=await E.text(),A=new DOMParser().parseFromString(x,"text/html");window.blocks[z]=A}return window.blocks[z]}(b);try{const z=await C;if(!z)throw new Error(`An error occurred fetching ${p.name}`);const{body:E}=z.cloneNode(!0),x=(g=function(N){const I=N.querySelector(":scope > div > .library-metadata:only-child");if(I){const B=I.parentElement,D=_s(I.parentElement);return B.remove(),D}return{}}(E))!=null?g:{},A=(h=x.type)!=null?h:void 0,T=function(N){const I=N.querySelector(".page-metadata");if(I){const B=Ms(I);return I.remove(),B}}(E);let M;if(A&&A.toLowerCase()==="template"){M||(M=Ze("Templates","sp-icon-file-code",!0,!1),l.push(M));const N=(v=x.name)!=null?v:p.name,I=(w=(f=x.searchtags)!=null?f:x["search-tags"])!=null?w:"",B=Ze(N,"sp-icon-file-code",!1,!0,"sp-icon-copy");I&&B.setAttribute("data-search-tags",I);const D={detail:{blockWrapper:E,blockData:p,blockURL:b,defaultLibraryMetadata:x,pageMetadata:T}};B.addEventListener("OnAction",P=>{P.preventDefault(),P.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",D))}),M.append(B),B.addEventListener("click",async()=>{this.dispatchEvent(new CustomEvent("LoadTemplate",D))}),s===j&&(M.setAttribute("expanded",!0),this.selectedItem=B,this.dispatchEvent(new CustomEvent("LoadTemplate",D)))}else{const N=Ze(p.name,"sp-icon-file-template",!0,!0,"sp-icon-preview");l.push(N),N.addEventListener("OnAction",D=>this.onPreview(D,b));const I=E.querySelectorAll(":scope > div");let B=0;I.forEach((D,P)=>{var F,O,J,W,at,Bt;if(B>0)return void(B-=1);const bt=(F=_s(D))!=null?F:{},ze=D.querySelector("div[class]");let Nt=(O=bt.name)!=null?O:Rs(ze);const Fs=Rs(ze,!0),co=(Bt=(at=(W=(J=bt.searchtags)!=null?J:bt["search-tags"])!=null?W:x.searchtags)!=null?at:x["search-tags"])!=null?Bt:"";(!Nt||Nt==="section-metadata")&&(Nt="Unnamed Item");const wt=Ze(Nt,"sp-icon-file-code",!1,!0,"sp-icon-copy");if(co&&wt.setAttribute("data-search-tags",co),bt.includeNext){const xt=Number(bt.includeNext);if(!Number.isNaN(xt)){const Je=document.createElement("body");let no=0;for(;no<xt;){const Vs=D.nextElementSibling;Je.append(Vs),no+=1}Je.prepend(D),D=Je,B=xt,x.multiSectionBlock=!0}}else if(bt.type==="section"){const xt=document.createElement("body");xt.append(D),D=xt,x.compoundBlock=!0}const Qe={detail:{blockWrapper:D,blockNameWithVariant:Fs,blockData:p,blockURL:b,sectionLibraryMetadata:bt,defaultLibraryMetadata:x,pageMetadata:T,index:P}};wt.classList.add("descendant"),wt.setAttribute("data-index",P),wt.addEventListener("OnAction",xt=>{xt.preventDefault(),xt.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",Qe))}),N.append(wt),wt.addEventListener("click",async()=>{this.selectedItem&&this.selectedItem.removeAttribute("selected"),wt.setAttribute("selected",!0),this.selectedItem=wt,this.dispatchEvent(new CustomEvent("LoadBlock",Qe))}),s===j&&i===P.toString()&&(N.setAttribute("expanded",!0),this.selectedItem=wt,this.dispatchEvent(new CustomEvent("LoadBlock",Qe)))})}return C}catch(z){console.error(z.message),e.dispatchEvent(new CustomEvent("Toast",{detail:{message:z.message,variant:"negative"}}))}});await Promise.all(d),n.append(...l.sort((p,g)=>{const h=p.getAttribute("label").toLowerCase(),v=g.getAttribute("label").toLowerCase();return h<v?-1:h>v?1:0})),setTimeout(()=>{this.selectedItem&&this.selectedItem.setAttribute("selected",!0)},1),n.querySelectorAll("sp-sidenav-item").length===0&&e.append(this.renderNoResults())}(o=this.renderRoot)==null||o.append(c)}}V(to,"properties",{mutationObserver:{state:!1},selectedItem:{state:!1},type:{state:!0}}),V(to,"styles",k`
    .list-container {
      width: 100%;
    }
