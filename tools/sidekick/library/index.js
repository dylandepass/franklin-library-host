...
`,Ca=Object.defineProperty,ja=Object.getOwnPropertyDescriptor,vr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?ja(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ca(t,r,s),s};const fr=class extends Ae(gt){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[Po]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let e=0,t=this.parentElement;for(;t instanceof fr;)e++,t=t.parentElement;return e}handleSideNavSelect(e){this.selected=e.target===this}handleClick(e){!this.href&&e&&e.preventDefault(),!this.disabled&&(!this.href||e!=null&&e.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(e){const t=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:e}});this.dispatchEvent(t)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return u`
            ...
            ${this.expanded?u`
                  ...
                  `:u``}
        `}updated(e){this.hasChildren&&this.expanded&&!this.selected&&(this.focusElement.tabIndex=-1),super.updated(e)}connectedCallback(){super.connectedCallback(),this.startTrackingSelection()}disconnectedCallback(){this.stopTrackingSelection(),super.disconnectedCallback()}async startTrackingSelection(){const e=this.parentSideNav;if(e&&(await e.updateComplete,e.startTrackingSelectionForItem(this),this.selected=this.value!=null&&this.value===e.value,this.selected===!0&&e.variant==="multilevel")){let t=this.parentElement;for(;t instanceof fr;)t.expanded=!0,t=t.parentElement}}stopTrackingSelection(){const e=this.parentSideNav;e&&e.stopTrackingSelectionForItem(this),this._parentSidenav=void 0}};let ae=fr;vr([m()],ae.prototype,"value",2),vr([m({type:Boolean,reflect:!0})],ae.prototype,"selected",2),vr([m({type:Boolean,reflect:!0})],ae.prototype,"expanded",2);var Ea=k`
...
`,Aa=Object.defineProperty,Ha=Object.getOwnPropertyDescriptor;class Oo extends P{constructor(){super(...arguments),this.label=""}static get styles(){return[Po,Ea]}update(t){this.hasAttribute("slot")||(this.slot="descendant"),super.update(t)}render(){return u`
        ...
        `}willUpdate(){if(!this.hasUpdated){const t=this.querySelector("[selected]");t&&(this.value=t.value)}}updated(t){super.updated(t),t.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}function y(e,t){customElements.define(e,t)}yr([m({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],Ie.prototype,"manageTabIndex",2),yr([m({reflect:!0})],Ie.prototype,"value",2),yr([m({reflect:!0})],Ie.prototype,"variant",2),y("sp-sidenav",Ie);class vt{constructor(){this.iconsetMap=new Map}static getInstance(){return vt.instance||(vt.instance=new vt),vt.instance}addIconset(t,r){this.iconsetMap.set(t,r);const o=new CustomEvent("sp-iconset-added",{bubbles:!0,composed:!0,detail:{name:t,iconset:r}});setTimeout(()=>window.dispatchEvent(o),0)}removeIconset(t){this.iconsetMap.delete(t);const r=new CustomEvent("sp-iconset-removed",{bubbles:!0,composed:!0,detail:{name:t}});setTimeout(()=>window.dispatchEvent(r),0)}getIconset(t){return this.iconsetMap.get(t)}}var Ta=Object.defineProperty,La=Object.getOwnPropertyDescriptor;class Mo extends Y{constructor(){super(...arguments),this.registered=!1,this.handleRemoved=({detail:t})=>{t.name===this.name&&(this.registered=!1,this.addIconset())}}firstUpdated(){this.style.display="none"}set name(t){this.registered&&(this._name&&vt.getInstance().removeIconset(this._name),t&&vt.getInstance().addIconset(t,this)),this._name=t}get name(){return this._name}connectedCallback(){super.connectedCallback(),this.addIconset(),window.addEventListener("sp-iconset-removed",this.handleRemoved)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-removed",this.handleRemoved),this.removeIconset()}addIconset(){!this.name||this.registered||(vt.getInstance().addIconset(this.name,this),this.registered=!0)}removeIconset(){this.name&&(vt.getInstance().removeIconset(this.name),this.registered=!1)}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?La(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&Ta(t,r,s)})([m()],Mo.prototype,"name",1);var Da=Object.defineProperty,qa=Object.getOwnPropertyDescriptor;class _o extends Mo{constructor(){super(...arguments),this.iconMap=new Map}updated(t){if(!this.slotContainer)return;const r=this.getSVGNodes(this.slotContainer);this.updateSVG(r),super.updated(t)}async applyIconToElement(t,r,o,a){await this.updateComplete;const s=this.iconMap.get(r);if(!s)throw new Error(`Unable to find icon ${r}`);const c=this.prepareSvgClone(s);c.setAttribute("role","img"),a?c.setAttribute("aria-label",a):c.setAttribute("aria-hidden","true"),t.shadowRoot?t.shadowRoot.appendChild(c):t.appendChild(c)}getIconList(){return[...this.iconMap.keys()]}prepareSvgClone(t){const r=t.cloneNode(!0),o=document.createElementNS("http://www.w3.org/2000/svg","svg"),a=r.getAttribute("viewBox")||"";for(o.style.cssText="pointer-events: none; display: block; width: 100%; height: 100%;",o.setAttribute("viewBox",a),o.setAttribute("preserveAspectRatio","xMidYMid meet"),o.setAttribute("focusable","false");r.childNodes.length>0;)o.appendChild(r.childNodes[0]);return o}getSVGIconName(t){return t}getSanitizedIconName(t){return t}renderDefaultContent(){return u``}render(){return u`
...
`,Pa=Object.defineProperty,Oa=Object.getOwnPropertyDescriptor,kr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Oa(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Pa(t,r,s),s};class Ft extends function(t,r){var o;class a extends t{constructor(...c){super(c),this.slotHasContent=!1,new He(this,{config:{characterData:!0,subtree:!0},callback:i=>{for(const n of i)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[gr])return;const c=[...this[gr]].filter(i=>!!i.tagName||!!i.textContent&&i.textContent.trim());this.slotHasContent=c.length>0}update(c){if(!this.hasUpdated){const{childNodes:i}=this,n=[...i].filter(l=>l.tagName?r?l.getAttribute("slot")===r:!l.hasAttribute("slot"):!!l.textContent&&l.textContent.trim());this.slotHasContent=n.length>0}super.update(c)}firstUpdated(c){super.firstUpdated(c),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=gr,Bo([m({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),Bo([Eo(r,!0)],a.prototype,o,2),a}(Ae(gt)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[Ba]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[u`
                <slot name="icon" ?icon-only=${!this.hasLabel}></slot>
            `,u`
                <span id="label">
                    <slot @slotchange=${this.manageTextObservedSlot}></slot>
                </span>
            `]}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(t){if(this.disabled)return t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation(),!1}proxyFocus(){this.focus()}shouldProxyClick(){let t=!1;if(this.anchorElement)this.anchorElement.click(),t=!0;else if(this.type!=="button"){const r=document.createElement("button");r.type=this.type,this.insertAdjacentElement("afterend",r),r.click(),r.remove(),t=!0}return t}renderAnchor(){return u`
            ${this.buttonContent}
            ${super.renderAnchor({id:"button",ariaHidden:!0,className:"button anchor hidden"})}
        `}renderButton(){return u`
            ${this.buttonContent}
        `}render(){return this.href&&this.href.length>0?this.renderAnchor():this.renderButton()}handleKeydown(t){const{code:r}=t;r==="Space"&&(t.preventDefault(),this.href===void 0&&(this.addEventListener("keyup",this.handleKeyup),this.active=!0))}handleKeypress(t){const{code:r}=t;switch(r){case"Enter":case"NumpadEnter":this.click()}}handleKeyup(t){const{code:r}=t;r==="Space"&&(this.removeEventListener("keyup",this.handleKeyup),this.active=!1,this.click())}handleRemoveActive(){this.active=!1}handlePointerdown(){this.active=!0}manageAnchor(){this.href&&this.href.length>0?(this.getAttribute("role")==="button"&&this.setAttribute("role","link"),this.removeEventListener("click",this.shouldProxyClick)):((!this.hasAttribute("role")||this.getAttribute("role")==="link")&&this.setAttribute("role","button"),this.addEventListener("click",this.shouldProxyClick))}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("tabindex")||(this.tabIndex=0),this.manageAnchor(),this.addEventListener("keydown",this.handleKeydown),this.addEventListener("keypress",this.handleKeypress),this.addEventListener("pointerdown",this.handlePointerdown)}updated(t){super.updated(t),t.has("href")&&this.manageAnchor(),t.has("label")&&this.setAttribute("aria-label",this.label||""),t.has("active")&&(this.active?(this.addEventListener("focusout",this.handleRemoveActive),this.addEventListener("pointerup",this.handleRemoveActive),this.addEventListener("pointercancel",this.handleRemoveActive),this.addEventListener("pointerleave",this.handleRemoveActive)):(this.removeEventListener("focusout",this.handleRemoveActive),this.removeEventListener("pointerup",this.handleRemoveActive),this.removeEventListener("pointercancel",this.handleRemoveActive),this.removeEventListener("pointerleave",this.handleRemoveActive))),this.anchorElement&&(this.anchorElement.addEventListener("focus",this.proxyFocus),this.anchorElement.tabIndex=-1)}}kr([m({type:Boolean,reflect:!0})],Ft.prototype,"active",2),kr([m({type:String})],Ft.prototype,"type",2),kr([Q(".anchor")],Ft.prototype,"anchorElement",2);var Ma=k`
...
`,Va=Object.defineProperty,Wa=Object.getOwnPropertyDescriptor,Uo=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Wa(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Va(t,r,s),s};class H extends P{static get styles(){return[Fa]}render(){return u`
            <slot></slot>
        `}}Uo([m()],H.prototype,"label",2),Uo([m({reflect:!0})],H.prototype,"size",2);var Ka=Object.defineProperty,Ga=Object.getOwnPropertyDescriptor,wr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ga(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ka(t,r,s),s};class Te extends H{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const r=this.parseIcon(this.name);t.detail.name===r.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,r,o){super.attributeChangedCallback(t,r,o),this.updateIconPromise=this.updateIcon()}render(){return this.name?u`
                <div id="container"></div>
            `:this.src?u`
                <img src="${this.src}" alt=${E(this.label)} />
            `:super.render()}async updateIcon(){if(this.updateIconPromise&&await this.updateIconPromise,!this.name)return Promise.resolve();const t=this.parseIcon(this.name),r=vt.getInstance().getIconset(t.iconset);return r&&this.iconContainer?(this.iconContainer.innerHTML="",r.applyIconToElement(this.iconContainer,t.icon,this.size||"",this.label?this.label:"")):Promise.resolve()}parseIcon(t){const r=t.split(":");let o="default",a=t;return r.length>1&&(o=r[0],a=r[1]),{iconset:o,icon:a}}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.updateIconPromise,t}}let xr;wr([m()],Te.prototype,"src",2),wr([m()],Te.prototype,"name",2),wr([Q("#container")],Te.prototype,"iconContainer",2);const J=function(e,...t){return xr?xr(e,...t):t.reduce((r,o,a)=>r+o+e[a+1],e[0])},tt=e=>{xr=e};y("sp-icon-cross75",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Cross75"}={})=>J`<svg
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-cross100",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Cross100"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-cross200",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Cross200"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-cross300",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Cross300"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
...
`,Za=Object.defineProperty,Xa=Object.getOwnPropertyDescriptor;const Ya={s:()=>u`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class Fo extends at(Ro){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Na,No]}get buttonContent(){return[Ya[this.size]()]}render(){return u`
            <div class="fill">${super.render()}</div>
        `}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?Xa(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&Za(t,r,s)})([m({reflect:!0})],Fo.prototype,"variant",2);var Qa=k`
...
`,Ja=Object.defineProperty,tc=Object.getOwnPropertyDescriptor;const ec={s:()=>u`
        <sp-icon-cross75
            slot="icon"
            class="icon spectrum-UIIcon-Cross75"
        ></sp-icon-cross75>
    ...
    `,xl:()=>u`
        <sp-icon-cross300
            ...
            class="icon spectrum-UIIcon-Cross300"
        ></sp-icon-cross300>
    `};class Vo extends at(Ro){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Qa,No]}get buttonContent(){return[ec[this.size]()]}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?tc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&Ja(t,r,s)})([m({reflect:!0})],Vo.prototype,"variant",2);var rc=k`
:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
--mod-sans-font-family-stack,var(--spectrum-sans-font-family-stack)
);justify-content:center;line-height:var(--mod-line-height-100,var(--spectrum-line-height-100));margin:0;overflow:visible;-webkit-text-decoration:none;text-decoration:none;text-transform:none;transition:background var(
--mod-animation-duration-100,var(--spectrum-animation-duration-100)
...
`;y("sp-icon-corner-triangle300",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Corner Triangle300"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 7 7"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
                ...
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t);const r=this.role==="button"&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(r?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}Ct([m({type:Boolean,reflect:!0})],yt.prototype,"emphasized",2),Ct([m({type:Boolean,reflect:!0,attribute:"hold-affordance"})],yt.prototype,"holdAffordance",2),Ct([m({type:Boolean,reflect:!0})],yt.prototype,"quiet",2),Ct([m({reflect:!0})],yt.prototype,"role",2),Ct([m({type:Boolean,reflect:!0})],yt.prototype,"selected",2),Ct([m({type:Boolean,reflect:!0})],yt.prototype,"toggles",2),Ct([m({reflect:!0})],yt.prototype,"variant",2),Ct([m({type:String})],yt.prototype,"value",1),y("sp-action-button",yt);const Ko=class{constructor(e,{mode:t}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:r})=>{this.handleHelpText(r),this.handleNegativeHelpText(r)},this.host=e,this.instanceCount=Ko.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=t}get isInternal(){return this.mode==="internal"}render(e){return u`
  ...
  >
    ...
    />
  </svg>`)()}});const F=function(e,...t){return zr?zr(e,...t):t.reduce((r,o,a)=>r+o+e[a+1],e[0])},V=e=>{zr=e};y("sp-icon-alert",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Alert"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
...
`,nc=Object.defineProperty,lc=Object.getOwnPropertyDescriptor,M=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?lc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&nc(t,r,s),s};const uc=["text","url","tel","email","password"];class _ extends function(t,{mode:r}={mode:"internal"}){return class extends t{constructor(){super(...arguments),this.helpTextManager=new Go(this,{mode:r})}get helpTextId(){return this.helpTextManager.id}renderHelpText(o){return this.helpTextManager.render(o)}}}(gt){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[ic,Cr]}get type(){var t;return(t=uc.find(r=>r===this._type))!=null?t:"text"}set type(t){const r=this._type;this._type=t,this.requestUpdate("type",r)}set value(t){if(t===this.value)return;const r=this._value;this._value=t,this.requestUpdate("value",r)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,r,o="none"){this.inputElement.setSelectionRange(t,r,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?u`
            ...
            `:this.valid?u`
                ...
                ></sp-icon-checkmark100>
            `:T}get displayValue(){return this.value.toString()}get renderMultiline(){return u`
        ...
        `}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then(()=>{this.checkValidity()}),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),this.minlength!==void 0&&(t=t&&this.value.toString().length>=this.minlength),this.valid=t,this.invalid=!t),t}}M([m({attribute:"allowed-keys"})],_.prototype,"allowedKeys",2),M([m({type:Boolean,reflect:!0})],_.prototype,"focused",2),M([Q(".input")],_.prototype,"inputElement",2),M([m({type:Boolean,reflect:!0})],_.prototype,"invalid",2),M([m()],_.prototype,"label",2),M([m()],_.prototype,"placeholder",2),M([m({attribute:"type",reflect:!0})],_.prototype,"_type",2),M([ar()],_.prototype,"type",1),M([m()],_.prototype,"pattern",2),M([m({type:Boolean,reflect:!0})],_.prototype,"grows",2),M([m({type:Number})],_.prototype,"maxlength",2),M([m({type:Number})],_.prototype,"minlength",2),M([m({type:Boolean,reflect:!0})],_.prototype,"multiline",2),M([m({type:Boolean,reflect:!0})],_.prototype,"readonly",2),M([m({type:Boolean,reflect:!0})],_.prototype,"valid",2),M([m({type:String})],_.prototype,"value",1),M([m({type:Boolean,reflect:!0})],_.prototype,"quiet",2),M([m({type:Boolean,reflect:!0})],_.prototype,"required",2),M([m({type:String,reflect:!0})],_.prototype,"autocomplete",2);class jr extends _{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const r=this._value;this._value=t,this.requestUpdate("value",r)}get value(){return this._value}}M([m({type:String})],jr.prototype,"value",1),y("sp-clear-button",Fo),y("sp-icon-magnify",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Magnify"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
...
`,pc=Object.defineProperty,dc=Object.getOwnPropertyDescriptor,ie=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?dc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&pc(t,r,s),s};const gc=e=>e.stopPropagation();class Vt extends jr{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,mc]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:r}=t;!this.value||r!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return u`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}ie([m()],Vt.prototype,"action",2),ie([m()],Vt.prototype,"label",2),ie([m()],Vt.prototype,"method",2),ie([m()],Vt.prototype,"placeholder",2),ie([Q("#form")],Vt.prototype,"form",2),y("sp-search",Vt);var Zo=k`
...
`,hc=Object.defineProperty,bc=Object.getOwnPropertyDescriptor;class Er extends at(P,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Er.styles=[Zo],((e,t,r,o)=>{for(var a,s=o>1?void 0:o?bc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&hc(t,r,s)})([m({type:Boolean,reflect:!0})],Er.prototype,"vertical",2),y("sp-divider",Er),y("sp-close-button",Vo),y("sp-icon-info",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Info"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-checkmark-circle",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Checkmark Circle"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    width=${e}
    height=${t}
    viewBox="0 0 36 36"
...
`,fc=Object.defineProperty,yc=Object.getOwnPropertyDescriptor,Ar=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?yc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&fc(t,r,s),s};const kc=["negative","positive","info","error","warning"];class Le extends P{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[vc]}set timeout(t){const r=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;r&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=r,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const r=this.variant;kc.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",r)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(this.timeout!==null&&this.open?this.startCountdown():this.stopCountdown())}}Ar([m({type:Boolean,reflect:!0})],Le.prototype,"open",2),Ar([m({type:Number})],Le.prototype,"timeout",1),Ar([m({type:String})],Le.prototype,"variant",1),y("sp-toast",Le);const De=async(e,t,r,o)=>{const{Overlay:a}=await Promise.resolve().then(function(){return Fi});return a.open(e,t,r,o)};var wc=k`
...
`,Sc=Object.defineProperty,Tc=Object.getOwnPropertyDescriptor,ne=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Tc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Sc(t,r,s),s};class Gt extends at(P,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[Ic]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return u`
            <div class="track"></div>
            <div class="fills">
                ${["Mask1","Mask2"].map((r,o)=>u`
                        <div class="fill${r}">
                            <div
                                class="fillSub${r}"
                                style=${E(t[o])}
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(t){super.updated(t),!this.indeterminate&&t.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),this.label&&t.has("label")&&this.setAttribute("aria-label",this.label)}}ne([m({type:Boolean,reflect:!0})],Gt.prototype,"indeterminate",2),ne([m({type:String})],Gt.prototype,"label",2),ne([m({type:Boolean,reflect:!0,attribute:"over-background"})],Gt.prototype,"overBackground",2),ne([m({reflect:!0})],Gt.prototype,"static",2),ne([m({type:Number})],Gt.prototype,"progress",2),y("sp-progress-circle",Gt);var Lc=k`
...
`],qc=Object.defineProperty,$c=Object.getOwnPropertyDescriptor,Jo=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?$c(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&qc(t,r,s),s};class qe extends P{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[Qo,Dc,Lc]}render(){return u`
        ...
        `}}qe.is="sp-illustrated-message",Jo([m()],qe.prototype,"heading",2),Jo([m()],qe.prototype,"description",2),y("sp-illustrated-message",qe),y("sp-icon-search",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Search"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    <path
      d="M33.173 30.215 25.4 22.443a12.826 12.826 0 1 0-2.957 2.957l7.772 7.772a2.1 2.1 0 0 0 2.958-2.958ZM6 15a9 9 0 1 1 9 9 9 9 0 0 1-9-9Z"
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-file-template",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="File Template"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-file-code",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="File Code"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-device-phone",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Device Phone"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-device-tablet",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Device Tablet"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-device-desktop",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Device Desktop"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-magic-wand",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Magic Wand"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-copy",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Copy"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-preview",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Preview"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-view-detail",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="View Detail"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-chevron-right",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Chevron Right"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-chevron-left",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Chevron Left"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
...
`,Pc=Object.defineProperty,Oc=Object.getOwnPropertyDescriptor,ts=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Oc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Pc(t,r,s),s};class Sr extends P{constructor(){super(...arguments),this.label=""}static get styles(){return[Bc]}render(){return this.variant==="file"?(t=>u`
    <svg
        class="file"
        role="img"
        viewBox="0 0 128 128"
...
`)(this.label):u`
        ...
        `}}ts([m({type:String,reflect:!0})],Sr.prototype,"variant",2),ts([m()],Sr.prototype,"label",2),y("sp-asset",Sr);var Mc=Object.defineProperty,_c=Object.getOwnPropertyDescriptor,Tr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?_c(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Mc(t,r,s),s};class $e extends gt{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return u`
            <input
                ...
                @change=${this.handleChange}
            />
        `}}Tr([m({type:Boolean,reflect:!0})],$e.prototype,"checked",2),Tr([m({type:Boolean,reflect:!0})],$e.prototype,"readonly",2),Tr([Q("#input")],$e.prototype,"inputElement",2),y("sp-icon-checkmark75",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Checkmark75"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-checkmark200",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Checkmark200"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-checkmark300",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Checkmark300"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-dash75",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Dash75"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
  ...
  </svg>`)()}}),y("sp-icon-dash100",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Dash100"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  </svg>`)()}}),y("sp-icon-dash200",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Dash200"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
  ...
  </svg>`)()}}),y("sp-icon-dash300",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Dash300"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
...
`,Nc=Object.defineProperty,Fc=Object.getOwnPropertyDescriptor,Lr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Fc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Nc(t,r,s),s};const Vc={s:u`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:u`
        ...
        ></sp-icon-dash300>
    `};class Be extends at($e){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[Rc,Cr,Uc]}render(){return u`
            ${super.render()}
            <span id="box">
                ${Vc[this.size]}
                ${Wc[this.size]}
        ...
        `}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),t.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}Lr([m({type:Boolean,reflect:!0})],Be.prototype,"indeterminate",2),Lr([m({type:Boolean,reflect:!0})],Be.prototype,"invalid",2),Lr([m({type:Boolean,reflect:!0})],Be.prototype,"emphasized",2),y("sp-checkbox",Be);var Kc=k`
...
`,Gc=Object.defineProperty,Zc=Object.getOwnPropertyDescriptor,es=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Zc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Gc(t,r,s),s};class Dr extends P{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[Kc]}render(){return u`
            <slot></slot>
        `}}es([m({type:Boolean,reflect:!0})],Dr.prototype,"opened",2),es([m({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Dr.prototype,"textOnly",2),y("sp-quick-actions",Dr);var Xc=k`
...
`],Qc=Object.defineProperty,Jc=Object.getOwnPropertyDescriptor,ht=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Jc(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Qc(t,r,s),s};class lt extends Ae(at(function(t,r){var o;const a=Array.isArray(r)?r:[r];return o=Nt,class extends t{constructor(...s){super(s),this[o]=new Map,this.managePresenceObservedSlot=()=>{let c=!1;a.forEach(i=>{const n=!!this.querySelector(i),l=this[Nt].get(i)||!1;c=c||l!==n,this[Nt].set(i,!!this.querySelector(i))}),c&&this.updateComplete.then(()=>{this.requestUpdate()})},new He(this,{config:{childList:!0,subtree:!0},callback:()=>{this.managePresenceObservedSlot()}}),this.managePresenceObservedSlot()}get slotContentIsPresent(){if(a.length===1)return this[Nt].get(a[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(s){if(this[Nt].has(s))return this[Nt].get(s)||!1;throw new Error(`The provided selector \`${s}\` is not being observed.`)}}}(Ho(P),['[slot="cover-photo"]','[slot="preview"]']),{validSizes:["s","m"]})){constructor(){super(...arguments),this.variant="standard",this._selected=!1,this.heading="",this.horizontal=!1,this.focused=!1,this.toggles=!1,this.value="",this.subheading="",this.handleFocusin=t=>{this.focused=!0,t.composedPath()[0]===this?this.addEventListener("keydown",this.handleKeydown):this.removeEventListener("keydown",this.handleKeydown)}}static get styles(){return[Qo,Yc,Xc]}get selected(){return this._selected}set selected(t){t!==this.selected&&(this._selected=t,this.requestUpdate("selected",!this._selected))}get hasCoverPhoto(){return this.getSlotContentPresence('[slot="cover-photo"]')}get hasPreview(){return this.getSlotContentPresence('[slot="preview"]')}click(){var t;(t=this.likeAnchor)==null||t.click()}handleFocusout(t){this.focused=!1,t.composedPath()[0]===this&&this.removeEventListener("keydown",this.handleKeydown)}handleKeydown(t){const{code:r}=t;switch(r){case"Space":if(this.toggleSelected(),this.toggles){t.preventDefault();break}case"Enter":case"NumpadEnter":this.click()}}handleSelectedChange(t){t.stopPropagation(),this.selected=t.target.checked,this.announceChange()}toggleSelected(){this.toggles?(this.selected=!this.selected,this.announceChange()):this.dispatchEvent(new Event("click",{bubbles:!0,composed:!0}))}announceChange(){this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0,composed:!0}))||(this.selected=!this.selected)}stopPropagationOnHref(t){this.href&&t.stopPropagation()}handlePointerdown(t){if(t.composedPath().some(a=>a.localName==="a"))return;const r=+new Date,o=()=>{+new Date-r<200&&this.click(),this.removeEventListener("pointerup",o),this.removeEventListener("pointercancel",o)};this.addEventListener("pointerup",o),this.addEventListener("pointercancel",o)}get renderHeading(){return u`
        ...
        `}render(){return u`
            ...
            ${this.variant==="quiet"&&this.size==="s"?u`
                  ...
                  `:u``}
        `}firstUpdated(t){super.firstUpdated(t),this.addEventListener("pointerdown",this.handlePointerdown),this.addEventListener("focusin",this.handleFocusin),this.shadowRoot.addEventListener("focusin",this.handleFocusin),this.addEventListener("focusout",this.handleFocusout)}}ht([m()],lt.prototype,"asset",2),ht([m({reflect:!0})],lt.prototype,"variant",2),ht([m({type:Boolean,reflect:!0})],lt.prototype,"selected",1),ht([m()],lt.prototype,"heading",2),ht([m({type:Boolean,reflect:!0})],lt.prototype,"horizontal",2),ht([Q("#like-anchor")],lt.prototype,"likeAnchor",2),ht([m({type:Boolean,reflect:!0})],lt.prototype,"focused",2),ht([m({type:Boolean,reflect:!0})],lt.prototype,"toggles",2),ht([m()],lt.prototype,"value",2),ht([m()],lt.prototype,"subheading",2),y("sp-card",lt);var ti=k`
...
`,ei=Object.defineProperty,ri=Object.getOwnPropertyDescriptor;class rs extends at(P){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[ti]}handleSlotchange({target:t}){t.assignedElements().forEach(r=>{r.size=this.size})}render(){return u`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?ri(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&ei(t,r,s)})([m({type:Boolean,reflect:!0})],rs.prototype,"vertical",2),y("sp-button-group",rs);var oi=k`
...
`,si=Object.defineProperty,ai=Object.getOwnPropertyDescriptor,At=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?ai(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&si(t,r,s),s};const qr=[];class kt extends at(P,{validSizes:["xs","s","m","l","xl"]}){constructor(){super(),this._buttons=[],this._buttonSelector="sp-action-button",this.rovingTabindexController=new Ao(this,{focusInIndex:t=>{let r=-1;const o=t.findIndex((a,s)=>(!t[r]&&!a.disabled&&(r=s),a.selected&&!a.disabled));return t[o]?o:r},elements:()=>this.buttons,isFocusableElement:t=>!t.disabled}),this.compact=!1,this.emphasized=!1,this.justified=!1,this.label="",this.quiet=!1,this.vertical=!1,this._selected=qr,this.manageButtons=()=>{const t=this.shadowRoot.querySelector("slot");if(!t)return;const r=t.assignedElements({flatten:!0}).reduce((a,s)=>{if(s.matches(this._buttonSelector))a.push(s);else{const c=Array.from(s.querySelectorAll(`:scope > ${this._buttonSelector}`));a.push(...c)}return a},[]);this.buttons=r;const o=[];this.buttons.forEach(a=>{a.selected&&o.push(a.value)}),this.setSelected(this.selected.concat(o)),this.manageChildren(),this.manageSelects()},new He(this,{config:{childList:!0,subtree:!0},callback:()=>{this.manageButtons()}})}static get styles(){return[oi]}set buttons(t){t!==this.buttons&&(this._buttons=t,this.rovingTabindexController.clearElementCache())}get buttons(){return this._buttons}set selected(t){this.requestUpdate("selected",this._selected),this._selected=t,this.updateComplete.then(()=>{this.applySelects(),this.manageChildren()})}get selected(){return this._selected}dispatchChange(t){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))||(this.setSelected(t),this.buttons.map(r=>{r.selected=this.selected.includes(r.value)}))}setSelected(t,r){if(t===this.selected)return;const o=this.selected;this.requestUpdate("selected",o),this._selected=t,r&&this.dispatchChange(o)}focus(t){this.rovingTabindexController.focus(t)}deselectSelectedButtons(){[...this.querySelectorAll("[selected]")].forEach(t=>{t.selected=!1,t.tabIndex=-1,t.setAttribute("aria-checked","false")})}handleClick(t){const r=t.target;if(r.value!==void 0)switch(this.selects){case"single":this.deselectSelectedButtons(),r.selected=!0,r.tabIndex=0,r.setAttribute("aria-checked","true"),this.setSelected([r.value],!0),r.focus();break;case"multiple":{const o=[...this.selected];r.selected=!r.selected,r.setAttribute("aria-checked",r.selected?"true":"false"),r.selected?o.push(r.value):o.splice(this.selected.indexOf(r.value),1),this.setSelected(o,!0),this.buttons.forEach(a=>{a.tabIndex=-1}),r.tabIndex=0;break}}}async applySelects(){await this.manageSelects(!0)}async manageSelects(t){if(!this.buttons.length)return;const r=this.buttons;switch(this.selects){case"single":{this.setAttribute("role","radiogroup");const o=[],a=r.map(async c=>{await c.updateComplete,c.setAttribute("role","radio"),c.setAttribute("aria-checked",c.selected?"true":"false"),c.selected&&o.push(c)});if(t)break;await Promise.all(a);const s=o.map(c=>c.value);this.setSelected(s||qr);break}case"multiple":{this.setAttribute("role","group");const o=[],a=[],s=r.map(async i=>{await i.updateComplete,i.setAttribute("role","checkbox"),i.setAttribute("aria-checked",i.selected?"true":"false"),i.selected&&(o.push(i.value),a.push(i))});if(t)break;await Promise.all(s);const c=o.length?o:qr;this.setSelected(c);break}default:if(!this.selected.length){this.buttons.forEach(o=>{o.setAttribute("role","button")}),this.removeAttribute("role");break}{const o=[],a=r.map(async s=>{await s.updateComplete,s.setAttribute("aria-checked",s.selected?"true":"false"),s.setAttribute("role","button"),s.selected&&o.push(s)});if(t)break;await Promise.all(a),this.setSelected(o.map(s=>s.value))}}}render(){return u`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.addEventListener("click",this.handleClick)}updated(t){super.updated(t),t.has("selects")&&(this.manageSelects(),this.manageChildren()),(t.has("quiet")&&this.quiet||t.has("emphasized")&&this.emphasized||t.has("size")&&this.size)&&this.manageChildren(),t.has("label")&&(this.label||t.get("label")!==void 0)&&(this.label.length?this.setAttribute("aria-label",this.label):this.removeAttribute("aria-label"))}manageChildren(){this.buttons.forEach(t=>{t.quiet=this.quiet,t.emphasized=this.emphasized,t.selected=this.selected.includes(t.value),t.size=this.size})}}At([m({type:Boolean,reflect:!0})],kt.prototype,"compact",2),At([m({type:Boolean,reflect:!0})],kt.prototype,"emphasized",2),At([m({type:Boolean,reflect:!0})],kt.prototype,"justified",2),At([m({type:String})],kt.prototype,"label",2),At([m({type:Boolean,reflect:!0})],kt.prototype,"quiet",2),At([m({type:String})],kt.prototype,"selects",2),At([m({type:Boolean,reflect:!0})],kt.prototype,"vertical",2),At([m({type:Array})],kt.prototype,"selected",1),y("sp-action-group",kt),y("sp-icon",Te),y("sp-icon-chevron100",class extends H{render(){return tt(u),(({width:e=24,height:t=24,title:r="Chevron100"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
...
`,bi=Object.defineProperty,vi=Object.getOwnPropertyDescriptor,is=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?vi(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&bi(t,r,s),s};const $r=class extends wt{constructor(){super(),$r.instances+=1,this.headerId=`sp-menu-group-label-${$r.instances}`}static get styles(){return[...super.styles,hi]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return u`
        ...
        `}};let Oe=$r;Oe.instances=0,is([Eo("header",!0)],Oe.prototype,"headerElements",2),is([ar()],Oe.prototype,"headerElement",2),y("sp-menu-group",Oe);var fi=k`
...
`,xi=Object.defineProperty,zi=Object.getOwnPropertyDescriptor;class ns extends P{constructor(){super(...arguments),this.open=!1}static get styles(){return[wi]}render(){return u``}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?zi(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&xi(t,r,s)})([m({type:Boolean,reflect:!0})],ns.prototype,"open",2),y("sp-underlay",ns);class ls{constructor(t,r){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(r),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}}var Ci=k`
...
`,Ei=Object.defineProperty,Ai=Object.getOwnPropertyDescriptor,us=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ai(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ei(t,r,s),s};class Br extends P{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new ls(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[Ci,ji]}focus(){const t=lr(this);t?t.focus():this.children.length===1?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(t){t.has("open")&&t.get("open")!==void 0&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise(r=>{this.resolveTransitionPromise=()=>{this.animating=!1,r()}})),super.update(t)}render(){return u`
        ...
        `}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.transitionPromise,t}}us([m({type:Boolean,reflect:!0})],Br.prototype,"open",2),us([Q(".tray")],Br.prototype,"tray",2),y("sp-tray",Br);var Hi=k`
:host{--spectrum-overlay-animation-distance:var(
--spectrum-picker-m-texticon-popover-offset-y,var(--spectrum-global-dimension-size-75)
...
`,Ii=Object.defineProperty,Si=Object.getOwnPropertyDescriptor,Me=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Si(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ii(t,r,s),s};class le extends P{constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[Hi]}renderTip(){return u`
            <div id="tip">
                <svg
        ...
        `}connectedCallback(){super.connectedCallback(),this.addEventListener("sp-overlay-query",this.onOverlayQuery)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sp-overlay-query",this.onOverlayQuery)}onOverlayQuery(t){if(!t.target||t.target!==this)return;const r=this.shadowRoot.querySelector("#tip");r&&(t.detail.overlayContentTipElement=r)}render(){return u`
            <slot></slot>
            ${this.tip?this.renderTip():T}
        `}}Me([m({type:Boolean,reflect:!0})],le.prototype,"dialog",2),Me([m({type:Boolean,reflect:!0})],le.prototype,"open",2),Me([m({reflect:!0})],le.prototype,"placement",2),Me([m({type:Boolean,reflect:!0})],le.prototype,"tip",2),y("sp-popover",le);var Ti=k`
...
`;const Zt=e=>{if(!e)return null;const t=e.closest("active-overlay");if(t)return t;const r=e.getRootNode();return r.host?Zt(r.host):null},Pr=(e,t)=>{const r=[];if(!e)return[];for(const o of t)o.root&&Zt(o.root)===e&&(r.push(o),r.push(...Pr(o,t)));return r};function Xt(e){return e.split("-")[1]}function Or(e){return e==="y"?"height":"width"}function It(e){return e.split("-")[0]}function Yt(e){return["top","bottom"].includes(It(e))?"x":"y"}function ms(e,t,r){let{reference:o,floating:a}=e;const s=o.x+o.width/2-a.width/2,c=o.y+o.height/2-a.height/2,i=Yt(t),n=Or(i),l=o[n]/2-a[n]/2,d=i==="x";let p;switch(It(t)){case"top":p={x:s,y:o.y-a.height};break;case"bottom":p={x:s,y:o.y+o.height};break;case"right":p={x:o.x+o.width,y:c};break;case"left":p={x:o.x-a.width,y:c};break;default:p={x:o.x,y:o.y}}switch(Xt(t)){case"start":p[i]-=l*(r&&d?-1:1);break;case"end":p[i]+=l*(r&&d?-1:1)}return p}function ps(e){return typeof e!="number"?function(t){return{top:0,right:0,bottom:0,left:0,...t}}(e):{top:e,right:e,bottom:e,left:e}}function _e(e){return{...e,top:e.y,left:e.x,right:e.x+e.width,bottom:e.y+e.height}}async function Mr(e,t){var r;t===void 0&&(t={});const{x:o,y:a,platform:s,rects:c,elements:i,strategy:n}=e,{boundary:l="clippingAncestors",rootBoundary:d="viewport",elementContext:p="floating",altBoundary:g=!1,padding:h=0}=t,b=ps(h),v=i[g?p==="floating"?"reference":"floating":p],w=_e(await s.getClippingRect({element:(r=await(s.isElement==null?void 0:s.isElement(v)))==null||r?v:v.contextElement||await(s.getDocumentElement==null?void 0:s.getDocumentElement(i.floating)),boundary:l,rootBoundary:d,strategy:n})),f=p==="floating"?{...c.floating,x:o,y:a}:c.reference,x=await(s.getOffsetParent==null?void 0:s.getOffsetParent(i.floating)),z=await(s.isElement==null?void 0:s.isElement(x))&&await(s.getScale==null?void 0:s.getScale(x))||{x:1,y:1},C=_e(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({rect:f,offsetParent:x,strategy:n}):f);return{top:(w.top-C.top+b.top)/z.y,bottom:(C.bottom-w.bottom+b.bottom)/z.y,left:(w.left-C.left+b.left)/z.x,right:(C.right-w.right+b.right)/z.x}}const _r=Math.min,qt=Math.max;function Rr(e,t,r){return qt(e,_r(t,r))}const Li={left:"right",right:"left",bottom:"top",top:"bottom"};function Re(e){return e.replace(/left|right|bottom|top/g,t=>Li[t])}const Di={start:"end",end:"start"};function Ur(e){return e.replace(/start|end/g,t=>Di[t])}const ds=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var r;const{placement:o,middlewareData:a,rects:s,initialPlacement:c,platform:i,elements:n}=t,{mainAxis:l=!0,crossAxis:d=!0,fallbackPlacements:p,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:h="none",flipAlignment:b=!0,...v}=e,w=It(o),f=It(c)===c,x=await(i.isRTL==null?void 0:i.isRTL(n.floating)),z=p||(f||!b?[Re(c)]:function(q){const Z=Re(q);return[Ur(q),Z,Ur(Z)]}(c));p||h==="none"||z.push(...function(q,Z,B,R){const K=Xt(q);let O=function(it,X,dt){const ye=["left","right"],ao=["right","left"],Ps=["top","bottom"],Os=["bottom","top"];switch(it){case"top":case"bottom":return dt?X?ao:ye:X?ye:ao;case"left":case"right":return X?Ps:Os;default:return[]}}(It(q),B==="start",R);return K&&(O=O.map(it=>it+"-"+K),Z&&(O=O.concat(O.map(Ur)))),O}(c,b,h,x));const C=[c,...z],S=await Mr(t,v),j=[];let I=((r=a.flip)==null?void 0:r.overflows)||[];if(l&&j.push(S[w]),d){const{main:q,cross:Z}=function(B,R,K){K===void 0&&(K=!1);const O=Xt(B),it=Yt(B),X=Or(it);let dt=it==="x"?O===(K?"end":"start")?"right":"left":O==="start"?"bottom":"top";return R.reference[X]>R.floating[X]&&(dt=Re(dt)),{main:dt,cross:Re(dt)}}(o,s,x);j.push(S[q],S[Z])}if(I=[...I,{placement:o,overflows:j}],!j.every(q=>q<=0)){var $,U;const q=((($=a.flip)==null?void 0:$.index)||0)+1,Z=C[q];if(Z)return{data:{index:q,overflows:I},reset:{placement:Z}};let B=(U=I.filter(R=>R.overflows[0]<=0).sort((R,K)=>R.overflows[1]-K.overflows[1])[0])==null?void 0:U.placement;if(!B)switch(g){case"bestFit":{var ft;const R=(ft=I.map(K=>[K.placement,K.overflows.filter(O=>O>0).reduce((O,it)=>O+it,0)]).sort((K,O)=>K[1]-O[1])[0])==null?void 0:ft[0];R&&(B=R);break}case"initialPlacement":B=c}if(o!==B)return{reset:{placement:B}}}return{}}}},qi=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(t){const{x:r,y:o}=t,a=await async function(s,c){const{placement:i,platform:n,elements:l}=s,d=await(n.isRTL==null?void 0:n.isRTL(l.floating)),p=It(i),g=Xt(i),h=Yt(i)==="x",b=["left","top"].includes(p)?-1:1,v=d&&h?-1:1,w=typeof c=="function"?c(s):c;let{mainAxis:f,crossAxis:x,alignmentAxis:z}=typeof w=="number"?{mainAxis:w,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...w};return g&&typeof z=="number"&&(x=g==="end"?-1*z:z),h?{x:x*v,y:f*b}:{x:f*b,y:x*v}}(t,e);return{x:r+a.x,y:o+a.y,data:a}}}},$i=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){const{placement:r,rects:o,platform:a,elements:s}=t,{apply:c=()=>{},...i}=e,n=await Mr(t,i),l=It(r),d=Xt(r),p=Yt(r)==="x",{width:g,height:h}=o.floating;let b,v;l==="top"||l==="bottom"?(b=l,v=d===(await(a.isRTL==null?void 0:a.isRTL(s.floating))?"start":"end")?"left":"right"):(v=l,b=d==="end"?"top":"bottom");const w=h-n[b],f=g-n[v],x=!t.middlewareData.shift;let z=w,C=f;if(p){const j=g-n.left-n.right;C=d||x?_r(f,j):j}else{const j=h-n.top-n.bottom;z=d||x?_r(w,j):j}if(x&&!d){const j=qt(n.left,0),I=qt(n.right,0),$=qt(n.top,0),U=qt(n.bottom,0);p?C=g-2*(j!==0||I!==0?j+I:qt(n.left,n.right)):z=h-2*($!==0||U!==0?$+U:qt(n.top,n.bottom))}await c({...t,availableWidth:C,availableHeight:z});const S=await a.getDimensions(s.floating);return g!==S.width||h!==S.height?{reset:{rects:!0}}:{}}}};function st(e){var t;return((t=e.ownerDocument)==null?void 0:t.defaultView)||window}function bt(e){return st(e).getComputedStyle(e)}function gs(e){return e instanceof st(e).Node}function St(e){return gs(e)?(e.nodeName||"").toLowerCase():""}let Ue;function hs(){if(Ue)return Ue;const e=navigator.userAgentData;return e&&Array.isArray(e.brands)?(Ue=e.brands.map(t=>t.brand+"/"+t.version).join(" "),Ue):navigator.userAgent}function mt(e){return e instanceof st(e).HTMLElement}function pt(e){return e instanceof st(e).Element}function bs(e){return typeof ShadowRoot>"u"?!1:e instanceof st(e).ShadowRoot||e instanceof ShadowRoot}function Ne(e){const{overflow:t,overflowX:r,overflowY:o,display:a}=bt(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+r)&&!["inline","contents"].includes(a)}function Bi(e){return["table","td","th"].includes(St(e))}function Nr(e){const t=/firefox/i.test(hs()),r=bt(e),o=r.backdropFilter||r.WebkitBackdropFilter;return r.transform!=="none"||r.perspective!=="none"||!!o&&o!=="none"||t&&r.willChange==="filter"||t&&!!r.filter&&r.filter!=="none"||["transform","perspective"].some(a=>r.willChange.includes(a))||["paint","layout","strict","content"].some(a=>{const s=r.contain;return s!=null&&s.includes(a)})}function Fr(){return/^((?!chrome|android).)*safari/i.test(hs())}function Vr(e){return["html","body","#document"].includes(St(e))}const vs=Math.min,ue=Math.max,Fe=Math.round;function fs(e){const t=bt(e);let r=parseFloat(t.width),o=parseFloat(t.height);const a=mt(e),s=a?e.offsetWidth:r,c=a?e.offsetHeight:o,i=Fe(r)!==s||Fe(o)!==c;return i&&(r=s,o=c),{width:r,height:o,fallback:i}}function ys(e){return pt(e)?e:e.contextElement}const ks={x:1,y:1};function Qt(e){const t=ys(e);if(!mt(t))return ks;const r=t.getBoundingClientRect(),{width:o,height:a,fallback:s}=fs(t);let c=(s?Fe(r.width):r.width)/o,i=(s?Fe(r.height):r.height)/a;return c&&Number.isFinite(c)||(c=1),i&&Number.isFinite(i)||(i=1),{x:c,y:i}}function $t(e,t,r,o){var a,s;t===void 0&&(t=!1),r===void 0&&(r=!1);const c=e.getBoundingClientRect(),i=ys(e);let n=ks;t&&(o?pt(o)&&(n=Qt(o)):n=Qt(e));const l=i?st(i):window,d=Fr()&&r;let p=(c.left+(d&&((a=l.visualViewport)==null?void 0:a.offsetLeft)||0))/n.x,g=(c.top+(d&&((s=l.visualViewport)==null?void 0:s.offsetTop)||0))/n.y,h=c.width/n.x,b=c.height/n.y;if(i){const v=st(i),w=o&&pt(o)?st(o):o;let f=v.frameElement;for(;f&&o&&w!==v;){const x=Qt(f),z=f.getBoundingClientRect(),C=getComputedStyle(f);z.x+=(f.clientLeft+parseFloat(C.paddingLeft))*x.x,z.y+=(f.clientTop+parseFloat(C.paddingTop))*x.y,p*=x.x,g*=x.y,h*=x.x,b*=x.y,p+=z.x,g+=z.y,f=st(f).frameElement}}return _e({width:h,height:b,x:p,y:g})}function Tt(e){return((gs(e)?e.ownerDocument:e.document)||window.document).documentElement}function Ve(e){return pt(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.pageXOffset,scrollTop:e.pageYOffset}}function ws(e){return $t(Tt(e)).left+Ve(e).scrollLeft}function me(e){if(St(e)==="html")return e;const t=e.assignedSlot||e.parentNode||bs(e)&&e.host||Tt(e);return bs(t)?t.host:t}function xs(e){const t=me(e);return Vr(t)?t.ownerDocument.body:mt(t)&&Ne(t)?t:xs(t)}function pe(e,t){var r;t===void 0&&(t=[]);const o=xs(e),a=o===((r=e.ownerDocument)==null?void 0:r.body),s=st(o);return a?t.concat(s,s.visualViewport||[],Ne(o)?o:[]):t.concat(o,pe(o))}function zs(e,t,r){let o;if(t==="viewport")o=function(c,i){const n=st(c),l=Tt(c),d=n.visualViewport;let p=l.clientWidth,g=l.clientHeight,h=0,b=0;if(d){p=d.width,g=d.height;const v=Fr();(!v||v&&i==="fixed")&&(h=d.offsetLeft,b=d.offsetTop)}return{width:p,height:g,x:h,y:b}}(e,r);else if(t==="document")o=function(c){const i=Tt(c),n=Ve(c),l=c.ownerDocument.body,d=ue(i.scrollWidth,i.clientWidth,l.scrollWidth,l.clientWidth),p=ue(i.scrollHeight,i.clientHeight,l.scrollHeight,l.clientHeight);let g=-n.scrollLeft+ws(c);const h=-n.scrollTop;return bt(l).direction==="rtl"&&(g+=ue(i.clientWidth,l.clientWidth)-d),{width:d,height:p,x:g,y:h}}(Tt(e));else if(pt(t))o=function(c,i){const n=$t(c,!0,i==="fixed"),l=n.top+c.clientTop,d=n.left+c.clientLeft,p=mt(c)?Qt(c):{x:1,y:1};return{width:c.clientWidth*p.x,height:c.clientHeight*p.y,x:d*p.x,y:l*p.y}}(t,r);else{const c={...t};if(Fr()){var a,s;const i=st(e);c.x-=((a=i.visualViewport)==null?void 0:a.offsetLeft)||0,c.y-=((s=i.visualViewport)==null?void 0:s.offsetTop)||0}o=c}return _e(o)}function Cs(e,t){return mt(e)&&bt(e).position!=="fixed"?t?t(e):e.offsetParent:null}function js(e,t){const r=st(e);if(!mt(e))return r;let o=Cs(e,t);for(;o&&Bi(o)&&bt(o).position==="static";)o=Cs(o,t);return o&&(St(o)==="html"||St(o)==="body"&&bt(o).position==="static"&&!Nr(o))?r:o||function(a){let s=me(a);for(;mt(s)&&!Vr(s);){if(Nr(s))return s;s=me(s)}return null}(e)||r}function Pi(e,t,r){const o=mt(t),a=Tt(t),s=$t(e,!0,r==="fixed",t);let c={scrollLeft:0,scrollTop:0};const i={x:0,y:0};if(o||!o&&r!=="fixed")if((St(t)!=="body"||Ne(a))&&(c=Ve(t)),mt(t)){const n=$t(t,!0);i.x=n.x+t.clientLeft,i.y=n.y+t.clientTop}else a&&(i.x=ws(a));return{x:s.left+c.scrollLeft-i.x,y:s.top+c.scrollTop-i.y,width:s.width,height:s.height}}const Oi={getClippingRect:function(e){let{element:t,boundary:r,rootBoundary:o,strategy:a}=e;const s=[...r==="clippingAncestors"?function(n,l){const d=l.get(n);if(d)return d;let p=pe(n).filter(v=>pt(v)&&St(v)!=="body"),g=null;const h=bt(n).position==="fixed";let b=h?me(n):n;for(;pt(b)&&!Vr(b);){const v=bt(b),w=Nr(b);v.position==="fixed"&&(g=null),(h?w||g:w||v.position!=="static"||!g||!["absolute","fixed"].includes(g.position))?g=v:p=p.filter(f=>f!==b),b=me(b)}return l.set(n,p),p}(t,this._c):[].concat(r),o],c=s[0],i=s.reduce((n,l)=>{const d=zs(t,l,a);return n.top=ue(d.top,n.top),n.right=vs(d.right,n.right),n.bottom=vs(d.bottom,n.bottom),n.left=ue(d.left,n.left),n},zs(t,c,a));return{width:i.right-i.left,height:i.bottom-i.top,x:i.left,y:i.top}},convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{rect:t,offsetParent:r,strategy:o}=e;const a=mt(r),s=Tt(r);if(r===s)return t;let c={scrollLeft:0,scrollTop:0},i={x:1,y:1};const n={x:0,y:0};if((a||!a&&o!=="fixed")&&((St(r)!=="body"||Ne(s))&&(c=Ve(r)),mt(r))){const l=$t(r);i=Qt(r),n.x=l.x+r.clientLeft,n.y=l.y+r.clientTop}return{width:t.width*i.x,height:t.height*i.y,x:t.x*i.x-c.scrollLeft*i.x+n.x,y:t.y*i.y-c.scrollTop*i.y+n.y}},isElement:pt,getDimensions:function(e){return fs(e)},getOffsetParent:js,getDocumentElement:Tt,getScale:Qt,async getElementRects(e){let{reference:t,floating:r,strategy:o}=e;const a=this.getOffsetParent||js,s=this.getDimensions;return{reference:Pi(t,await a(r),o),floating:{x:0,y:0,...await s(r)}}},getClientRects:e=>Array.from(e.getClientRects()),isRTL:e=>bt(e).direction==="rtl"},Mi=(e,t,r)=>{const o=new Map,a={platform:Oi,...r},s={...a.platform,_c:o};return(async(c,i,n)=>{const{placement:l="bottom",strategy:d="absolute",middleware:p=[],platform:g}=n,h=p.filter(Boolean),b=await(g.isRTL==null?void 0:g.isRTL(i));let v=await g.getElementRects({reference:c,floating:i,strategy:d}),{x:w,y:f}=ms(v,l,b),x=l,z={},C=0;for(let S=0;S<h.length;S++){const{name:j,fn:I}=h[S],{x:$,y:U,data:ft,reset:q}=await I({x:w,y:f,initialPlacement:l,placement:x,strategy:d,middlewareData:z,rects:v,platform:g,elements:{reference:c,floating:i}});w=$!=null?$:w,f=U!=null?U:f,z={...z,[j]:{...z[j],...ft}},q&&C<=50&&(C++,typeof q=="object"&&(q.placement&&(x=q.placement),q.rects&&(v=q.rects===!0?await g.getElementRects({reference:c,floating:i,strategy:d}):q.rects),{x:w,y:f}=ms(v,x,b)),S=-1)}return{x:w,y:f,placement:x,strategy:d,middlewareData:z}})(e,t,{...a,platform:s})};var _i=Object.defineProperty,Ri=Object.getOwnPropertyDescriptor,de=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ri(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&_i(t,r,s),s};const Es={initial:"idle",states:{idle:{on:{active:"active"}},active:{on:{hiding:"hiding",idle:"idle"}},hiding:{on:{dispose:"dispose"}},dispose:{on:{disposed:"disposed"}},disposed:{on:{}}}},As=(e,t)=>e?t&&Es.states[e].on[t]||e:Es.initial,Ui=e=>{var t;return(t={left:["right","bottom","top"],"left-start":["right-start","bottom","top"],"left-end":["right-end","bottom","top"],right:["left","bottom","top"],"right-start":["left-start","bottom","top"],"right-end":["left-end","bottom","top"],top:["bottom","left","right"],"top-start":["bottom-start","left","right"],"top-end":["bottom-end","left","right"],bottom:["top","left","right"],"bottom-start":["top-start","left","right"],"bottom-end":["top-end","left","right"]}[e])!=null?t:[e]},Hs=class extends P{constructor(){super(),this.contentAnimationPromise=Promise.resolve(!0),this.resolveContentAnimationPromise=()=>{},this._state=As(),this.animating=!1,this.theme={},this.tabbingAway=!1,this.offset=6,this.skidding=0,this.interaction="hover",this.positionAnimationFrame=0,this.willNotifyClosed=!1,this.isConstrained=!1,this.updateOverlayPosition=()=>{this.interaction!=="modal"&&this.cleanup?this.dispatchEvent(new Event("close")):this.setOverlayPosition()},this.resetOverlayPosition=()=>{this.style.removeProperty("max-height"),this.style.removeProperty("height"),this.initialHeight=void 0,this.isConstrained=!1,this.offsetHeight,this.setOverlayPosition()},this.setOverlayPosition=async()=>{if(!this.placement||this.placement==="none")return;function e(n){const l=window.devicePixelRatio||1;return Math.round(n*l)/l||-1e4}await(document.fonts?document.fonts.ready:Promise.resolve());const t=this.virtualTrigger?ds({padding:8,fallbackPlacements:Ui(this.placement)}):ds({padding:8}),r=[qi({mainAxis:this.offset,crossAxis:this.skidding}),(o={padding:8},o===void 0&&(o={}),{name:"shift",options:o,async fn(n){const{x:l,y:d,placement:p}=n,{mainAxis:g=!0,crossAxis:h=!1,limiter:b={fn:I=>{let{x:$,y:U}=I;return{x:$,y:U}}},...v}=o,w={x:l,y:d},f=await Mr(n,v),x=Yt(It(p)),z=x==="x"?"y":"x";let C=w[x],S=w[z];if(g){const I=x==="y"?"bottom":"right";C=Rr(C+f[x==="y"?"top":"left"],C,C-f[I])}if(h){const I=z==="y"?"bottom":"right";S=Rr(S+f[z==="y"?"top":"left"],S,S-f[I])}const j=b.fn({...n,[x]:C,[z]:S});return{...j,data:{x:j.x-l,y:j.y-d}}}}),t,$i({padding:8,apply:({availableWidth:n,availableHeight:l,rects:{floating:d}})=>{const p=Math.max(100,Math.floor(l)),g=d.height;this.initialHeight=(this.isConstrained||this.virtualTrigger)&&this.initialHeight||g,this.isConstrained=g<this.initialHeight||p<=g;const h=this.isConstrained?`${p}px`:"";Object.assign(this.style,{maxWidth:`${Math.floor(n)}px`,maxHeight:h,height:h})}})];var o;this.overlayContentTip&&r.push((n=>({name:"arrow",options:n,async fn(l){const{element:d,padding:p=0}=n||{},{x:g,y:h,placement:b,rects:v,platform:w,elements:f}=l;if(d==null)return{};const x=ps(p),z={x:g,y:h},C=Yt(b),S=Or(C),j=await w.getDimensions(d),I=C==="y",$=I?"top":"left",U=I?"bottom":"right",ft=I?"clientHeight":"clientWidth",q=v.reference[S]+v.reference[C]-z[C]-v.floating[S],Z=z[C]-v.reference[C],B=await(w.getOffsetParent==null?void 0:w.getOffsetParent(d));let R=B?B[ft]:0;R&&await(w.isElement==null?void 0:w.isElement(B))||(R=f.floating[ft]||v.floating[S]);const K=q/2-Z/2,O=x[$],it=R-j[S]-x[U],X=R/2-j[S]/2+K,dt=Rr(O,X,it),ye=Xt(b)!=null&&X!=dt&&v.reference[S]/2-(X<O?x[$]:x[U])-j[S]/2<0;return{[C]:z[C]-(ye?X<O?O-X:it-X:0),data:{[C]:dt,centerOffset:X-dt}}}}))({element:this.overlayContentTip}));const{x:a,y:s,placement:c,middlewareData:i}=await Mi(this.virtualTrigger||this.trigger,this,{placement:this.placement,middleware:r,strategy:"fixed"});if(Object.assign(this.style,{top:"0px",left:"0px",transform:`translate(${e(a)}px, ${e(s)}px)`}),c!==this.getAttribute("actual-placement")&&(this.setAttribute("actual-placement",c),this.overlayContent.setAttribute("placement",c)),this.overlayContentTip&&i.arrow){const{x:n,y:l}=i.arrow;Object.assign(this.overlayContentTip.style,{left:n!=null?`${e(n)}px`:"",top:l!=null?`${e(l)}px`:"",right:"",bottom:""})}},this.handleInlineTriggerKeydown=e=>{const{code:t,shiftKey:r}=e;if(t==="Tab"){if(r)return this.tabbingAway=!0,void this.dispatchEvent(new Event("close"));e.stopPropagation(),e.preventDefault(),this.focus()}},this.stealOverlayContentPromise=Promise.resolve(),this.stealOverlayContentPromise=new Promise(e=>this.stealOverlayContentResolver=e)}get state(){return this._state}set state(e){const t=As(this.state,e);t!==this.state&&(this._state=t,this.state==="active"||this.state==="hiding"?this.setAttribute("state",this.state):this.removeAttribute("state"))}async focus(){const e=lr(this);if(e){e.updateComplete&&await e.updateComplete;const t=this.getRootNode().activeElement;(t===this||!this.contains(t))&&e.focus()}else super.focus();this.removeAttribute("tabindex")}get hasTheme(){return!!this.theme.color||!!this.theme.scale||!!this.theme.lang}static get styles(){return[Ti]}get hasModalRoot(){return!!this._modalRoot}feature(){this.contains(document.activeElement)||(this.tabIndex=-1);const e=Zt(this.trigger);e&&e.slot==="open"&&(this._modalRoot=e._modalRoot||e),(this.interaction==="modal"||this._modalRoot)&&(this.slot="open",this.interaction==="modal"&&this.setAttribute("aria-modal","true"),this._modalRoot&&(e==null||e.feature()))}obscure(e){if(this.slot&&e==="modal"){if(this.removeAttribute("slot"),this.removeAttribute("aria-modal"),this.interaction!=="modal"){const t=Zt(this.trigger);return this._modalRoot=t==null?void 0:t.obscure(e),this._modalRoot}return this}}async willUpdate(){this.hasUpdated||!this.overlayContent||!this.trigger||(this.stealOverlayContent(this.overlayContent),this.state="active",this.feature(),this.placement&&this.placement!=="none"&&(await this.updateOverlayPosition(),document.addEventListener("sp-update-overlays",this.resetOverlayPosition)),this.placement&&this.placement!=="none"&&(this.contentAnimationPromise=this.applyContentAnimation("sp-overlay-fade-in")))}async openCallback(e){await this.updateComplete,this.receivesFocus&&await this.focus(),await e(),this.trigger.dispatchEvent(new CustomEvent("sp-opened",{bubbles:!0,composed:!0,cancelable:!0,detail:{interaction:this.interaction}}))}open(e){this.extractDetail(e)}extractDetail(e){this.overlayContent=e.content,this.overlayContentTip=e.contentTip,this.trigger=e.trigger,this.virtualTrigger=e.virtualTrigger,this.placement=e.placement,this.offset=e.offset,this.skidding=e.skidding||0,this.interaction=e.interaction,this.theme=e.theme,this.receivesFocus=e.receivesFocus,this.root=e.root}dispose(){this.state==="dispose"&&(this.timeout&&(clearTimeout(this.timeout),delete this.timeout),this.trigger.removeEventListener("keydown",this.handleInlineTriggerKeydown),this.returnOverlayContent(),this.state="disposed",this.willNotifyClosed&&(this.overlayContent.dispatchEvent(new Event("sp-overlay-closed")),this.willNotifyClosed=!1),this.cleanup&&this.cleanup())}stealOverlayContent(e){this.originalPlacement=e.getAttribute("placement"),this.restoreContent=br([e],this,{position:"beforeend",prepareCallback:t=>{const r=t.slot,o=t.placement;return t.removeAttribute("slot"),a=>{a.slot=r,a.placement=o}}}),this.stealOverlayContentResolver()}returnOverlayContent(){if(!this.restoreContent)return;const[e]=this.restoreContent();this.restoreContent=void 0,this.willNotifyClosed=!0,this.originalPlacement&&(e.setAttribute("placement",this.originalPlacement),delete this.originalPlacement)}async placeOverlay(){!this.placement||this.placement==="none"||(this.cleanup=function(e,t,r,o){o===void 0&&(o={});const{ancestorScroll:a=!0,ancestorResize:s=!0,elementResize:c=!0,animationFrame:i=!1}=o,n=a&&!i,l=n||s?[...pt(e)?pe(e):e.contextElement?pe(e.contextElement):[],...pe(t)]:[];l.forEach(h=>{n&&h.addEventListener("scroll",r,{passive:!0}),s&&h.addEventListener("resize",r)});let d,p=null;c&&(p=new ResizeObserver(()=>{r()}),pt(e)&&!i&&p.observe(e),pt(e)||!e.contextElement||i||p.observe(e.contextElement),p.observe(t));let g=i?$t(e):null;return i&&function h(){const b=$t(e);!g||b.x===g.x&&b.y===g.y&&b.width===g.width&&b.height===g.height||r(),g=b,d=requestAnimationFrame(h)}(),r(),()=>{var h;l.forEach(b=>{n&&b.removeEventListener("scroll",r),s&&b.removeEventListener("resize",r)}),(h=p)==null||h.disconnect(),p=null,i&&cancelAnimationFrame(d)}}(this.virtualTrigger||this.trigger,this,this.updateOverlayPosition,{elementResize:!1}))}async hide(e=!0){this.state==="active"&&(this.state="hiding",e&&await this.applyContentAnimation("sp-overlay-fade-out"),this.state="dispose")}schedulePositionUpdate(){cancelAnimationFrame(this.positionAnimationFrame),this.positionAnimationFrame=requestAnimationFrame(()=>{this.cleanup?this.updateOverlayPosition():this.placeOverlay()})}onSlotChange(){this.schedulePositionUpdate()}applyContentAnimation(e){return this.placement==="none"?Promise.resolve(!0):(this.resolveContentAnimationPromise(),new Promise(t=>{this.resolveContentAnimationPromise=()=>{t(!1)};const r=this.shadowRoot.querySelector("#contents"),o=a=>{e===a.animationName&&(r.removeEventListener("animationend",o),r.removeEventListener("animationcancel",o),this.animating=!1,t(a.type==="animationcancel"))};r.addEventListener("animationend",o),r.addEventListener("animationcancel",o),r.style.animationName=e,this.animating=!0}))}renderTheme(e){const{color:t,scale:r,lang:o,theme:a}=this.theme;return u`
        ...
        `}update(t){this.selects&&(this.selects="single"),t.has("disabled")&&this.disabled&&(this.open=!1),t.has("open")&&(this.open||t.get("open")!==void 0)&&(this.menuStatePromise=new Promise(r=>this.menuStateResolver=r),this.open?this.openMenu():this.closeMenu()),t.has("value")&&!t.has("selectedItem")&&this.updateMenuItems(),super.update(t)}get dismissHelper(){return u`
      ...
      `]}connectedCallback(){super.connectedCallback()}onClick(){this.handleClick(),this.selected=!1}onAction(t){t.preventDefault(),t.stopPropagation(),this.dispatchEvent(new CustomEvent(rt.ON_ACTION))}render(){return u`
      <a
        target=${E(this.target)}
        download=${E(this.download)}
        rel=${E(this.rel)}
        ...
        aria-current=${E(this.selected&&this.href?"page":void 0)}
      >
        ${this.disclosureArrow?u`<sp-icon-chevron-right class="disclosureArrow" size="s"></sp-icon-chevron-right>`:""}
        <slot name="icon"></slot>
        <div class="container">
          ${this.label}
          ${this.action?u`
...
`,Xi=Object.defineProperty,Yi=Object.getOwnPropertyDescriptor,G=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Yi(t,r):t,c=e.length-1;c>=0;c--)(a=e[c])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Xi(t,r,s),s};const Gr=3840;class W extends P{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Gr,this.secondaryMin=0,this.secondaryMax=Gr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Gr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Zi]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return u`
  ...
  `),customElements.define("library-header",Xr);class Yr extends Y{connectedCallback(){super.connectedCallback()}render(){return u`
  ...
  `),customElements.define("illustrated-message",Yr);const he=()=>new rn;class rn{}const Qr=new WeakMap,be=je(class extends $o{render(e){return T}update(e,[t]){var r;const o=t!==this.G;return o&&this.G!==void 0&&this.ot(void 0),(o||this.rt!==this.lt)&&(this.G=t,this.ct=(r=e.options)===null||r===void 0?void 0:r.host,this.ot(this.lt=e.element)),T}ot(e){var t;if(typeof this.G=="function"){const r=(t=this.ct)!==null&&t!==void 0?t:globalThis;let o=Qr.get(r);o===void 0&&(o=new WeakMap,Qr.set(r,o)),o.get(this.G)!==void 0&&this.G.call(this.ct,void 0),o.set(this.G,e),e!==void 0&&this.G.call(this.ct,e)}else this.G.value=e}get rt(){var e,t,r;return typeof this.G=="function"?(t=Qr.get((e=this.ct)!==null&&e!==void 0?e:globalThis))===null||t===void 0?void 0:t.get(this.G):(r=this.G)===null||r===void 0?void 0:r.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});class Jr extends Y{constructor(){super(),D(this,"promptInput",he()),D(this,"popover",he()),D(this,"generateButton",he()),this.state="ready"}connectedCallback(){super.connectedCallback()}onOpen(){this.promptInput.value.focus()}async onGenerate(){this.generateButton.value.toggleAttribute("disabled"),this.promptInput.value.toggleAttribute("disabled"),this.generating=!0,this.popover.value.open=!1;try{const t=await async function(r){const o={prompt:r,model:"text-davinci-003",max_tokens:256,temperature:.7,n:1,frequency_penalty:0,presence_penalty:0},a=await fetch("https://api.openai.com/v1/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${localStorage.getItem("open-ai-key")}`},body:JSON.stringify(o)}),s=await a.json();if(a.ok)return s.choices[0].text.trim();throw new Error(`${s.error.message}: ${s.error.code}`)}(`${this.promptInput.value.value}`);this.dispatchEvent(new CustomEvent("generated",{detail:{generated:t}}))}catch(t){this.dispatchEvent(new CustomEvent("error",{detail:{message:t}})),this.remove(),L.instance.dispatchEvent(new CustomEvent("Toast",{detail:{message:t,variant:"negative"}}))}}render(){return u`
  ...
  `),customElements.define("block-renderer",to);class ro extends Y{constructor(){super(),this.type="hierarchical"}onPreview(t,r){this.dispatchEvent(new CustomEvent("PreviewBlock",{detail:{path:r}})),window.open(r,"_blank")}renderNoResults(){return`
    ...
    `}filterBlocks(t){const r=this.renderRoot.querySelector(".message-container"),o=this.renderRoot.querySelectorAll("sp-sidenav-item"),a=this.renderRoot.querySelectorAll("sp-sidenav-item > sp-sidenav-item"),s=this.renderRoot.querySelectorAll("sp-sidenav > sp-sidenav-item");let c=!0;if(t==="")return o.forEach(i=>{i.removeAttribute("aria-hidden"),i.removeAttribute("expanded")}),void(r&&r.remove());a.forEach(i=>{var n;const l=i.label.toLowerCase(),d=(n=i.dataset.searchTags)!=null?n:"";l.includes(t.toLowerCase())||d.split(",").some(p=>p.toLowerCase().includes(t.toLowerCase()))?i.removeAttribute("aria-hidden"):i.setAttribute("aria-hidden",!0)}),s.forEach(i=>{let n=!1;i.querySelectorAll("sp-sidenav-item").forEach(l=>{l.hasAttribute("aria-hidden")||(n=!0,c=!1,r&&r.remove())}),n?(i.setAttribute("expanded",!0),i.removeAttribute("aria-hidden")):i.setAttribute("aria-hidden",!0)}),c&&!r&&this.renderRoot.append(ot("div",{},this.renderNoResults()))}async loadBlocks(t,r){var o;const a=ot("div",{class:"list-container"});if(this.type==="hierarchical"){const s=ot("sp-sidenav",{variant:"multilevel","data-testid":"blocks"});a.append(s);const c=[],i=t.map(async n=>{const{path:l}=n,d=Ge(A),p=Ke(l)?`${d}${l}`:l,g=async function(h){if(window.blocks||(window.blocks={}),!window.blocks[h]){const b=await fetch(`${h}.plain.html`);if(!b.ok)return;const v=await b.text(),w=new DOMParser().parseFromString(v,"text/html");window.blocks[h]=w}return window.blocks[h]}(p);try{const h=await g;if(!h)throw new Error(`An error occurred fetching ${n.name}`);const b=Ls(n.name,"sp-icon-file-template",!0,!0,"sp-icon-preview");c.push(b),b.addEventListener("OnAction",f=>this.onPreview(f,p));const{body:v}=h,w=function(f){const x=f.querySelector(":scope > div > .library-metadata:only-child");return x?$s(x.parentElement):{}}(v);return[...v.querySelectorAll(":scope > div")].forEach((f,x)=>{var z,C,S,j;const I=(z=$s(f))!=null?z:{},$=f.querySelector("div[class]"),U=eo($,!1),ft=(C=I.name)!=null?C:eo($),q=eo($,!0),Z=(j=(S=I.searchTags)!=null?S:w.searchTags)!=null?j:"";if(!U)return;const B=Ls(ft,"sp-icon-file-code",!1,!0,"sp-icon-copy");Z&&B.setAttribute("data-search-tags",Z),B.classList.add("descendant"),B.setAttribute("data-index",x),B.addEventListener("OnAction",R=>{R.preventDefault(),R.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",{detail:{blockWrapper:f,blockNameWithVariant:q,blockPath:p}}))}),b.append(B),B.addEventListener("click",async()=>{this.dispatchEvent(new CustomEvent("LoadBlock",{detail:{blockWrapper:f,blockData:n,sectionLibraryMetadata:I,defaultLibraryMetadata:w}}))})}),g}catch(h){console.error(h.message),r.dispatchEvent(new CustomEvent("Toast",{detail:{message:h.message,variant:"negative"}}))}});await Promise.all(i),s.append(...c.sort((n,l)=>{const d=n.getAttribute("label").toUpperCase(),p=l.getAttribute("label").toUpperCase();return d<p?-1:d>p?1:0})),s.querySelectorAll("sp-sidenav-item").length===0&&r.append(this.renderNoResults())}(o=this.renderRoot)==null||o.append(a)}}D(ro,"properties",{mutationObserver:{state:!1},type:{state:!0}}),D(ro,"styles",k`
    .list-container {
      width: 100%;
    }
  ...
  `),customElements.define("block-list",ro);class oo extends Y{render(){return u`
