...
`,Pa=Object.defineProperty,Oa=Object.getOwnPropertyDescriptor,kr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Oa(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Pa(t,r,s),s};class Ft extends function(t,r){var o;class a extends t{constructor(...i){super(i),this.slotHasContent=!1,new He(this,{config:{characterData:!0,subtree:!0},callback:c=>{for(const n of c)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[gr])return;const i=[...this[gr]].filter(c=>!!c.tagName||!!c.textContent&&c.textContent.trim());this.slotHasContent=i.length>0}update(i){if(!this.hasUpdated){const{childNodes:c}=this,n=[...c].filter(l=>l.tagName?r?l.getAttribute("slot")===r:!l.hasAttribute("slot"):!!l.textContent&&l.textContent.trim());this.slotHasContent=n.length>0}super.update(i)}firstUpdated(i){super.firstUpdated(i),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=gr,Bo([m({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),Bo([Eo(r,!0)],a.prototype,o,2),a}(Ae(gt)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[Ba]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[u`
...
`,Va=Object.defineProperty,Wa=Object.getOwnPropertyDescriptor,Uo=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Wa(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Va(t,r,s),s};class H extends P{static get styles(){return[Fa]}render(){return u`
            <slot></slot>
        `}}Uo([m()],H.prototype,"label",2),Uo([m({reflect:!0})],H.prototype,"size",2);var Ka=Object.defineProperty,Ga=Object.getOwnPropertyDescriptor,wr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ga(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ka(t,r,s),s};class Te extends H{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const r=this.parseIcon(this.name);t.detail.name===r.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,r,o){super.attributeChangedCallback(t,r,o),this.updateIconPromise=this.updateIcon()}render(){return this.name?u`
...
`,Za=Object.defineProperty,Xa=Object.getOwnPropertyDescriptor;const Ya={s:()=>u`
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class Fo extends st(Ro){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Na,No]}get buttonContent(){return[Ya[this.size]()]}render(){return u`
            <div class="fill">${super.render()}</div>
        `}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?Xa(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&Za(t,r,s)})([m({reflect:!0})],Fo.prototype,"variant",2);var Qa=k`
...
`,Ja=Object.defineProperty,ti=Object.getOwnPropertyDescriptor;const ei={s:()=>u`
        <sp-icon-cross75
            slot="icon"
            class="icon spectrum-UIIcon-Cross75"
        ></sp-icon-cross75>
    ...
    `,xl:()=>u`
        <sp-icon-cross300
            ...
            class="icon spectrum-UIIcon-Cross300"
        ></sp-icon-cross300>
    `};class Vo extends st(Ro){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Qa,No]}get buttonContent(){return[ei[this.size]()]}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?ti(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&Ja(t,r,s)})([m({reflect:!0})],Vo.prototype,"variant",2);var ri=k`
:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
--mod-sans-font-family-stack,var(--spectrum-sans-font-family-stack)
);justify-content:center;line-height:var(--mod-line-height-100,var(--spectrum-line-height-100));margin:0;overflow:visible;-webkit-text-decoration:none;text-decoration:none;text-transform:none;transition:background var(
--mod-animation-duration-100,var(--spectrum-animation-duration-100)
...
`,pi=Object.defineProperty,di=Object.getOwnPropertyDescriptor,ce=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?di(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&pi(t,r,s),s};const gi=e=>e.stopPropagation();class Vt extends jr{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,mi]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:r}=t;!this.value||r!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return u`
            <form
                action=${this.action}
                id="form"
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}ce([m()],Vt.prototype,"action",2),ce([m()],Vt.prototype,"label",2),ce([m()],Vt.prototype,"method",2),ce([m()],Vt.prototype,"placeholder",2),ce([Q("#form")],Vt.prototype,"form",2),y("sp-search",Vt);var Zo=k`
...
`,hi=Object.defineProperty,bi=Object.getOwnPropertyDescriptor;class Er extends st(P,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Er.styles=[Zo],((e,t,r,o)=>{for(var a,s=o>1?void 0:o?bi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&hi(t,r,s)})([m({type:Boolean,reflect:!0})],Er.prototype,"vertical",2),y("sp-divider",Er),y("sp-close-button",Vo),y("sp-icon-info",class extends H{render(){return V(u),(({width:e=24,height:t=24,hidden:r=!1,title:o="Info"}={})=>F`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
...
`,fi=Object.defineProperty,yi=Object.getOwnPropertyDescriptor,Ar=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?yi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&fi(t,r,s),s};const ki=["negative","positive","info","error","warning"];class Le extends P{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[vi]}set timeout(t){const r=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;r&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=r,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const r=this.variant;ki.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",r)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
...
`,Si=Object.defineProperty,Ti=Object.getOwnPropertyDescriptor,ne=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ti(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Si(t,r,s),s};class Gt extends st(P,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[Ii]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return u`
            <div class="track"></div>
            <div class="fills">
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(t){super.updated(t),!this.indeterminate&&t.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),this.label&&t.has("label")&&this.setAttribute("aria-label",this.label)}}ne([m({type:Boolean,reflect:!0})],Gt.prototype,"indeterminate",2),ne([m({type:String})],Gt.prototype,"label",2),ne([m({type:Boolean,reflect:!0,attribute:"over-background"})],Gt.prototype,"overBackground",2),ne([m({reflect:!0})],Gt.prototype,"static",2),ne([m({type:Number})],Gt.prototype,"progress",2),y("sp-progress-circle",Gt);var Li=k`
...
`],qi=Object.defineProperty,$i=Object.getOwnPropertyDescriptor,Jo=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?$i(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&qi(t,r,s),s};class qe extends P{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[Qo,Di,Li]}render(){return u`
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-button",ie);var Bi=k`
...
`,Pi=Object.defineProperty,Oi=Object.getOwnPropertyDescriptor,ts=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Oi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Pi(t,r,s),s};class Sr extends P{constructor(){super(...arguments),this.label=""}static get styles(){return[Bi]}render(){return this.variant==="file"?(t=>u`
    <svg
        class="file"
        role="img"
        viewBox="0 0 128 128"
...
`)(this.label):u`
            <slot></slot>
        `}}ts([m({type:String,reflect:!0})],Sr.prototype,"variant",2),ts([m()],Sr.prototype,"label",2),y("sp-asset",Sr);var Mi=Object.defineProperty,_i=Object.getOwnPropertyDescriptor,Tr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?_i(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Mi(t,r,s),s};class $e extends gt{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return u`
            <input
                id="input"
...
`,Ni=Object.defineProperty,Fi=Object.getOwnPropertyDescriptor,Lr=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Fi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ni(t,r,s),s};const Vi={s:u`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:u`
        ...
        ></sp-icon-dash300>
    `};class Be extends st($e){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[Ri,Cr,Ui]}render(){return u`
            ${super.render()}
            <span id="box">
                ${Vi[this.size]}
                ${Wi[this.size]}
...
`,Gi=Object.defineProperty,Zi=Object.getOwnPropertyDescriptor,es=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Zi(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Gi(t,r,s),s};class Dr extends P{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[Ki]}render(){return u`
            <slot></slot>
        `}}es([m({type:Boolean,reflect:!0})],Dr.prototype,"opened",2),es([m({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Dr.prototype,"textOnly",2),y("sp-quick-actions",Dr);var Xi=k`
...
`,ec=Object.defineProperty,rc=Object.getOwnPropertyDescriptor;class rs extends st(P){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[tc]}handleSlotchange({target:t}){t.assignedElements().forEach(r=>{r.size=this.size})}render(){return u`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?rc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&ec(t,r,s)})([m({type:Boolean,reflect:!0})],rs.prototype,"vertical",2),y("sp-button-group",rs);var oc=k`
...
`,bc=Object.defineProperty,vc=Object.getOwnPropertyDescriptor,cs=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?vc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&bc(t,r,s),s};const $r=class extends wt{constructor(){super(),$r.instances+=1,this.headerId=`sp-menu-group-label-${$r.instances}`}static get styles(){return[...super.styles,hc]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return u`
        ...
        `}};let Oe=$r;Oe.instances=0,cs([Eo("header",!0)],Oe.prototype,"headerElements",2),cs([ar()],Oe.prototype,"headerElement",2),y("sp-menu-group",Oe);var fc=k`
...
`;class yc extends st(P,{validSizes:["s","m","l"]}){static get styles(){return[Zo,fc]}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}}y("sp-menu-divider",yc);var kc=k`
...
`,xc=Object.defineProperty,zc=Object.getOwnPropertyDescriptor;class ns extends P{constructor(){super(...arguments),this.open=!1}static get styles(){return[wc]}render(){return u``}}((e,t,r,o)=>{for(var a,s=o>1?void 0:o?zc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);o&&s&&xc(t,r,s)})([m({type:Boolean,reflect:!0})],ns.prototype,"open",2),y("sp-underlay",ns);class ls{constructor(t,r){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(r),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}}var Cc=k`
...
`,Ec=Object.defineProperty,Ac=Object.getOwnPropertyDescriptor,us=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Ac(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ec(t,r,s),s};class Br extends P{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new ls(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[Cc,jc]}focus(){const t=lr(this);t?t.focus():this.children.length===1?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(t){t.has("open")&&t.get("open")!==void 0&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise(r=>{this.resolveTransitionPromise=()=>{this.animating=!1,r()}})),super.update(t)}render(){return u`
            <sp-underlay
                ?open=${this.open}
                @click=${this.close}
        ...
        `}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.transitionPromise,t}}us([m({type:Boolean,reflect:!0})],Br.prototype,"open",2),us([Q(".tray")],Br.prototype,"tray",2),y("sp-tray",Br);var Hc=k`
:host{--spectrum-overlay-animation-distance:var(
--spectrum-picker-m-texticon-popover-offset-y,var(--spectrum-global-dimension-size-75)
...
`,Ic=Object.defineProperty,Sc=Object.getOwnPropertyDescriptor,Me=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Sc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Ic(t,r,s),s};class le extends P{constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[Hc]}renderTip(){return u`
            <div id="tip">
                <svg
        ...
        `}}Me([m({type:Boolean,reflect:!0})],le.prototype,"dialog",2),Me([m({type:Boolean,reflect:!0})],le.prototype,"open",2),Me([m({reflect:!0})],le.prototype,"placement",2),Me([m({type:Boolean,reflect:!0})],le.prototype,"tip",2),y("sp-popover",le);var Tc=k`
...
`,Xc=Object.defineProperty,Yc=Object.getOwnPropertyDescriptor,G=(e,t,r,o)=>{for(var a,s=o>1?void 0:o?Yc(t,r):t,i=e.length-1;i>=0;i--)(a=e[i])&&(s=(o?a(t,r,s):a(s))||s);return o&&s&&Xc(t,r,s),s};const Gr=3840;class W extends P{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Gr,this.secondaryMin=0,this.secondaryMax=Gr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Gr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Zc]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return u`
            <slot
      ...
      `]}});class Qc{constructor(){D(this,"listeners",[])}addEventListener(t,r){const o={type:t,callback:r};return this.listeners.push(o),o}removeEventListener(t){for(let r=0;r<this.listeners.length;r++)if(t===this.listeners[r])return void this.listeners.splice(r,1)}removeEventListeners(t){t.forEach(r=>{this.removeEventListener(r)})}dispatchEvent(t){this.listeners.slice().forEach(r=>{t.type===r.type&&r.callback.apply(this,[t])})}}class L extends Qc{constructor(){return super(),L._instance||(L._instance=this),L._instance}static get instance(){return L._instance||(L._instance=new L),L._instance}}async function Ds(e){const t=await fetch(e);if(t.status===401)(async function(r){const o=new URL(r),a=await fetch(r,{credentials:"include"});if(a.status===401)window.open(o.origin,"_self");else if(!a.ok)throw new Error("unable to load library JSON");a.json()})(e);else if(!t.ok)throw new Error("unable to load library JSON");return t.json()}function ge(){return window.libraryDev}function Ge(e){return ge()?new URL(e.appStore.config.base).origin:window.location.origin}async function Jc(e,t){const{appStore:r}=e;let{libraries:o}=e;r.config=t;try{const a=await Ds(t.base),s=await async function(i){if(i){const{origin:c}=new URL(i),n=await Ds(i),l=n.data?n:n.blocks;return l&&l.data.forEach(d=>{d.path&&!d.path.includes("://")&&(d.path=`${c}${d.path}`,d.extended=!0)}),n}return Promise.resolve()}(t.extends);o=await async function(i,c){const n={};if(i[":type"]==="multi-sheet")for(const l of i[":names"])n[l]=i[l].data;else n.blocks=i.data;if(c)if(c[":type"]==="multi-sheet")for(const l of c[":names"])n[l]?n[l].push(...c[l].data):n[l]=c[l].data;else n.blocks=[...n.blocks||[],...c.data];return n}(a,s),r.libraries=o,L.instance.dispatchEvent(new CustomEvent(rt.LIBRARY_LOADED))}catch(a){L.instance.dispatchEvent(new CustomEvent(Pt.TOAST,{detail:{variant:"negative",message:e.appStore.localeDict.errorLoadingLibraryJSON}})),console.error("Unable to load library",a)}}D(L,"_instance",void 0);const tn={initialized:!1,activePlugin:void 0,activePluginPath:void 0,searchQuery:"",libraries:[],config:{},localeDict:{}};class A{static init(){A.appStore=function(t={},r="store"){function o(a,s,i){const c=new CustomEvent(s,{bubbles:!0,cancelable:!0,detail:i});return L.instance.dispatchEvent(c)}return new Proxy(t,function a(s,i){return{get:(c,n)=>n==="_isProxy"||(typeof c[n]=="object"&&c[n]!==null&&!c[n]._isProxy&&(c[n]=new Proxy(c[n],a(s,i))),c[n]),set:(c,n,l)=>(c[n]===l||(c[n]=l,o(0,n,i)),!0),deleteProperty:(c,n)=>(delete c[n],o(0,n,i),!0)}}(r,t))}(tn,"app"),A.appStore.webRoot=ge()?"./src/":A.host}}D(A,"host","https://main--franklin-library-host--dylandepass.hlx.live/tools/sidekick/library"),D(A,"appStore",void 0),D(A,"libraries",void 0);const en={blocks:ge()?"../../src/plugins/blocks/blocks.js":`${A.host}/plugins/blocks/blocks.js`,tags:ge()?"../../src/plugins/tags/tags.js":`${A.host}/plugins/tags/tags.js`,"api-test":ge()?"../../src/plugins/api-test/api-test.js":`${A.host}/plugins/api-test/api-test.js`};async function qs(e,t){const{appStore:r}=e,{config:o}=r,a=Ge(e);let s=en[t];const i=o[t];if(i&&(s=Ke(i)?`${a}${i}`:i),s)try{const c=await import(s);r.pluginData=r.libraries[t],r.activePluginPath=s,r.activePlugin=c.default,r.activePluginDecorate=c.decorate,L.instance.dispatchEvent(new CustomEvent(rt.PLUGIN_LOADED))}catch(c){L.instance.dispatchEvent(new CustomEvent(Pt.TOAST,{detail:{variant:"negative",message:e.appStore.localeDict.errorLoadingPlugin}})),Zr(e),console.error(`Error loading plugin ${t}: ${c.message}`)}else L.instance.dispatchEvent(new CustomEvent(Pt.TOAST,{detail:{variant:"negative",message:e.appStore.localeDict.unknownPlugin}}))}async function Zr(e){const{appStore:t}=e;t.activePlugin=void 0,t.pluginData=void 0,t.activePluginPath=void 0,t.activePluginDecorate=void 0,L.instance.dispatchEvent(new CustomEvent(rt.PLUGIN_UNLOADED))}class Xr extends Y{connectedCallback(){super.connectedCallback(),L.instance.addEventListener(rt.LIBRARY_LOADED,()=>{this.libraries=A.appStore.libraries;const t=Object.keys(this.libraries),r=t.includes("blocks")?"blocks":t[0];qs(A,r)}),L.instance.addEventListener(rt.PLUGIN_LOADED,()=>{if(A.appStore.activePlugin){const{searchEnabled:t}=A.appStore.activePlugin;t&&(this.searchEnabled=!0),this.pluginActive=!0,this.defaultPluginName=A.appStore.activePlugin.title.toLowerCase()}}),L.instance.addEventListener(rt.PLUGIN_UNLOADED,()=>{this.pluginActive=!1,this.searchEnabled=!1,this.searchActivated=!1;const t=this.renderRoot.querySelector(".middle-bar");t==null||t.classList.remove("search-active"),this.renderRoot.querySelector("sp-search").value=""})}onBack(){Zr(A)}activateSearch(){const t=this.renderRoot.querySelector(".middle-bar");this.searchActivated=!this.searchActivated,this.searchActivated?t==null||t.classList.add("search-active"):t==null||t.classList.remove("search-active");const r=this.renderRoot.querySelector("sp-search");r==null||r.focus()}async onPluginChange(t){const{value:r}=t.target;Zr(A),await qs(A,r)}onSearch(t){A.appStore.searchQuery=t.target.value,L.instance.dispatchEvent(new CustomEvent(rt.SEARCH_UPDATED))}renderLibraries(){if(this.libraries){const t=Object.keys(this.libraries);return u`
        <sp-picker
          quiet 
