...
`,Ba=Object.defineProperty,Pa=Object.getOwnPropertyDescriptor,fr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Pa(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ba(t,e,s),s};class Ft extends function(t,e){var o;class a extends t{constructor(...i){super(i),this.slotHasContent=!1,new Ae(this,{config:{characterData:!0,subtree:!0},callback:c=>{for(const n of c)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[pr])return;const i=[...this[pr]].filter(c=>!!c.tagName||!!c.textContent&&c.textContent.trim());this.slotHasContent=i.length>0}update(i){if(!this.hasUpdated){const{childNodes:c}=this,n=[...c].filter(m=>m.tagName?e?m.getAttribute("slot")===e:!m.hasAttribute("slot"):!!m.textContent&&m.textContent.trim());this.slotHasContent=n.length>0}super.update(i)}firstUpdated(i){super.firstUpdated(i),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=pr,qo([l({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),qo([Co(e,!0)],a.prototype,o,2),a}(Ee(ht)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[$a]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[u`
...
`,Fa=Object.defineProperty,Va=Object.getOwnPropertyDescriptor,_o=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Va(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Fa(t,e,s),s};class H extends ${static get styles(){return[Na]}render(){return u`
            <slot></slot>
        `}}_o([l()],H.prototype,"label",2),_o([l({reflect:!0})],H.prototype,"size",2);var Wa=Object.defineProperty,Ka=Object.getOwnPropertyDescriptor,yr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ka(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Wa(t,e,s),s};class Se extends H{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const e=this.parseIcon(this.name);t.detail.name===e.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o),this.updateIconPromise=this.updateIcon()}render(){return this.name?u`
                <div id="container"></div>
            `:this.src?u`
                <img src="${this.src}" alt=${E(this.label)} />
            `:super.render()}async updateIcon(){if(this.updateIconPromise&&await this.updateIconPromise,!this.name)return Promise.resolve();const t=this.parseIcon(this.name),e=ft.getInstance().getIconset(t.iconset);return e&&this.iconContainer?(this.iconContainer.innerHTML="",e.applyIconToElement(this.iconContainer,t.icon,this.size||"",this.label?this.label:"")):Promise.resolve()}parseIcon(t){const e=t.split(":");let o="default",a=t;return e.length>1&&(o=e[0],a=e[1]),{iconset:o,icon:a}}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.updateIconPromise,t}}let kr;yr([l()],Se.prototype,"src",2),yr([l()],Se.prototype,"name",2),yr([Q("#container")],Se.prototype,"iconContainer",2);const J=function(r,...t){return kr?kr(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},tt=r=>{kr=r};y("sp-icon-cross75",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Cross75"}={})=>J`<svg
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-cross100",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Cross100"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-cross200",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Cross200"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-cross300",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Cross300"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
...
`,Ga=Object.defineProperty,Za=Object.getOwnPropertyDescriptor;const Xa={s:()=>u`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class Uo extends st(Mo){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Ua,Ro]}get buttonContent(){return[Xa[this.size]()]}render(){return u`
            <div class="fill">${super.render()}</div>
        `}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?Za(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&Ga(t,e,s)})([l({reflect:!0})],Uo.prototype,"variant",2);var Ya=k`
...
`,Qa=Object.defineProperty,Ja=Object.getOwnPropertyDescriptor;const ti={s:()=>u`
        <sp-icon-cross75
            slot="icon"
            class="icon spectrum-UIIcon-Cross75"
        ></sp-icon-cross75>
    ...
    `,xl:()=>u`
        <sp-icon-cross300
            ...
            class="icon spectrum-UIIcon-Cross300"
        ></sp-icon-cross300>
    `};class No extends st(Mo){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Ya,Ro]}get buttonContent(){return[ti[this.size]()]}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ja(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&Qa(t,e,s)})([l({reflect:!0})],No.prototype,"variant",2);var ei=k`
:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
--mod-sans-font-family-stack,var(--spectrum-sans-font-family-stack)
);justify-content:center;line-height:var(--mod-line-height-100,var(--spectrum-line-height-100));margin:0;overflow:visible;-webkit-text-decoration:none;text-decoration:none;text-transform:none;transition:background var(
--mod-animation-duration-100,var(--spectrum-animation-duration-100)
...
`;y("sp-icon-corner-triangle300",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Corner Triangle300"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 7 7"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}});var oi=Object.defineProperty,si=Object.getOwnPropertyDescriptor,Ct=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?si(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&oi(t,e,s),s};const ai={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let Fo;class yt extends st(Ft,{validSizes:["xs","s","m","l","xl"]}){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[...super.styles,ei,ri]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(t){t.button===0&&(this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),Fo=setTimeout(()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))},300))}onPointerup(){clearTimeout(Fo),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:e,altKey:o}=t;(e==="Space"||o&&e==="ArrowDown")&&(t.preventDefault(),e==="ArrowDown"&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:e,altKey:o}=t;(e==="Space"||o&&e==="ArrowDown")&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(u`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${ai[this.size]}"
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t);const e=this.role==="button"&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(e?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}Ct([l({type:Boolean,reflect:!0})],yt.prototype,"emphasized",2),Ct([l({type:Boolean,reflect:!0,attribute:"hold-affordance"})],yt.prototype,"holdAffordance",2),Ct([l({type:Boolean,reflect:!0})],yt.prototype,"quiet",2),Ct([l({reflect:!0})],yt.prototype,"role",2),Ct([l({type:Boolean,reflect:!0})],yt.prototype,"selected",2),Ct([l({type:Boolean,reflect:!0})],yt.prototype,"toggles",2),Ct([l({reflect:!0})],yt.prototype,"variant",2),Ct([l({type:String})],yt.prototype,"value",1),y("sp-action-button",yt);const Vo=class{constructor(r,{mode:t}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:e})=>{this.handleHelpText(e),this.handleNegativeHelpText(e)},this.host=r,this.instanceCount=Vo.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=t}get isInternal(){return this.mode==="internal"}render(r){return u`
  ...
  >
    ...
    />
  </svg>`)()}});const N=function(r,...t){return wr?wr(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},F=r=>{wr=r};y("sp-icon-alert",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Alert"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,ci=Object.defineProperty,ni=Object.getOwnPropertyDescriptor,P=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?ni(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&ci(t,e,s),s};const li=["text","url","tel","email","password"];class O extends function(t,{mode:e}={mode:"internal"}){return class extends t{constructor(){super(...arguments),this.helpTextManager=new Wo(this,{mode:e})}get helpTextId(){return this.helpTextManager.id}renderHelpText(o){return this.helpTextManager.render(o)}}}(ht){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[ii,xr]}get type(){var t;return(t=li.find(e=>e===this._type))!=null?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?u`
        ...
        `}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then(()=>{this.checkValidity()}),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),this.minlength!==void 0&&(t=t&&this.value.toString().length>=this.minlength),this.valid=t,this.invalid=!t),t}}P([l({attribute:"allowed-keys"})],O.prototype,"allowedKeys",2),P([l({type:Boolean,reflect:!0})],O.prototype,"focused",2),P([Q(".input")],O.prototype,"inputElement",2),P([l({type:Boolean,reflect:!0})],O.prototype,"invalid",2),P([l()],O.prototype,"label",2),P([l()],O.prototype,"placeholder",2),P([l({attribute:"type",reflect:!0})],O.prototype,"_type",2),P([or()],O.prototype,"type",1),P([l()],O.prototype,"pattern",2),P([l({type:Boolean,reflect:!0})],O.prototype,"grows",2),P([l({type:Number})],O.prototype,"maxlength",2),P([l({type:Number})],O.prototype,"minlength",2),P([l({type:Boolean,reflect:!0})],O.prototype,"multiline",2),P([l({type:Boolean,reflect:!0})],O.prototype,"readonly",2),P([l({type:Boolean,reflect:!0})],O.prototype,"valid",2),P([l({type:String})],O.prototype,"value",1),P([l({type:Boolean,reflect:!0})],O.prototype,"quiet",2),P([l({type:Boolean,reflect:!0})],O.prototype,"required",2),P([l({type:String,reflect:!0})],O.prototype,"autocomplete",2);class zr extends O{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}P([l({type:String})],zr.prototype,"value",1),y("sp-clear-button",Uo),y("sp-icon-magnify",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Magnify"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,mi=Object.defineProperty,pi=Object.getOwnPropertyDescriptor,ce=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?pi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&mi(t,e,s),s};const di=r=>r.stopPropagation();class Vt extends zr{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,ui]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||e!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return u`
            <form
                action=${this.action}
                id="form"
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}ce([l()],Vt.prototype,"action",2),ce([l()],Vt.prototype,"label",2),ce([l()],Vt.prototype,"method",2),ce([l()],Vt.prototype,"placeholder",2),ce([Q("#form")],Vt.prototype,"form",2),y("sp-search",Vt);var Ko=k`
...
`,gi=Object.defineProperty,hi=Object.getOwnPropertyDescriptor;class Cr extends st($,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Cr.styles=[Ko],((r,t,e,o)=>{for(var a,s=o>1?void 0:o?hi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&gi(t,e,s)})([l({type:Boolean,reflect:!0})],Cr.prototype,"vertical",2),y("sp-divider",Cr),y("sp-close-button",No),y("sp-icon-info",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Info"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-checkmark-circle",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Checkmark Circle"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    width=${r}
    height=${t}
    viewBox="0 0 36 36"
...
`,vi=Object.defineProperty,fi=Object.getOwnPropertyDescriptor,jr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?fi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&vi(t,e,s),s};const yi=["negative","positive","info","error","warning"];class Te extends ${constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[bi]}set timeout(t){const e=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;yi.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(this.timeout!==null&&this.open?this.startCountdown():this.stopCountdown())}}jr([l({type:Boolean,reflect:!0})],Te.prototype,"open",2),jr([l({type:Number})],Te.prototype,"timeout",1),jr([l({type:String})],Te.prototype,"variant",1),y("sp-toast",Te);const Le=async(r,t,e,o)=>{const{Overlay:a}=await Promise.resolve().then(function(){return Nc});return a.open(r,t,e,o)};var ki=k`
...
`,Ii=Object.defineProperty,Si=Object.getOwnPropertyDescriptor,ne=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Si(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ii(t,e,s),s};class Gt extends st($,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[Hi]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return u`
            <div class="track"></div>
            <div class="fills">
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(t){super.updated(t),!this.indeterminate&&t.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),this.label&&t.has("label")&&this.setAttribute("aria-label",this.label)}}ne([l({type:Boolean,reflect:!0})],Gt.prototype,"indeterminate",2),ne([l({type:String})],Gt.prototype,"label",2),ne([l({type:Boolean,reflect:!0,attribute:"over-background"})],Gt.prototype,"overBackground",2),ne([l({reflect:!0})],Gt.prototype,"static",2),ne([l({type:Number})],Gt.prototype,"progress",2),y("sp-progress-circle",Gt);var Ti=k`
...
`],Di=Object.defineProperty,qi=Object.getOwnPropertyDescriptor,Yo=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?qi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Di(t,e,s),s};class De extends ${constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[Xo,Li,Ti]}render(){return u`
        ...
        `}}De.is="sp-illustrated-message",Yo([l()],De.prototype,"heading",2),Yo([l()],De.prototype,"description",2),y("sp-illustrated-message",De),y("sp-icon-search",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Search"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    <path
      d="M33.173 30.215 25.4 22.443a12.826 12.826 0 1 0-2.957 2.957l7.772 7.772a2.1 2.1 0 0 0 2.958-2.958ZM6 15a9 9 0 1 1 9 9 9 9 0 0 1-9-9Z"
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-file-template",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="File Template"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-file-code",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="File Code"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-device-phone",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Device Phone"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-device-tablet",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Device Tablet"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-device-desktop",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Device Desktop"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-magic-wand",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Magic Wand"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-copy",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Copy"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-preview",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Preview"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-view-detail",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="View Detail"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-chevron-right",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Chevron Right"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-icon-chevron-left",class extends H{render(){return F(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Chevron Left"}={})=>N`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,Bi=Object.defineProperty,Pi=Object.getOwnPropertyDescriptor,Qo=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Pi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Bi(t,e,s),s};class Hr extends ${constructor(){super(...arguments),this.label=""}static get styles(){return[$i]}render(){return this.variant==="file"?(t=>u`
    <svg
        class="file"
        role="img"
        viewBox="0 0 128 128"
...
`)(this.label):u`
        ...
        `}}Qo([l({type:String,reflect:!0})],Hr.prototype,"variant",2),Qo([l()],Hr.prototype,"label",2),y("sp-asset",Hr);var Oi=Object.defineProperty,Mi=Object.getOwnPropertyDescriptor,Ir=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Mi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Oi(t,e,s),s};class qe extends ht{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return u`
            <input
                ...
                @change=${this.handleChange}
            />
        `}}Ir([l({type:Boolean,reflect:!0})],qe.prototype,"checked",2),Ir([l({type:Boolean,reflect:!0})],qe.prototype,"readonly",2),Ir([Q("#input")],qe.prototype,"inputElement",2),y("sp-icon-checkmark75",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Checkmark75"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-checkmark200",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Checkmark200"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-checkmark300",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Checkmark300"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}}),y("sp-icon-dash75",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Dash75"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
  ...
  </svg>`)()}}),y("sp-icon-dash100",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Dash100"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  </svg>`)()}}),y("sp-icon-dash200",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Dash200"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
  ...
  </svg>`)()}}),y("sp-icon-dash300",class extends H{render(){return tt(u),(({width:r=24,height:t=24,title:e="Dash300"}={})=>J`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
...
`,Ui=Object.defineProperty,Ni=Object.getOwnPropertyDescriptor,Sr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ni(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ui(t,e,s),s};const Fi={s:u`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:u`
        ...
        ></sp-icon-dash300>
    `};class $e extends st(qe){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[_i,xr,Ri]}render(){return u`
            ${super.render()}
            <span id="box">
                ${Fi[this.size]}
                ${Vi[this.size]}
        ...
        `}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),t.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}Sr([l({type:Boolean,reflect:!0})],$e.prototype,"indeterminate",2),Sr([l({type:Boolean,reflect:!0})],$e.prototype,"invalid",2),Sr([l({type:Boolean,reflect:!0})],$e.prototype,"emphasized",2),y("sp-checkbox",$e);var Wi=k`
...
`,Ki=Object.defineProperty,Gi=Object.getOwnPropertyDescriptor,Jo=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Gi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ki(t,e,s),s};class Tr extends ${constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[Wi]}render(){return u`
            <slot></slot>
        `}}Jo([l({type:Boolean,reflect:!0})],Tr.prototype,"opened",2),Jo([l({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Tr.prototype,"textOnly",2),y("sp-quick-actions",Tr);var Zi=k`
...
`],Yi=Object.defineProperty,Qi=Object.getOwnPropertyDescriptor,bt=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Qi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Yi(t,e,s),s};class lt extends Ee(st(function(t,e){var o;const a=Array.isArray(e)?e:[e];return o=Nt,class extends t{constructor(...s){super(s),this[o]=new Map,this.managePresenceObservedSlot=()=>{let i=!1;a.forEach(c=>{const n=!!this.querySelector(c),m=this[Nt].get(c)||!1;i=i||m!==n,this[Nt].set(c,!!this.querySelector(c))}),i&&this.updateComplete.then(()=>{this.requestUpdate()})},new Ae(this,{config:{childList:!0,subtree:!0},callback:()=>{this.managePresenceObservedSlot()}}),this.managePresenceObservedSlot()}get slotContentIsPresent(){if(a.length===1)return this[Nt].get(a[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(s){if(this[Nt].has(s))return this[Nt].get(s)||!1;throw new Error(`The provided selector \`${s}\` is not being observed.`)}}}(Eo($),['[slot="cover-photo"]','[slot="preview"]']),{validSizes:["s","m"]})){constructor(){super(...arguments),this.variant="standard",this._selected=!1,this.heading="",this.horizontal=!1,this.focused=!1,this.toggles=!1,this.value="",this.subheading="",this.handleFocusin=t=>{this.focused=!0,t.composedPath()[0]===this?this.addEventListener("keydown",this.handleKeydown):this.removeEventListener("keydown",this.handleKeydown)}}static get styles(){return[Xo,Xi,Zi]}get selected(){return this._selected}set selected(t){t!==this.selected&&(this._selected=t,this.requestUpdate("selected",!this._selected))}get hasCoverPhoto(){return this.getSlotContentPresence('[slot="cover-photo"]')}get hasPreview(){return this.getSlotContentPresence('[slot="preview"]')}click(){var t;(t=this.likeAnchor)==null||t.click()}handleFocusout(t){this.focused=!1,t.composedPath()[0]===this&&this.removeEventListener("keydown",this.handleKeydown)}handleKeydown(t){const{code:e}=t;switch(e){case"Space":if(this.toggleSelected(),this.toggles){t.preventDefault();break}case"Enter":case"NumpadEnter":this.click()}}handleSelectedChange(t){t.stopPropagation(),this.selected=t.target.checked,this.announceChange()}toggleSelected(){this.toggles?(this.selected=!this.selected,this.announceChange()):this.dispatchEvent(new Event("click",{bubbles:!0,composed:!0}))}announceChange(){this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0,composed:!0}))||(this.selected=!this.selected)}stopPropagationOnHref(t){this.href&&t.stopPropagation()}handlePointerdown(t){if(t.composedPath().some(a=>a.localName==="a"))return;const e=+new Date,o=()=>{+new Date-e<200&&this.click(),this.removeEventListener("pointerup",o),this.removeEventListener("pointercancel",o)};this.addEventListener("pointerup",o),this.addEventListener("pointercancel",o)}get renderHeading(){return u`
        ...
        `}render(){return u`
            ...
            ${this.variant==="quiet"&&this.size==="s"?u`
                  ...
                  `:u``}
        `}firstUpdated(t){super.firstUpdated(t),this.addEventListener("pointerdown",this.handlePointerdown),this.addEventListener("focusin",this.handleFocusin),this.shadowRoot.addEventListener("focusin",this.handleFocusin),this.addEventListener("focusout",this.handleFocusout)}}bt([l()],lt.prototype,"asset",2),bt([l({reflect:!0})],lt.prototype,"variant",2),bt([l({type:Boolean,reflect:!0})],lt.prototype,"selected",1),bt([l()],lt.prototype,"heading",2),bt([l({type:Boolean,reflect:!0})],lt.prototype,"horizontal",2),bt([Q("#like-anchor")],lt.prototype,"likeAnchor",2),bt([l({type:Boolean,reflect:!0})],lt.prototype,"focused",2),bt([l({type:Boolean,reflect:!0})],lt.prototype,"toggles",2),bt([l()],lt.prototype,"value",2),bt([l()],lt.prototype,"subheading",2),y("sp-card",lt);var Ji=k`
...
`,tc=Object.defineProperty,ec=Object.getOwnPropertyDescriptor;class ts extends st($){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[Ji]}handleSlotchange({target:t}){t.assignedElements().forEach(e=>{e.size=this.size})}render(){return u`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?ec(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&tc(t,e,s)})([l({type:Boolean,reflect:!0})],ts.prototype,"vertical",2),y("sp-button-group",ts);var rc=k`
...
`,hc=Object.defineProperty,bc=Object.getOwnPropertyDescriptor,as=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?bc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&hc(t,e,s),s};const Dr=class extends wt{constructor(){super(),Dr.instances+=1,this.headerId=`sp-menu-group-label-${Dr.instances}`}static get styles(){return[...super.styles,gc]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const r=this.headerElements.length?this.headerElements[0]:void 0;if(r!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),r){const t=r.id||this.headerId;r.id||(r.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=r}render(){return u`
        ...
        `}};let Pe=Dr;Pe.instances=0,as([Co("header",!0)],Pe.prototype,"headerElements",2),as([or()],Pe.prototype,"headerElement",2),y("sp-menu-group",Pe);var vc=k`
...
`;class fc extends st($,{validSizes:["s","m","l"]}){static get styles(){return[Ko,vc]}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}}y("sp-menu-divider",fc);var yc=k`
...
`,wc=Object.defineProperty,xc=Object.getOwnPropertyDescriptor;class is extends ${constructor(){super(...arguments),this.open=!1}static get styles(){return[kc]}render(){return u``}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?xc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&wc(t,e,s)})([l({type:Boolean,reflect:!0})],is.prototype,"open",2),y("sp-underlay",is);class cs{constructor(t,e){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(e),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}}var zc=k`
...
`,jc=Object.defineProperty,Ec=Object.getOwnPropertyDescriptor,ns=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ec(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&jc(t,e,s),s};class qr extends ${constructor(){super(...arguments),this.open=!1,this.prefersMotion=new cs(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[zc,Cc]}focus(){const t=cr(this);t?t.focus():this.children.length===1?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(t){t.has("open")&&t.get("open")!==void 0&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise(e=>{this.resolveTransitionPromise=()=>{this.animating=!1,e()}})),super.update(t)}render(){return u`
            <sp-underlay
                ?open=${this.open}
                @click=${this.close}
        ...
        `}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.transitionPromise,t}}ns([l({type:Boolean,reflect:!0})],qr.prototype,"open",2),ns([Q(".tray")],qr.prototype,"tray",2),y("sp-tray",qr);var Ac=k`
:host{--spectrum-overlay-animation-distance:var(
--spectrum-picker-m-texticon-popover-offset-y,var(--spectrum-global-dimension-size-75)
...
`,Hc=Object.defineProperty,Ic=Object.getOwnPropertyDescriptor,Oe=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ic(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Hc(t,e,s),s};class le extends ${constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[Ac]}renderTip(){return u`
            <div id="tip">
                <svg
        ...
        `}}Oe([l({type:Boolean,reflect:!0})],le.prototype,"dialog",2),Oe([l({type:Boolean,reflect:!0})],le.prototype,"open",2),Oe([l({reflect:!0})],le.prototype,"placement",2),Oe([l({type:Boolean,reflect:!0})],le.prototype,"tip",2),y("sp-popover",le);var Sc=k`
...
`;const Zt=r=>{if(!r)return null;const t=r.closest("active-overlay");if(t)return t;const e=r.getRootNode();return e.host?Zt(e.host):null},$r=(r,t)=>{const e=[];if(!r)return[];for(const o of t)o.root&&Zt(o.root)===r&&(e.push(o),e.push(...$r(o,t)));return e};function Xt(r){return r.split("-")[1]}function Br(r){return r==="y"?"height":"width"}function It(r){return r.split("-")[0]}function Yt(r){return["top","bottom"].includes(It(r))?"x":"y"}function ls(r,t,e){let{reference:o,floating:a}=r;const s=o.x+o.width/2-a.width/2,i=o.y+o.height/2-a.height/2,c=Yt(t),n=Br(c),m=o[n]/2-a[n]/2,d=c==="x";let p;switch(It(t)){case"top":p={x:s,y:o.y-a.height};break;case"bottom":p={x:s,y:o.y+o.height};break;case"right":p={x:o.x+o.width,y:i};break;case"left":p={x:o.x-a.width,y:i};break;default:p={x:o.x,y:o.y}}switch(Xt(t)){case"start":p[c]-=m*(e&&d?-1:1);break;case"end":p[c]+=m*(e&&d?-1:1)}return p}function us(r){return typeof r!="number"?function(t){return{top:0,right:0,bottom:0,left:0,...t}}(r):{top:r,right:r,bottom:r,left:r}}function Me(r){return{...r,top:r.y,left:r.x,right:r.x+r.width,bottom:r.y+r.height}}async function Pr(r,t){var e;t===void 0&&(t={});const{x:o,y:a,platform:s,rects:i,elements:c,strategy:n}=r,{boundary:m="clippingAncestors",rootBoundary:d="viewport",elementContext:p="floating",altBoundary:g=!1,padding:h=0}=t,f=us(h),b=c[g?p==="floating"?"reference":"floating":p],w=Me(await s.getClippingRect({element:(e=await(s.isElement==null?void 0:s.isElement(b)))==null||e?b:b.contextElement||await(s.getDocumentElement==null?void 0:s.getDocumentElement(c.floating)),boundary:m,rootBoundary:d,strategy:n})),v=p==="floating"?{...i.floating,x:o,y:a}:i.reference,x=await(s.getOffsetParent==null?void 0:s.getOffsetParent(c.floating)),z=await(s.isElement==null?void 0:s.isElement(x))&&await(s.getScale==null?void 0:s.getScale(x))||{x:1,y:1},C=Me(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({rect:v,offsetParent:x,strategy:n}):v);return{top:(w.top-C.top+f.top)/z.y,bottom:(C.bottom-w.bottom+f.bottom)/z.y,left:(w.left-C.left+f.left)/z.x,right:(C.right-w.right+f.right)/z.x}}const Or=Math.min,qt=Math.max;function Mr(r,t,e){return qt(r,Or(t,e))}const Tc={left:"right",right:"left",bottom:"top",top:"bottom"};function _e(r){return r.replace(/left|right|bottom|top/g,t=>Tc[t])}const Lc={start:"end",end:"start"};function _r(r){return r.replace(/start|end/g,t=>Lc[t])}const ms=function(r){return r===void 0&&(r={}),{name:"flip",options:r,async fn(t){var e;const{placement:o,middlewareData:a,rects:s,initialPlacement:i,platform:c,elements:n}=t,{mainAxis:m=!0,crossAxis:d=!0,fallbackPlacements:p,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:h="none",flipAlignment:f=!0,...b}=r,w=It(o),v=It(i)===i,x=await(c.isRTL==null?void 0:c.isRTL(n.floating)),z=p||(v||!f?[_e(i)]:function(T){const G=_e(T);return[_r(T),G,_r(G)]}(i));p||h==="none"||z.push(...function(T,G,Z,U){const W=Xt(T);let B=function(ct,X,gt){const fe=["left","right"],oo=["right","left"],Bs=["top","bottom"],Ps=["bottom","top"];switch(ct){case"top":case"bottom":return gt?X?oo:fe:X?fe:oo;case"left":case"right":return X?Bs:Ps;default:return[]}}(It(T),Z==="start",U);return W&&(B=B.map(ct=>ct+"-"+W),G&&(B=B.concat(B.map(_r)))),B}(i,f,h,x));const C=[i,...z],I=await Pr(t,b),j=[];let S=((e=a.flip)==null?void 0:e.overflows)||[];if(m&&j.push(I[w]),d){const{main:T,cross:G}=function(Z,U,W){W===void 0&&(W=!1);const B=Xt(Z),ct=Yt(Z),X=Br(ct);let gt=ct==="x"?B===(W?"end":"start")?"right":"left":B==="start"?"bottom":"top";return U.reference[X]>U.floating[X]&&(gt=_e(gt)),{main:gt,cross:_e(gt)}}(o,s,x);j.push(I[T],I[G])}if(S=[...S,{placement:o,overflows:j}],!j.every(T=>T<=0)){var M,_;const T=(((M=a.flip)==null?void 0:M.index)||0)+1,G=C[T];if(G)return{data:{index:T,overflows:S},reset:{placement:G}};let Z=(_=S.filter(U=>U.overflows[0]<=0).sort((U,W)=>U.overflows[1]-W.overflows[1])[0])==null?void 0:_.placement;if(!Z)switch(g){case"bestFit":{var dt;const U=(dt=S.map(W=>[W.placement,W.overflows.filter(B=>B>0).reduce((B,ct)=>B+ct,0)]).sort((W,B)=>W[1]-B[1])[0])==null?void 0:dt[0];U&&(Z=U);break}case"initialPlacement":Z=i}if(o!==Z)return{reset:{placement:Z}}}return{}}}},Dc=function(r){return r===void 0&&(r=0),{name:"offset",options:r,async fn(t){const{x:e,y:o}=t,a=await async function(s,i){const{placement:c,platform:n,elements:m}=s,d=await(n.isRTL==null?void 0:n.isRTL(m.floating)),p=It(c),g=Xt(c),h=Yt(c)==="x",f=["left","top"].includes(p)?-1:1,b=d&&h?-1:1,w=typeof i=="function"?i(s):i;let{mainAxis:v,crossAxis:x,alignmentAxis:z}=typeof w=="number"?{mainAxis:w,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...w};return g&&typeof z=="number"&&(x=g==="end"?-1*z:z),h?{x:x*b,y:v*f}:{x:v*f,y:x*b}}(t,r);return{x:e+a.x,y:o+a.y,data:a}}}},qc=function(r){return r===void 0&&(r={}),{name:"size",options:r,async fn(t){const{placement:e,rects:o,platform:a,elements:s}=t,{apply:i=()=>{},...c}=r,n=await Pr(t,c),m=It(e),d=Xt(e),p=Yt(e)==="x",{width:g,height:h}=o.floating;let f,b;m==="top"||m==="bottom"?(f=m,b=d===(await(a.isRTL==null?void 0:a.isRTL(s.floating))?"start":"end")?"left":"right"):(b=m,f=d==="end"?"top":"bottom");const w=h-n[f],v=g-n[b],x=!t.middlewareData.shift;let z=w,C=v;if(p){const j=g-n.left-n.right;C=d||x?Or(v,j):j}else{const j=h-n.top-n.bottom;z=d||x?Or(w,j):j}if(x&&!d){const j=qt(n.left,0),S=qt(n.right,0),M=qt(n.top,0),_=qt(n.bottom,0);p?C=g-2*(j!==0||S!==0?j+S:qt(n.left,n.right)):z=h-2*(M!==0||_!==0?M+_:qt(n.top,n.bottom))}await i({...t,availableWidth:C,availableHeight:z});const I=await a.getDimensions(s.floating);return g!==I.width||h!==I.height?{reset:{rects:!0}}:{}}}};function ot(r){var t;return((t=r.ownerDocument)==null?void 0:t.defaultView)||window}function vt(r){return ot(r).getComputedStyle(r)}function ps(r){return r instanceof ot(r).Node}function St(r){return ps(r)?(r.nodeName||"").toLowerCase():""}let Re;function ds(){if(Re)return Re;const r=navigator.userAgentData;return r&&Array.isArray(r.brands)?(Re=r.brands.map(t=>t.brand+"/"+t.version).join(" "),Re):navigator.userAgent}function mt(r){return r instanceof ot(r).HTMLElement}function pt(r){return r instanceof ot(r).Element}function gs(r){return typeof ShadowRoot>"u"?!1:r instanceof ot(r).ShadowRoot||r instanceof ShadowRoot}function Ue(r){const{overflow:t,overflowX:e,overflowY:o,display:a}=vt(r);return/auto|scroll|overlay|hidden|clip/.test(t+o+e)&&!["inline","contents"].includes(a)}function $c(r){return["table","td","th"].includes(St(r))}function Rr(r){const t=/firefox/i.test(ds()),e=vt(r),o=e.backdropFilter||e.WebkitBackdropFilter;return e.transform!=="none"||e.perspective!=="none"||!!o&&o!=="none"||t&&e.willChange==="filter"||t&&!!e.filter&&e.filter!=="none"||["transform","perspective"].some(a=>e.willChange.includes(a))||["paint","layout","strict","content"].some(a=>{const s=e.contain;return s!=null&&s.includes(a)})}function Ur(){return/^((?!chrome|android).)*safari/i.test(ds())}function Nr(r){return["html","body","#document"].includes(St(r))}const hs=Math.min,ue=Math.max,Ne=Math.round;function bs(r){const t=vt(r);let e=parseFloat(t.width),o=parseFloat(t.height);const a=mt(r),s=a?r.offsetWidth:e,i=a?r.offsetHeight:o,c=Ne(e)!==s||Ne(o)!==i;return c&&(e=s,o=i),{width:e,height:o,fallback:c}}function vs(r){return pt(r)?r:r.contextElement}const fs={x:1,y:1};function Qt(r){const t=vs(r);if(!mt(t))return fs;const e=t.getBoundingClientRect(),{width:o,height:a,fallback:s}=bs(t);let i=(s?Ne(e.width):e.width)/o,c=(s?Ne(e.height):e.height)/a;return i&&Number.isFinite(i)||(i=1),c&&Number.isFinite(c)||(c=1),{x:i,y:c}}function $t(r,t,e,o){var a,s;t===void 0&&(t=!1),e===void 0&&(e=!1);const i=r.getBoundingClientRect(),c=vs(r);let n=fs;t&&(o?pt(o)&&(n=Qt(o)):n=Qt(r));const m=c?ot(c):window,d=Ur()&&e;let p=(i.left+(d&&((a=m.visualViewport)==null?void 0:a.offsetLeft)||0))/n.x,g=(i.top+(d&&((s=m.visualViewport)==null?void 0:s.offsetTop)||0))/n.y,h=i.width/n.x,f=i.height/n.y;if(c){const b=ot(c),w=o&&pt(o)?ot(o):o;let v=b.frameElement;for(;v&&o&&w!==b;){const x=Qt(v),z=v.getBoundingClientRect(),C=getComputedStyle(v);z.x+=(v.clientLeft+parseFloat(C.paddingLeft))*x.x,z.y+=(v.clientTop+parseFloat(C.paddingTop))*x.y,p*=x.x,g*=x.y,h*=x.x,f*=x.y,p+=z.x,g+=z.y,v=ot(v).frameElement}}return Me({width:h,height:f,x:p,y:g})}function Tt(r){return((ps(r)?r.ownerDocument:r.document)||window.document).documentElement}function Fe(r){return pt(r)?{scrollLeft:r.scrollLeft,scrollTop:r.scrollTop}:{scrollLeft:r.pageXOffset,scrollTop:r.pageYOffset}}function ys(r){return $t(Tt(r)).left+Fe(r).scrollLeft}function me(r){if(St(r)==="html")return r;const t=r.assignedSlot||r.parentNode||gs(r)&&r.host||Tt(r);return gs(t)?t.host:t}function ks(r){const t=me(r);return Nr(t)?t.ownerDocument.body:mt(t)&&Ue(t)?t:ks(t)}function pe(r,t){var e;t===void 0&&(t=[]);const o=ks(r),a=o===((e=r.ownerDocument)==null?void 0:e.body),s=ot(o);return a?t.concat(s,s.visualViewport||[],Ue(o)?o:[]):t.concat(o,pe(o))}function ws(r,t,e){let o;if(t==="viewport")o=function(i,c){const n=ot(i),m=Tt(i),d=n.visualViewport;let p=m.clientWidth,g=m.clientHeight,h=0,f=0;if(d){p=d.width,g=d.height;const b=Ur();(!b||b&&c==="fixed")&&(h=d.offsetLeft,f=d.offsetTop)}return{width:p,height:g,x:h,y:f}}(r,e);else if(t==="document")o=function(i){const c=Tt(i),n=Fe(i),m=i.ownerDocument.body,d=ue(c.scrollWidth,c.clientWidth,m.scrollWidth,m.clientWidth),p=ue(c.scrollHeight,c.clientHeight,m.scrollHeight,m.clientHeight);let g=-n.scrollLeft+ys(i);const h=-n.scrollTop;return vt(m).direction==="rtl"&&(g+=ue(c.clientWidth,m.clientWidth)-d),{width:d,height:p,x:g,y:h}}(Tt(r));else if(pt(t))o=function(i,c){const n=$t(i,!0,c==="fixed"),m=n.top+i.clientTop,d=n.left+i.clientLeft,p=mt(i)?Qt(i):{x:1,y:1};return{width:i.clientWidth*p.x,height:i.clientHeight*p.y,x:d*p.x,y:m*p.y}}(t,e);else{const i={...t};if(Ur()){var a,s;const c=ot(r);i.x-=((a=c.visualViewport)==null?void 0:a.offsetLeft)||0,i.y-=((s=c.visualViewport)==null?void 0:s.offsetTop)||0}o=i}return Me(o)}function xs(r,t){return mt(r)&&vt(r).position!=="fixed"?t?t(r):r.offsetParent:null}function zs(r,t){const e=ot(r);if(!mt(r))return e;let o=xs(r,t);for(;o&&$c(o)&&vt(o).position==="static";)o=xs(o,t);return o&&(St(o)==="html"||St(o)==="body"&&vt(o).position==="static"&&!Rr(o))?e:o||function(a){let s=me(a);for(;mt(s)&&!Nr(s);){if(Rr(s))return s;s=me(s)}return null}(r)||e}function Bc(r,t,e){const o=mt(t),a=Tt(t),s=$t(r,!0,e==="fixed",t);let i={scrollLeft:0,scrollTop:0};const c={x:0,y:0};if(o||!o&&e!=="fixed")if((St(t)!=="body"||Ue(a))&&(i=Fe(t)),mt(t)){const n=$t(t,!0);c.x=n.x+t.clientLeft,c.y=n.y+t.clientTop}else a&&(c.x=ys(a));return{x:s.left+i.scrollLeft-c.x,y:s.top+i.scrollTop-c.y,width:s.width,height:s.height}}const Pc={getClippingRect:function(r){let{element:t,boundary:e,rootBoundary:o,strategy:a}=r;const s=[...e==="clippingAncestors"?function(n,m){const d=m.get(n);if(d)return d;let p=pe(n).filter(b=>pt(b)&&St(b)!=="body"),g=null;const h=vt(n).position==="fixed";let f=h?me(n):n;for(;pt(f)&&!Nr(f);){const b=vt(f),w=Rr(f);b.position==="fixed"&&(g=null),(h?w||g:w||b.position!=="static"||!g||!["absolute","fixed"].includes(g.position))?g=b:p=p.filter(v=>v!==f),f=me(f)}return m.set(n,p),p}(t,this._c):[].concat(e),o],i=s[0],c=s.reduce((n,m)=>{const d=ws(t,m,a);return n.top=ue(d.top,n.top),n.right=hs(d.right,n.right),n.bottom=hs(d.bottom,n.bottom),n.left=ue(d.left,n.left),n},ws(t,i,a));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}},convertOffsetParentRelativeRectToViewportRelativeRect:function(r){let{rect:t,offsetParent:e,strategy:o}=r;const a=mt(e),s=Tt(e);if(e===s)return t;let i={scrollLeft:0,scrollTop:0},c={x:1,y:1};const n={x:0,y:0};if((a||!a&&o!=="fixed")&&((St(e)!=="body"||Ue(s))&&(i=Fe(e)),mt(e))){const m=$t(e);c=Qt(e),n.x=m.x+e.clientLeft,n.y=m.y+e.clientTop}return{width:t.width*c.x,height:t.height*c.y,x:t.x*c.x-i.scrollLeft*c.x+n.x,y:t.y*c.y-i.scrollTop*c.y+n.y}},isElement:pt,getDimensions:function(r){return bs(r)},getOffsetParent:zs,getDocumentElement:Tt,getScale:Qt,async getElementRects(r){let{reference:t,floating:e,strategy:o}=r;const a=this.getOffsetParent||zs,s=this.getDimensions;return{reference:Bc(t,await a(e),o),floating:{x:0,y:0,...await s(e)}}},getClientRects:r=>Array.from(r.getClientRects()),isRTL:r=>vt(r).direction==="rtl"},Oc=(r,t,e)=>{const o=new Map,a={platform:Pc,...e},s={...a.platform,_c:o};return(async(i,c,n)=>{const{placement:m="bottom",strategy:d="absolute",middleware:p=[],platform:g}=n,h=p.filter(Boolean),f=await(g.isRTL==null?void 0:g.isRTL(c));let b=await g.getElementRects({reference:i,floating:c,strategy:d}),{x:w,y:v}=ls(b,m,f),x=m,z={},C=0;for(let I=0;I<h.length;I++){const{name:j,fn:S}=h[I],{x:M,y:_,data:dt,reset:T}=await S({x:w,y:v,initialPlacement:m,placement:x,strategy:d,middlewareData:z,rects:b,platform:g,elements:{reference:i,floating:c}});w=M!=null?M:w,v=_!=null?_:v,z={...z,[j]:{...z[j],...dt}},T&&C<=50&&(C++,typeof T=="object"&&(T.placement&&(x=T.placement),T.rects&&(b=T.rects===!0?await g.getElementRects({reference:i,floating:c,strategy:d}):T.rects),{x:w,y:v}=ls(b,x,f)),I=-1)}return{x:w,y:v,placement:x,strategy:d,middlewareData:z}})(r,t,{...a,platform:s})};var Mc=Object.defineProperty,_c=Object.getOwnPropertyDescriptor,de=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?_c(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Mc(t,e,s),s};const Cs={initial:"idle",states:{idle:{on:{active:"active"}},active:{on:{hiding:"hiding",idle:"idle"}},hiding:{on:{dispose:"dispose"}},dispose:{on:{disposed:"disposed"}},disposed:{on:{}}}},js=(r,t)=>r?t&&Cs.states[r].on[t]||r:Cs.initial,Rc=r=>{var t;return(t={left:["right","bottom","top"],"left-start":["right-start","bottom","top"],"left-end":["right-end","bottom","top"],right:["left","bottom","top"],"right-start":["left-start","bottom","top"],"right-end":["left-end","bottom","top"],top:["bottom","left","right"],"top-start":["bottom-start","left","right"],"top-end":["bottom-end","left","right"],bottom:["top","left","right"],"bottom-start":["top-start","left","right"],"bottom-end":["top-end","left","right"]}[r])!=null?t:[r]},Es=class extends ${constructor(){super(),this.contentAnimationPromise=Promise.resolve(!0),this.resolveContentAnimationPromise=()=>{},this._state=js(),this.animating=!1,this.theme={},this.tabbingAway=!1,this.offset=6,this.skidding=0,this.interaction="hover",this.positionAnimationFrame=0,this.willNotifyClosed=!1,this.isConstrained=!1,this.updateOverlayPosition=()=>{this.interaction!=="modal"&&this.cleanup?this.dispatchEvent(new Event("close")):this.setOverlayPosition()},this.resetOverlayPosition=()=>{this.style.removeProperty("max-height"),this.style.removeProperty("height"),this.initialHeight=void 0,this.isConstrained=!1,this.offsetHeight,this.setOverlayPosition()},this.setOverlayPosition=async()=>{if(!this.placement||this.placement==="none")return;function r(n){const m=window.devicePixelRatio||1;return Math.round(n*m)/m||-1e4}await(document.fonts?document.fonts.ready:Promise.resolve());const t=this.virtualTrigger?ms({padding:8,fallbackPlacements:Rc(this.placement)}):ms({padding:8}),e=[Dc({mainAxis:this.offset,crossAxis:this.skidding}),(o={padding:8},o===void 0&&(o={}),{name:"shift",options:o,async fn(n){const{x:m,y:d,placement:p}=n,{mainAxis:g=!0,crossAxis:h=!1,limiter:f={fn:S=>{let{x:M,y:_}=S;return{x:M,y:_}}},...b}=o,w={x:m,y:d},v=await Pr(n,b),x=Yt(It(p)),z=x==="x"?"y":"x";let C=w[x],I=w[z];if(g){const S=x==="y"?"bottom":"right";C=Mr(C+v[x==="y"?"top":"left"],C,C-v[S])}if(h){const S=z==="y"?"bottom":"right";I=Mr(I+v[z==="y"?"top":"left"],I,I-v[S])}const j=f.fn({...n,[x]:C,[z]:I});return{...j,data:{x:j.x-m,y:j.y-d}}}}),t,qc({padding:8,apply:({availableWidth:n,availableHeight:m,rects:{floating:d}})=>{const p=Math.max(100,Math.floor(m)),g=d.height;this.initialHeight=(this.isConstrained||this.virtualTrigger)&&this.initialHeight||g,this.isConstrained=g<this.initialHeight||p<=g;const h=this.isConstrained?`${p}px`:"";Object.assign(this.style,{maxWidth:`${Math.floor(n)}px`,maxHeight:h,height:h})}})];var o;this.overlayContentTip&&e.push((n=>({name:"arrow",options:n,async fn(m){const{element:d,padding:p=0}=n||{},{x:g,y:h,placement:f,rects:b,platform:w,elements:v}=m;if(d==null)return{};const x=us(p),z={x:g,y:h},C=Yt(f),I=Br(C),j=await w.getDimensions(d),S=C==="y",M=S?"top":"left",_=S?"bottom":"right",dt=S?"clientHeight":"clientWidth",T=b.reference[I]+b.reference[C]-z[C]-b.floating[I],G=z[C]-b.reference[C],Z=await(w.getOffsetParent==null?void 0:w.getOffsetParent(d));let U=Z?Z[dt]:0;U&&await(w.isElement==null?void 0:w.isElement(Z))||(U=v.floating[dt]||b.floating[I]);const W=T/2-G/2,B=x[M],ct=U-j[I]-x[_],X=U/2-j[I]/2+W,gt=Mr(B,X,ct),fe=Xt(f)!=null&&X!=gt&&b.reference[I]/2-(X<B?x[M]:x[_])-j[I]/2<0;return{[C]:z[C]-(fe?X<B?B-X:ct-X:0),data:{[C]:gt,centerOffset:X-gt}}}}))({element:this.overlayContentTip}));const{x:a,y:s,placement:i,middlewareData:c}=await Oc(this.virtualTrigger||this.trigger,this,{placement:this.placement,middleware:e,strategy:"fixed"});if(Object.assign(this.style,{top:"0px",left:"0px",transform:`translate(${r(a)}px, ${r(s)}px)`}),i!==this.getAttribute("actual-placement")&&(this.setAttribute("actual-placement",i),this.overlayContent.setAttribute("placement",i)),this.overlayContentTip&&c.arrow){const{x:n,y:m}=c.arrow;Object.assign(this.overlayContentTip.style,{left:n!=null?`${r(n)}px`:"",top:m!=null?`${r(m)}px`:"",right:"",bottom:""})}},this.handleInlineTriggerKeydown=r=>{const{code:t,shiftKey:e}=r;if(t==="Tab"){if(e)return this.tabbingAway=!0,void this.dispatchEvent(new Event("close"));r.stopPropagation(),r.preventDefault(),this.focus()}},this.stealOverlayContentPromise=Promise.resolve(),this.stealOverlayContentPromise=new Promise(r=>this.stealOverlayContentResolver=r)}get state(){return this._state}set state(r){const t=js(this.state,r);t!==this.state&&(this._state=t,this.state==="active"||this.state==="hiding"?this.setAttribute("state",this.state):this.removeAttribute("state"))}async focus(){const r=cr(this);if(r){r.updateComplete&&await r.updateComplete;const t=this.getRootNode().activeElement;(t===this||!this.contains(t))&&r.focus()}else super.focus();this.removeAttribute("tabindex")}get hasTheme(){return!!this.theme.color||!!this.theme.scale||!!this.theme.lang}static get styles(){return[Sc]}get hasModalRoot(){return!!this._modalRoot}feature(){this.contains(document.activeElement)||(this.tabIndex=-1);const r=Zt(this.trigger);r&&r.slot==="open"&&(this._modalRoot=r._modalRoot||r),(this.interaction==="modal"||this._modalRoot)&&(this.slot="open",this.interaction==="modal"&&this.setAttribute("aria-modal","true"),this._modalRoot&&(r==null||r.feature()))}obscure(r){if(this.slot&&r==="modal"){if(this.removeAttribute("slot"),this.removeAttribute("aria-modal"),this.interaction!=="modal"){const t=Zt(this.trigger);return this._modalRoot=t==null?void 0:t.obscure(r),this._modalRoot}return this}}async willUpdate(){this.hasUpdated||!this.overlayContent||!this.trigger||(this.stealOverlayContent(this.overlayContent),this.state="active",this.feature(),this.placement&&this.placement!=="none"&&(await this.updateOverlayPosition(),document.addEventListener("sp-update-overlays",this.resetOverlayPosition)),this.placement&&this.placement!=="none"&&(this.contentAnimationPromise=this.applyContentAnimation("sp-overlay-fade-in")))}async openCallback(r){await this.updateComplete,this.receivesFocus&&await this.focus(),await r(),this.trigger.dispatchEvent(new CustomEvent("sp-opened",{bubbles:!0,composed:!0,cancelable:!0,detail:{interaction:this.interaction}}))}open(r){this.extractDetail(r)}extractDetail(r){this.overlayContent=r.content,this.overlayContentTip=r.contentTip,this.trigger=r.trigger,this.virtualTrigger=r.virtualTrigger,this.placement=r.placement,this.offset=r.offset,this.skidding=r.skidding||0,this.interaction=r.interaction,this.theme=r.theme,this.receivesFocus=r.receivesFocus,this.root=r.root}dispose(){this.state==="dispose"&&(this.timeout&&(clearTimeout(this.timeout),delete this.timeout),this.trigger.removeEventListener("keydown",this.handleInlineTriggerKeydown),this.returnOverlayContent(),this.state="disposed",this.willNotifyClosed&&(this.overlayContent.dispatchEvent(new Event("sp-overlay-closed")),this.willNotifyClosed=!1),this.cleanup&&this.cleanup())}stealOverlayContent(r){this.originalPlacement=r.getAttribute("placement"),this.restoreContent=gr([r],this,{position:"beforeend",prepareCallback:t=>{const e=t.slot,o=t.placement;return t.removeAttribute("slot"),a=>{a.slot=e,a.placement=o}}}),this.stealOverlayContentResolver()}returnOverlayContent(){if(!this.restoreContent)return;const[r]=this.restoreContent();this.restoreContent=void 0,this.willNotifyClosed=!0,this.originalPlacement&&(r.setAttribute("placement",this.originalPlacement),delete this.originalPlacement)}async placeOverlay(){!this.placement||this.placement==="none"||(this.cleanup=function(r,t,e,o){o===void 0&&(o={});const{ancestorScroll:a=!0,ancestorResize:s=!0,elementResize:i=!0,animationFrame:c=!1}=o,n=a&&!c,m=n||s?[...pt(r)?pe(r):r.contextElement?pe(r.contextElement):[],...pe(t)]:[];m.forEach(h=>{n&&h.addEventListener("scroll",e,{passive:!0}),s&&h.addEventListener("resize",e)});let d,p=null;i&&(p=new ResizeObserver(()=>{e()}),pt(r)&&!c&&p.observe(r),pt(r)||!r.contextElement||c||p.observe(r.contextElement),p.observe(t));let g=c?$t(r):null;return c&&function h(){const f=$t(r);!g||f.x===g.x&&f.y===g.y&&f.width===g.width&&f.height===g.height||e(),g=f,d=requestAnimationFrame(h)}(),e(),()=>{var h;m.forEach(f=>{n&&f.removeEventListener("scroll",e),s&&f.removeEventListener("resize",e)}),(h=p)==null||h.disconnect(),p=null,c&&cancelAnimationFrame(d)}}(this.virtualTrigger||this.trigger,this,this.updateOverlayPosition,{elementResize:!1}))}async hide(r=!0){this.state==="active"&&(this.state="hiding",r&&await this.applyContentAnimation("sp-overlay-fade-out"),this.state="dispose")}schedulePositionUpdate(){cancelAnimationFrame(this.positionAnimationFrame),this.positionAnimationFrame=requestAnimationFrame(()=>{this.cleanup?this.updateOverlayPosition():this.placeOverlay()})}onSlotChange(){this.schedulePositionUpdate()}applyContentAnimation(r){return this.placement==="none"?Promise.resolve(!0):(this.resolveContentAnimationPromise(),new Promise(t=>{this.resolveContentAnimationPromise=()=>{t(!1)};const e=this.shadowRoot.querySelector("#contents"),o=a=>{r===a.animationName&&(e.removeEventListener("animationend",o),e.removeEventListener("animationcancel",o),this.animating=!1,t(a.type==="animationcancel"))};e.addEventListener("animationend",o),e.addEventListener("animationcancel",o),e.style.animationName=r,this.animating=!0}))}renderTheme(r){const{color:t,scale:e,lang:o,theme:a}=this.theme;return u`
            <sp-theme
                theme=${E(a)}
                color=${E(t)}
                scale=${E(e)}
      ...
      `]}});const rt={TOAST:"Toast",LIBRARY_LOADED:"LibraryLoaded",PLUGIN_LOADED:"PluginLoaded",PLUGIN_UNLOADED:"PluginUnloaded",LOCALE_SET:"LocaleSet",SEARCH_UPDATED:"SearchUpdated",ON_ACTION:"OnAction"},Pt={TOAST:"Toast",SHOW_LOADER:"ShowLoader",HIDE_LOADER:"HideLoader"};class Hs extends ae{static get styles(){return[...super.styles,k`
        #item-link {
          display: flex;
...
`,Zc=Object.defineProperty,Xc=Object.getOwnPropertyDescriptor,K=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Xc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Zc(t,e,s),s};const Wr=3840;class V extends ${constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Wr,this.secondaryMin=0,this.secondaryMax=Wr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Wr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Gc]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return u`
      ...
      `]}});class Yc{constructor(){q(this,"listeners",[])}addEventListener(t,e){const o={type:t,callback:e};return this.listeners.push(o),o}removeEventListener(t){for(let e=0;e<this.listeners.length;e++)if(t===this.listeners[e])return void this.listeners.splice(e,1)}removeEventListeners(t){t.forEach(e=>{this.removeEventListener(e)})}dispatchEvent(t){this.listeners.slice().forEach(e=>{t.type===e.type&&e.callback.apply(this,[t])})}}class D extends Yc{constructor(){return super(),D._instance||(D._instance=this),D._instance}static get instance(){return D._instance||(D._instance=new D),D._instance}}q(D,"_instance",void 0);const Qc={initialized:!1,activePlugin:void 0,activePluginPath:void 0,searchQuery:"",context:{},localeDict:{}};class A{static init(){A.appStore=function(t={},e="store"){function o(a,s,i){const c=new CustomEvent(s,{bubbles:!0,cancelable:!0,detail:i});return D.instance.dispatchEvent(c)}return new Proxy(t,function a(s,i){return{get:(c,n)=>n==="_isProxy"||(typeof c[n]=="object"&&c[n]!==null&&!c[n]._isProxy&&(c[n]=new Proxy(c[n],a(s,i))),c[n]),set:(c,n,m)=>(c[n]===m||(c[n]=m,o(0,n,i)),!0),deleteProperty:(c,n)=>(delete c[n],o(0,n,i),!0)}}(e,t))}(Qc,"app"),A.appStore.webRoot=window.libraryDev?"./src/":A.libraryHost}}async function Ls(r,t){const e=await fetch(r);if(e.status===401)(async function(o,a){const s=await fetch(o,{credentials:"include"});if(s.status===401)window.open(a,"_self");else if(!s.ok)throw new Error("unable to load library JSON");s.json()})(r,t);else if(!e.ok)throw new Error("unable to load library JSON");return e.json()}function We(){return window.libraryDev}async function Jc(){const{context:r}=A.appStore;r.baseLibraryOrigin=We()?new URL(r.base).origin:window.location.origin;try{const t=await async function(o){const{base:a}=o,s=await Ls(Is(a)?`${o.baseLibraryOrigin}${a}`:a,o.baseLibraryOrigin),i=s.data?s:s.blocks;return i&&i.data.forEach(c=>{c.path&&(c.path.includes("://")&&(c.path=new URL(c.path).pathname),c.url=`${o.baseLibraryOrigin}${c.path}`,c.path=`${c.path}`,c.extended=!1)}),s}(r),e=await async function(o){if(o.extends){const{extends:a}=o,{origin:s}=new URL(a);o.extendedLibraryOrigin=s;const i=await Ls(a,o.extendedLibraryOrigin),c=i.data?i:i.blocks;return c&&c.data.forEach(n=>{n.path&&!n.path.includes("://")&&(n.url=`${s}${n.path}`,n.path=`${n.path}`,n.extended=!0)}),i}return Promise.resolve()}(r);r.libraries=await async function(o,a){const s={};if(o[":type"]==="multi-sheet")for(const i of o[":names"])s[i]=o[i].data;else s.blocks=o.data;if(a)if(a[":type"]==="multi-sheet")for(const i of a[":names"])s[i]?s[i].push(...a[i].data):s[i]=a[i].data;else s.blocks=[...s.blocks||[],...a.data];return s}(t,e),D.instance.dispatchEvent(new CustomEvent(rt.LIBRARY_LOADED))}catch(t){D.instance.dispatchEvent(new CustomEvent(Pt.TOAST,{detail:{variant:"negative",message:A.appStore.localeDict.errorLoadingLibraryJSON}})),console.error("Unable to load library",t)}}q(A,"libraryHost","https://main--franklin-library-host--dylandepass.hlx.live/tools/sidekick/library"),q(A,"appStore",void 0);const tn={blocks:We()?"../../src/plugins/blocks/blocks.js":`${A.libraryHost}/plugins/blocks/blocks.js`,tags:We()?"../../src/plugins/tags/tags.js":`${A.libraryHost}/plugins/tags/tags.js`,"api-test":We()?"../../src/plugins/api-test/api-test.js":`${A.libraryHost}/plugins/api-test/api-test.js`};async function Ds(r,t){const{appStore:e}=r,{context:o}=e;let a=tn[t];const s=o[t];if(s&&(a=Is(s)?`${o.baseLibraryOrigin}${s}`:s),a)try{const i=await import(a);e.pluginData=e.context.libraries[t],e.activePluginPath=a,e.activePlugin=i.default,e.activePluginDecorate=i.decorate,D.instance.dispatchEvent(new CustomEvent(rt.PLUGIN_LOADED))}catch(i){D.instance.dispatchEvent(new CustomEvent(Pt.TOAST,{detail:{variant:"negative",message:r.appStore.localeDict.errorLoadingPlugin}})),Kr(r),console.error(`Error loading plugin ${t}: ${i.message}`)}else D.instance.dispatchEvent(new CustomEvent(Pt.TOAST,{detail:{variant:"negative",message:r.appStore.localeDict.unknownPlugin}}))}async function Kr(r){const{appStore:t}=r;t.activePlugin=void 0,t.pluginData=void 0,t.activePluginPath=void 0,t.activePluginDecorate=void 0,D.instance.dispatchEvent(new CustomEvent(rt.PLUGIN_UNLOADED))}class Gr extends Y{connectedCallback(){super.connectedCallback(),D.instance.addEventListener(rt.LIBRARY_LOADED,()=>{this.libraries=A.appStore.context.libraries;const t=Object.keys(this.libraries),e=t.includes("blocks")?"blocks":t[0];Ds(A,e)}),D.instance.addEventListener(rt.PLUGIN_LOADED,()=>{if(A.appStore.activePlugin){const{searchEnabled:t}=A.appStore.activePlugin;t&&(this.searchEnabled=!0),this.pluginActive=!0,this.defaultPluginName=A.appStore.activePlugin.title.toLowerCase()}}),D.instance.addEventListener(rt.PLUGIN_UNLOADED,()=>{this.pluginActive=!1,this.searchEnabled=!1,this.searchActivated=!1;const t=this.renderRoot.querySelector(".middle-bar");t==null||t.classList.remove("search-active"),this.renderRoot.querySelector("sp-search").value=""})}onBack(){Kr(A)}activateSearch(){const t=this.renderRoot.querySelector(".middle-bar");this.searchActivated=!this.searchActivated,this.searchActivated?t==null||t.classList.add("search-active"):t==null||t.classList.remove("search-active");const e=this.renderRoot.querySelector("sp-search");e==null||e.focus()}async onPluginChange(t){const{value:e}=t.target;Kr(A),await Ds(A,e)}onSearch(t){A.appStore.searchQuery=t.target.value,D.instance.dispatchEvent(new CustomEvent(rt.SEARCH_UPDATED))}renderLibraries(){if(this.libraries){const t=Object.keys(this.libraries);return u`
        <sp-picker
          quiet 
      ...
      </div>`}}q(Gr,"properties",{searchActivated:{type:Boolean},pluginActive:{type:Boolean},libraries:{type:Array},searchEnabled:{type:Boolean},defaultPluginName:{type:String}}),q(Gr,"styles",k`
    .search {
      padding: 10px 5px;
      display: grid;
  ...
  `),customElements.define("library-header",Gr);class Zr extends Y{connectedCallback(){super.connectedCallback()}render(){return u`
  ...
  `),customElements.define("generative-text-popover",Yr);class Qr extends Y{constructor(){super(),q(this,"iframe",ge()),this.state="ready",this.extendedBlock=!1,this.mutationObserver=new MutationObserver(this.handleMutations.bind(this))}getBlockElement(){return this.blockWrapperHTML.querySelector("div[class]")}decorateIcons(t,e){t.querySelectorAll("span.icon").forEach(async o=>{if(o.classList.length<2||!o.classList[1].startsWith("icon-"))return;const a=o.classList[1].substring(5),s=await fetch(`${e}/icons/${a}.svg`);if(s.ok){const i=await s.text();if(i.match(/<style/i)){const c=document.createElement("img");c.src=`data:image/svg+xml,${encodeURIComponent(i)}`,o.appendChild(c)}else o.innerHTML=i}})}decorateEditableElements(t){[...t.querySelectorAll("p, li, strong, a, h1, h2, h3, h4, h5, h6")].forEach(e=>{e.textContent.trim()!==""&&(e.setAttribute("contentEditable",!0),e.setAttribute("data-library-id",window.crypto.randomUUID()))}),[...t.querySelectorAll("a")].forEach(e=>{const o=e.parentElement,a=e.parentElement.parentElement,s=o.childNodes.length===1&&o.tagName==="P",i=a.childNodes.length===1&&a.tagName==="P",c=a.childNodes.length===1&&a.tagName==="DIV",n=o.childNodes.length===1&&o.tagName==="STRONG",m=o.childNodes.length===1&&o.tagName==="EM";(s||i&&n||c&&s||i&&m)&&(o.removeAttribute("contentEditable"),o.removeAttribute("data-library-id"),a.removeAttribute("contentEditable"),a.removeAttribute("data-library-id"))}),[...t.querySelectorAll("img")].forEach(e=>{e.setAttribute("data-library-id",window.crypto.randomUUID())})}handleMutations(t){t.forEach(e=>{const{target:o,type:a}=e;let s=a!=="characterData"?o.getAttribute("data-library-id"):o.parentElement.getAttribute("data-library-id");const i=this.blockWrapperHTML.querySelector(`[data-library-id="${s}"]`);if(a==="attributes")e.attributeName==="src"&&o.tagName==="IMG"&&(i.src=o.src,i.width=o.width,i.height=o.height);else if(a==="characterData")s=e.target.parentElement.getAttribute("data-library-id"),i.innerHTML=e.target.parentElement.innerHTML;else if(a==="childList"&&e.addedNodes.length>0){i==null||i.replaceChildren();for(const c of e.addedNodes){const n=c.cloneNode(!0);i&&(i.textContent=n.textContent)}}})}enableImageDragDrop(t){function e(o){o.preventDefault(),o.stopPropagation()}[...t.querySelectorAll("img")].forEach(o=>{o.addEventListener("dragover",a=>e(a)),o.addEventListener("dragenter",a=>e(a)),o.addEventListener("drop",a=>{a.preventDefault();const s=a.dataTransfer.files[0],i=new FileReader;i.readAsDataURL(s),i.addEventListener("loadend",()=>{const c=new Image;c.src=i.result,c.addEventListener("load",()=>{o.setAttribute("width",c.width),o.setAttribute("height",c.height)}),o.src=i.result})})})}async fetchContainerPageHTML(t,e){return(await(await fetch(t)).text()).replace(/href="\//g,`href="${e}/`).replace(/src="\//g,`src="${e}/`)}async loadBlock(t,e,o,a){const{context:s}=A.appStore,{url:i}=e,c=e.extended?s.extendedLibraryOrigin:s.baseLibraryOrigin;this.blockWrapperHTML=o,this.decorateEditableElements(this.getBlockElement());const n=o.cloneNode(!0);n.innerHTML=n.innerHTML.replace(/\.\/media/g,`${c}/media`).replace(/src="\/media/g,`src="${c}/media`);const m=await this.fetchContainerPageHTML(i,c),d=new DOMParser().parseFromString(m,"text/html");d.querySelector("main").replaceChildren(n);const{value:p}=this.iframe;p.srcdoc=d.documentElement.outerHTML,p.style.display="block",p.addEventListener("load",()=>{const{body:g}=p.contentWindow.document;this.decorateIcons(g,c),p.contentDocument.addEventListener("scroll",()=>{this.activeOverlayContent&&this.activeOverlayContent.remove(),this.selectedContentEditable&&this.selectedContentEditable.blur()}),p.contentWindow.addEventListener("focus",()=>{this.activeOverlayContent&&this.activeOverlayContent.remove()}),[...p.contentDocument.querySelectorAll("p, strong, li, a, h1, h2, h3, h4, h5, h6")].forEach(b=>{b.addEventListener("keydown",w=>{w.keyCode===13&&w.preventDefault()}),b.addEventListener("focus",w=>{if(console.log("focus"),localStorage.getItem("open-ai-key")){this.selectedContentEditable=w.target;const v=w.target.getBoundingClientRect();this.activeOverlayContent=it("generative-text-popover"),this.activeOverlayContent.style.top=`${v.top+v.height+63}px`,this.activeOverlayContent.style.left=v.left+v.width+p.getBoundingClientRect().left-36+"px",this.activeOverlayContent.style.position="absolute",this.activeOverlayContent.addEventListener("generated",x=>{this.activeOverlayContent.open=!1,this.selectedContentEditable.innerHTML=x.detail.generated,this.activeOverlayContent.remove()}),a.append(this.activeOverlayContent)}}),b.addEventListener("focusout",w=>{var v;w.relatedTarget?this.activeOverlayContent&&((v=a.querySelector("generative-text-popover"))==null||v.remove()):setTimeout(()=>{var x,z,C;(((x=document.activeElement)==null?void 0:x.tagName)!=="SP-TEXTFIELD"||((z=document.activeElement)==null?void 0:z.tagName)==="SIDEKICK-LIBRARY")&&this.activeOverlayContent&&((C=a.querySelector("generative-text-popover"))==null||C.remove())},700)})}),this.enableImageDragDrop(g),this.mutationObserver.observe(g,{subtree:!0,attributes:!0,childList:!0,characterData:!0,characterDataOldValue:!0});const h=it("link",{rel:"stylesheet",href:`${c}/blocks/${t}/${t}.css`}),f=it("link",{rel:"stylesheet",href:`${c}/styles/lazy-styles.css`});p.contentWindow.document.head.append(f),p.contentWindow.document.head.append(h),p.contentWindow.hlx={codeBasePath:c},h.onload=()=>{var b,w;(b=g.querySelector("header"))==null||b.remove(),(w=g.querySelector("footer"))==null||w.remove(),p.style.display="block",[...p.contentDocument.querySelectorAll("source")].forEach(v=>{v.remove()}),[...p.contentDocument.querySelectorAll("img")].forEach(v=>{const x=v.getAttribute("src");x.startsWith("/media")&&(v.src=`${c}${x}`)})},h.onerror=b=>{console.error(b)}})}render(){return u`<iframe title="block" ${he(this.iframe)}></iframe>`}}function qs(r){const t=r.querySelector(".library-metadata"),e={};if(t){const o=function(a){const s={};return a.querySelectorAll(":scope > div").forEach(i=>{if(i.children){const c=[...i.children];if(c[1]){const n=c[1],m=Ss(c[0].textContent);let d="";if(n.querySelector("a")){const p=[...n.querySelectorAll("a")];d=p.length===1?p[0].href:p.map(g=>g.href)}else if(n.querySelector("img")){const p=[...n.querySelectorAll("img")];d=p.length===1?p[0].src:p.map(g=>g.src)}else if(n.querySelector("p")){const p=[...n.querySelectorAll("p")];d=p.length===1?p[0].textContent:p.map(g=>g.textContent)}else d=i.children[1].textContent;s[m]=d}}}),s}(t);return Object.keys(o).forEach(a=>{a!=="style"&&(e[function(s){return Ss(s).replace(/-([a-z])/g,i=>i[1].toUpperCase())}(a)]=o[a])}),t.remove(),e}}function Jr(r,t=!0){if(!r)return;const e=r.className.split(" "),o=e.shift();return t&&e.length>0?`${o} (${e.join(", ")})`:o}q(Qr,"properties",{mutationObserver:{state:!1},blockWrapperHTML:{state:!1},activeOverlayContent:{state:!1},selectedContentEditable:{state:!1},extendedBlock:{state:!0,type:Boolean}}),q(Qr,"styles",k`
    iframe {
      width: 100%;
      height: 100%;
      border: none;
  ...
  `),customElements.define("block-renderer",Qr);class to extends Y{constructor(){super(),this.type="hierarchical"}onPreview(t,e){this.dispatchEvent(new CustomEvent("PreviewBlock",{detail:{path:e}})),window.open(e,"_blank")}renderNoResults(){return`
      <div class="message-container">
    ...
    `}filterBlocks(t){const e=this.renderRoot.querySelector(".message-container"),o=this.renderRoot.querySelectorAll("sp-sidenav-item"),a=this.renderRoot.querySelectorAll("sp-sidenav-item > sp-sidenav-item"),s=this.renderRoot.querySelectorAll("sp-sidenav > sp-sidenav-item");let i=!0;if(t==="")return o.forEach(c=>{c.removeAttribute("aria-hidden"),c.removeAttribute("expanded")}),void(e&&e.remove());a.forEach(c=>{var n;const m=c.label.toLowerCase(),d=(n=c.dataset.searchTags)!=null?n:"";m.includes(t.toLowerCase())||d.split(",").some(p=>p.toLowerCase().includes(t.toLowerCase()))?c.removeAttribute("aria-hidden"):c.setAttribute("aria-hidden",!0)}),s.forEach(c=>{let n=!1;c.querySelectorAll("sp-sidenav-item").forEach(m=>{m.hasAttribute("aria-hidden")||(n=!0,i=!1,e&&e.remove())}),n?(c.setAttribute("expanded",!0),c.removeAttribute("aria-hidden")):c.setAttribute("aria-hidden",!0)}),i&&!e&&this.renderRoot.append(it("div",{},this.renderNoResults()))}async loadBlocks(t,e){var o;const a=it("div",{class:"list-container"});if(this.type==="hierarchical"){const s=it("sp-sidenav",{variant:"multilevel","data-testid":"blocks"});a.append(s);const i=[],c=t.map(async n=>{const{url:m}=n,d=async function(p){if(window.blocks||(window.blocks={}),!window.blocks[p]){const g=await fetch(`${p}.plain.html`);if(!g.ok)return;const h=await g.text(),f=new DOMParser().parseFromString(h,"text/html");window.blocks[p]=f}return window.blocks[p]}(m);try{const p=await d;if(!p)throw new Error(`An error occurred fetching ${n.name}`);const g=Ts(n.name,"sp-icon-file-template",!0,!0,"sp-icon-preview");i.push(g),g.addEventListener("OnAction",b=>this.onPreview(b,m));const{body:h}=p,f=function(b){const w=b.querySelector(":scope > div > .library-metadata:only-child");return w?qs(w.parentElement):{}}(h);return[...h.querySelectorAll(":scope > div")].forEach((b,w)=>{var v,x,z,C;const I=(v=qs(b))!=null?v:{},j=b.querySelector("div[class]"),S=Jr(j,!1),M=(x=I.name)!=null?x:Jr(j),_=Jr(j,!0),dt=(C=(z=I.searchTags)!=null?z:f.searchTags)!=null?C:"";if(!S)return;const T=Ts(M,"sp-icon-file-code",!1,!0,"sp-icon-copy");dt&&T.setAttribute("data-search-tags",dt),T.classList.add("descendant"),T.setAttribute("data-index",w),T.addEventListener("OnAction",G=>{G.preventDefault(),G.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",{detail:{blockWrapper:b,blockNameWithVariant:_,blockURL:m}}))}),g.append(T),T.addEventListener("click",async()=>{this.dispatchEvent(new CustomEvent("LoadBlock",{detail:{blockWrapper:b,blockData:n,sectionLibraryMetadata:I,defaultLibraryMetadata:f}}))})}),d}catch(p){console.error(p.message),e.dispatchEvent(new CustomEvent("Toast",{detail:{message:p.message,variant:"negative"}}))}});await Promise.all(c),s.append(...i.sort((n,m)=>{const d=n.getAttribute("label").toUpperCase(),p=m.getAttribute("label").toUpperCase();return d<p?-1:d>p?1:0})),s.querySelectorAll("sp-sidenav-item").length===0&&e.append(this.renderNoResults())}(o=this.renderRoot)==null||o.append(a)}}q(to,"properties",{mutationObserver:{state:!1},type:{state:!0}}),q(to,"styles",k`
    .list-container {
      width: 100%;
    }
  ...
  `),customElements.define("block-list",to);class eo extends Y{render(){return u`
      ...
      </sp-theme>`}}q(eo,"properties",{generating:{state:!0}}),q(eo,"styles",k`
    sp-theme {
        height: 100%;
    }
  ...
  `),customElements.define("no-preview",eo);class $s extends Y{constructor(...t){super(...t),q(this,"progressContainer",ge())}connectedCallback(){super.connectedCallback(),D.instance.addEventListener(rt.PLUGIN_LOADED,()=>{const t=it("div",{class:"plugin-root","data-testid":"plugin-root"});this.renderRoot.prepend(t),this.loadPluginStylesheet(),t.addEventListener(Pt.SHOW_LOADER,this.displayLoader.bind(this)),t.addEventListener(Pt.TOAST,this.sendToast),t.addEventListener(Pt.HIDE_LOADER,this.hideLoader.bind(this)),A.appStore.activePluginDecorate(t,A.appStore.pluginData)}),D.instance.addEventListener(rt.PLUGIN_UNLOADED,()=>{const t=this.renderRoot.querySelector(".plugin-root");t&&(this.hideLoader(),t.remove())}),D.instance.addEventListener(rt.SEARCH_UPDATED,()=>{const t=this.renderRoot.querySelector(".plugin-root");t&&(t.innerHTML="",A.appStore.activePluginDecorate(t,A.appStore.pluginData,A.appStore.searchQuery))})}loadPluginStylesheet(){const t=document.createElement("link");t.setAttribute("rel","stylesheet");const e=A.appStore.activePluginPath.replace(".js",".css");t.setAttribute("href",e),t.setAttribute("type","text/css"),this.renderRoot.append(t)}displayLoader(){var t;(t=this.progressContainer.value)==null||t.classList.add("visible")}hideLoader(){var t;(t=this.progressContainer.value)==null||t.classList.remove("visible")}sendToast(t){D.instance.dispatchEvent(new CustomEvent(Pt.TOAST,{detail:t.detail}))}render(){return u`
